...
var bottomMenuClick = function (iconName) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, satSet = _a.satSet, objectManager = _a.objectManager, uiManager = _a.uiManager;
    if (iconName === 'menu-sat-fov') {
        if (objectManager.selectedSat === -1 && jquery__WEBPACK_IMPORTED_MODULE_1___default()('#search').val() === '') {
            ...
            if (settingsManager.plugins.topMenu)
                _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.adviceManager.adviceList.satFovDisabled();
        ...
        if (settingsManager.isSatOverflyModeOn) {
            ...
            var satFieldOfView = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#satFieldOfView').val());
...
//# sourceMappingURL=src_js_plugins_satelliteFov_satelliteFov_ts.8725cb400efbcef73260.js.map