...
var satChng = function (row) {
    ...
    if (row === -1 && satChngTable.length === 0) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2___default().get('/analysis/satchng.json?v=' + _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.settingsManager.versionNumber).done(function (resp) {
            var _a;
    ...
    if (row !== -1) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('#anal-sat').val(satChngTable[row].SCC);
...
var getSatChngJson = function (resp, satChngTable) {
    ...
    for (var i = 0; i < resp.length; i++) {
        ...
        var date = (0,_app_js_timeManager_transforms__WEBPACK_IMPORTED_MODULE_1__.dateFromJday)(year, resp[i].day);
...
//# sourceMappingURL=src_js_plugins_satChanges_satChanges_ts.cfa4a888464f506804e6.js.map