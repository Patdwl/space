...
var photoManager = {
    ...
    dscovrLoaded: function (req) {
        if (req.status >= 200 && req.status < 400) {
            ...
            photoManager.colorbox("https://epic.gsfc.nasa.gov/archive/natural/".concat(year, "/").concat(month, "/").concat(day, "/png/").concat(imageUrl, ".png"));
        }
    },
    meteosat11: function () {
...
//# sourceMappingURL=src_js_plugins_photoManager_photoManager_ts.1108bc71bfa328a53b8b.js.map