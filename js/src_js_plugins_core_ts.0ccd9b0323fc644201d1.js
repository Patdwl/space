...
const loadCorePlugins = (keepTrackApi, plugins) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (plugins.shortTermFences)
            yield Promise.all(/*! import() */[__webpack_require__.e("src_js_plugins_sensor_sensor_ts"), __webpack_require__.e("src_js_plugins_shortTermFences_shortTermFences_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! @app/js/plugins/shortTermFences/shortTermFences */ "./src/js/plugins/shortTermFences/shortTermFences.ts")).then((mod) => mod.init());
        ...
        if (plugins.plotAnalysis)
            yield Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_css-loader_dist_runtime_api_js-node_modules_css-loader_dist_runtime_sour-f22700"), __webpack_require__.e("src_js_plugins_plotAnalysis_plotAnalysis_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! @app/js/plugins/plotAnalysis/plotAnalysis */ "./src/js/plugins/plotAnalysis/plotAnalysis.ts")).then((mod) => mod.init());
        if (plugins.twitter)
...
//# sourceMappingURL=src_js_plugins_core_ts.0ccd9b0323fc644201d1.js.map