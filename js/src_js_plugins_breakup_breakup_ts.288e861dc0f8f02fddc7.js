...
var breakupOnSubmit = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, orbitManager = _a.orbitManager, satellite = _a.satellite, timeManager = _a.timeManager, uiManager = _a.uiManager, satSet = _a.satSet;
    var satId = satSet.getIdFromObjNum(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#hc-scc').val());
    ...
    var launchLat = satellite.degreesLat(TEARR.lat);
    var launchLon = satellite.degreesLong(TEARR.lon);
    var alt = TEARR.alt;
    ...
    var meanmoVariation = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#hc-per').val());
    var incVariation = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#hc-inc').val());
    var rascVariation = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#hc-raan').val());
        ...
        for (var incIterat = 0; incIterat <= 4; incIterat++) {
            for (var meanmoIterat = 0; meanmoIterat <= 4; meanmoIterat++) {
                for (var rascIterat = 0; rascIterat <= 4; rascIterat++) {
                    ...
                    inc = _app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_1__.stringPad.padEmpty(inc, 8);
                    // For the second 30
                    ...
                    iTLE2 = "2 ".concat(80000 + i, " ").concat(inc, " ").concat(iTLE2.substr(17, 35)).concat(meanmo).concat(iTLE2.substr(63));
    ...
    if (iconName === 'menu-breakup') {
        ...
        if (isBreakupMenuOpen) {
            ...
            if (objectManager.selectedSat !== -1) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_2___default()('#hc-scc').val(sat.SCC_NUM);
            }
            else {
                if (settingsManager.plugins.topMenu)
                    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.adviceManager.adviceList.breakupDisabled();
...
//# sourceMappingURL=src_js_plugins_breakup_breakup_ts.288e861dc0f8f02fddc7.js.map