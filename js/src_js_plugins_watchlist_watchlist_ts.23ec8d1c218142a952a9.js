...
var init = function () {
    ...
    uiManager.updateNextPassOverlay = function (nextPassArray, isForceUpdate) {
        ...
        if ((timeManager.now > _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.watchlist.lastOverlayUpdateTime * 1 + 10000 && objectManager.selectedSat === -1 && !cameraManager.isDragging && cameraManager.zoomLevel === cameraManager.zoomTarget) || isForceUpdate) {
            ...
            _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.watchlist.lastOverlayUpdateTime = timeManager.now;
        }
    };
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.register({
        method: 'updateLoop',
...
//# sourceMappingURL=src_js_plugins_watchlist_watchlist_ts.23ec8d1c218142a952a9.js.map