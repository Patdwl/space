...
var bottomMenuClick = function (iconName) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, settingsManager = _a.settingsManager, uiManager = _a.uiManager;
...
var onColorSelected = function (context, colorStr) {
    ...
    context.element.css('cssText', "background-color: ".concat(context.color, " !important; color: ").concat(context.color, ";"));
...
var settingsFormChange = function (e, isDMChecked, isSLMChecked) {
...
var settingsFormSubmit = function (e, isHOSChecked, isDMChecked, isSLMChecked, isSNPChecked) {
    if (typeof e === 'undefined' || e === null)
        throw new Error('e is undefined');
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, satSet = _a.satSet, ColorScheme = _a.ColorScheme;
...
var settingsRisesetChange = function (e, isRiseSetChecked) {
    var satellite = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.satellite;
    if (typeof e === 'undefined' || e === null)
        throw new Error('e is undefined');
...
//# sourceMappingURL=src_js_plugins_settingsMenu_settingsMenu_ts.f641675f89869c9e47b1.js.map