...
const loadingScreenFadeIn = () => {
    const lat = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-lat').val());
    const lon = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-lon').val());
    const alt = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-alt').val());
    const el = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-el').val());
    settingsManager.gpsElevationMask = el;
    _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.satellite.updateDopsTable(lat, lon, alt);
...
//# sourceMappingURL=src_js_plugins_dops_dops_ts.17283f98e1784c9f15ad.js.map