...
`;let Se=!1;const ye=()=>{c.keepTrackApi.register({method:"uiManagerInit",cbName:"initialOrbit",cb:Te}),c.keepTrackApi.register({method:"uiManagerFinal",cbName:"initialOrbit",cb:we}),c.keepTrackApi.register({method:"bottomMenuClick",cbName:"initialOrbit",cb:Ce}),c.keepTrackApi.register({method:"hideSideMenus",cbName:"initialOrbit",cb:Ae}),c.keepTrackApi.register({method:"onHelpMenuClick",cbName:"initialOrbit",cb:Me})},Me=()=>!!Se&&(m.v.showAdvice("Initial Orbit Menu",ke),!0),Ae=()=>{(0,g.kW)((0,p.G)("obfit-menu"),1e3),(0,p.G)("menu-obfit").classList.remove("bmenu-item-selected"),Se=!1},Te=()=>{(0,p.G)("left-menus").insertAdjacentHTML("beforeend",c.keepTrackApi.html`
  ...
  `)},we=()=>{(0,p.G)("obfit-form").addEventListener("submit",(function(e){xe(e)}))},Ce=e=>{if("menu-obfit"===e){const e=l.I.get(r.Yv.UiManager);return Se?(Se=!1,void e.hideSideMenus()):(settingsManager.isMobileModeEnabled&&e.searchManager.searchToggle(!1),e.hideSideMenus(),(0,g.$k)((0,p.G)("obfit-menu"),1e3),Se=!0,void(0,p.G)("menu-obfit").classList.add("bmenu-item-selected"))}},xe=e=>{const{satellite:t}=c.keepTrackApi.programs,a=l.I.get(r.Yv.TimeManager),i=l.I.get(r.Yv.UiManager);let s=!1,n=!1;const o=Ee("obfit-t1"),d=Ee("obfit-x1"),p=Ee("obfit-y1"),u=Ee("obfit-z1"),g=Ee("obfit-xd1"),m=Ee("obfit-yd1"),h=Ee("obfit-zd1"),b=Ee("obfit-t2"),v=Ee("obfit-x2"),f=Ee("obfit-y2"),k=Ee("obfit-z2"),S=Ee("obfit-xd2"),y=Ee("obfit-yd2"),M=Ee("obfit-zd2"),A=Ee("obfit-t3"),T=Ee("obfit-x3"),w=Ee("obfit-y3"),C=Ee("obfit-z3"),x=Ee("obfit-xd3"),L=Ee("obfit-yd3"),E=Ee("obfit-zd3"),I=[];let N=[];if(isNaN(o))return i.toast("Time 1 is Invalid!","critical"),!1;if(isNaN(d))return i.toast("X 1 is Invalid!","critical"),!1;if(isNaN(p))return i.toast("Y 1 is Invalid!","critical"),!1;if(isNaN(u))return i.toast("Z 1 is Invalid!","critical"),!1;if(isNaN(g))return i.toast("X Dot 1 is Invalid!","critical"),!1;if(isNaN(m))return i.toast("Y Dot 1 is Invalid!","critical"),!1;if(isNaN(h))return i.toast("Z Dot 1 is Invalid!","critical"),!1;N=[o,d,p,u,g,m,h],I.push(N);const{isOb:G,sv:P}=Le({isOb:s,obNum:2,t:b,x:v,y:f,z:k,xd:S,yd:y,zd:M,uiManagerInstance:i});s=G,I.push(P),n=!!s&&n;const{isOb:D,sv:R}=Le({isOb:n,obNum:3,t:A,x:T,y:w,z:C,xd:x,yd:L,zd:E,uiManagerInstance:i});return n=D,I.push(R),fe.svs2analyst(I,a,t),e.preventDefault(),!0},Le=({isOb:e,obNum:t,t:a,x:i,y:s,z:n,xd:o,yd:l,zd:r,uiManagerInstance:c})=>{let d=[];return e&&isNaN(a)&&(e=!1,c.toast(`Time ${t} is Invalid!`,"caution")),e&&isNaN(i)&&(e=!1,c.toast(`X ${t} is Invalid!`,"caution")),e&&isNaN(s)&&(e=!1,c.toast(`Y ${t} is Invalid!`,"caution")),e&&isNaN(n)&&(e=!1,c.toast(`Z ${t} is Invalid!`,"caution")),e&&isNaN(o)&&(e=!1,c.toast(`X Dot ${t} is Invalid!`,"caution")),e&&isNaN(l)&&(e=!1,c.toast(`Y Dot ${t} is Invalid!`,"caution")),e&&isNaN(r)&&(e=!1,c.toast(`Z Dot ${t} is Invalid!`,"caution")),e&&(d=[a,i,s,n,o,l,r]),{isOb:e,sv:d}},Ee=e=>{const t=(0,p.G)(e).value;return t.length>0?parseFloat(t):NaN},Ie=a.p+"../img/missile.png",Ne=c.keepTrackApi.html`The Missile Menu is used for generating notional missile launches between countries.
<br><br>
    ...
    <div id="stf-content" class="side-menu">
      <div class="row">
        ...
        <div class="center-align">
          ...
          `,(0,p.G)("nav-mobile2").insertBefore(e,(0,p.G)("nav-mobile2").firstChild)}}const js=new Ys;var Vs=a(6492),Js=a(4427);class Ks extends te.c{constructor(){super(Ks.PLUGIN_NAME),this.isRotateL=!0,this.isRotateR=!1,this.isRotateU=!1,this.isRotateD=!1,this.bottomIconElementName="video-director-icon",this.bottomIconImg=Ps,this.bottomIconLabel="Video Director",this.sideMenuElementName="video-director-menu",this.sideMenuElementHtml=c.keepTrackApi.html`
