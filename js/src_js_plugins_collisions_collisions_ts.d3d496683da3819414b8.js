...
const findFutureDate = (socratesObjTwo, row) => {
    ...
    _api_keepTrackApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.timeManager.changeStaticOffset(selectedDate.getTime() - today.getTime()); // Find the offset from today
...
const processSocratesHtm = (socratesHTM) => {
    ...
    for (let i = 0; i < 20; i++) {
        ...
        tdT.appendChild(document.createTextNode(socratesDate[2] + ' ' + socratesDate[1] + ' ' + socratesDate[0] + ' - ' + _lib_helpers__WEBPACK_IMPORTED_MODULE_2__.stringPad.pad0(socratesTime[0], 2) + ':' + _lib_helpers__WEBPACK_IMPORTED_MODULE_2__.stringPad.pad0(socratesTime[1], 2) + ':' + _lib_helpers__WEBPACK_IMPORTED_MODULE_2__.stringPad.pad0(socratesTimeS[0], 2) + 'Z'));
        tdS1 = tr.insertCell();
...
//# sourceMappingURL=src_js_plugins_collisions_collisions_ts.d3d496683da3819414b8.js.map