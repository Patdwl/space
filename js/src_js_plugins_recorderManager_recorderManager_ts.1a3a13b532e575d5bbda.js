...
/* harmony export */ });
/* harmony import */ var _app_img_icons_video_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @app/img/icons/video.png */ "./src/img/icons/video.png");
...
/* harmony import */ var _app_js_plugins_recorderManager_CanvasRecorder__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @app/js/plugins/recorderManager/CanvasRecorder */ "./src/js/plugins/recorderManager/CanvasRecorder.ts");
...
const uiManagerInit = () => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_3___default()('#bottom-icons').append(_app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.html `
      <div id="menu-record" class="bmenu-item">
        <img alt="video" src="" delayedsrc="${_app_img_icons_video_png__WEBPACK_IMPORTED_MODULE_0__}" />
...
const uiManagerOnReady = () => {
    try {
        recorder = new _app_js_plugins_recorderManager_CanvasRecorder__WEBPACK_IMPORTED_MODULE_2__.CanvasRecorder(settingsManager.videoBitsPerSecond);
    }
    catch (e) {
        console.warn(e);
    }
...
const bottomMenuClick = (iconName) => {
    if (iconName === 'menu-record') {
        if (recorder.checkIfRecording()) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_3___default()('#menu-record').removeClass('bmenu-item-selected');
            return;
        }
        else {
            try {
                ...
                recorder.setIsRecording(false);
                jquery__WEBPACK_IMPORTED_MODULE_3___default()('#menu-record').removeClass('bmenu-item-selected');
                jquery__WEBPACK_IMPORTED_MODULE_3___default()('#menu-record').addClass('bmenu-item-disabled');
                if (!jquery__WEBPACK_IMPORTED_MODULE_3___default()('#menu-record:animated').length) {
                    jquery__WEBPACK_IMPORTED_MODULE_3___default()('#menu-record').effect('shake', {
                        distance: 10,
                    });
                }
            }
...
module.exports = __webpack_require__.p + "544485b6036555927139.png";

/***/ })

}]);
//# sourceMappingURL=src_js_plugins_recorderManager_recorderManager_ts.1a3a13b532e575d5bbda.js.map