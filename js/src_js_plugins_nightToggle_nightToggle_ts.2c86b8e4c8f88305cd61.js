        ...
        cb: (iconName) => {
            if (iconName === 'menu-day-night') {
                if (settingsManager.isDayNightToggle) {
                    settingsManager.isDayNightToggle = false;
                    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-day-night').removeClass('bmenu-item-selected');
                    return;
                }
                else {
                    settingsManager.isDayNightToggle = true;
                    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-day-night').addClass('bmenu-item-selected');
                    return;
                }
            }
        },
...
//# sourceMappingURL=src_js_plugins_nightToggle_nightToggle_ts.2c86b8e4c8f88305cd61.js.map