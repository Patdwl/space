...
var init = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs, sensorManager = _a.sensorManager, satellite = _a.satellite, satSet = _a.satSet, uiManager = _a.uiManager, timeManager = _a.timeManager;
    var isStfMenuOpen = false;
    // Add HTML
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.register({
        ...
        cb: function () {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#stf-on-object-link').on('click', function () {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#stf-az').val(satellite.currentTEARR.az.toFixed(1));
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#stf-el').val(satellite.currentTEARR.el.toFixed(1));
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#stf-rng').val(satellite.currentTEARR.rng.toFixed(1));
                uiManager.hideSideMenus();
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#stf-menu').effect('slide', { direction: 'left', mode: 'show' }, 1000);
                isStfMenuOpen = true;
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-stf').addClass('bmenu-item-selected');
            });
        },
    });
    // Add JavaScript
        ...
        cb: function (iconName) {
            if (iconName === 'menu-stf') {
                if (!sensorManager.checkSensorSelected()) {
                    // No Sensor Selected
                    uiManager.toast("Select a Sensor First!", 'caution', true);
                    if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-stf:animated').length) {
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-stf').effect('shake', {
                            distance: 10,
                        });
                    }
                    return;
    ...
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.register({
        ...
        cbName: 'shortTermFences',
        cb: function () {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-stf').addClass('bmenu-item-disabled');
        },
    });
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.register({
        method: 'setSensor',
        cbName: 'shortTermFences',
        cb: function (sensor, id) {
            if (sensor == null && id == null) {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-stf').addClass('bmenu-item-disabled');
            }
            else {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-stf').removeClass('bmenu-item-disabled');
            }
        },
    });
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.register({
        ...
        cbName: 'shortTermFences',
        cb: function () {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#stf-menu').effect('slide', { direction: 'left', mode: 'hide' }, 1000);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-stf').removeClass('bmenu-item-selected');
            isStfMenuOpen = false;
        },
    });
};
...
//# sourceMappingURL=src_js_plugins_shortTermFences_shortTermFences_ts.3b05d44e83d7362dda36.js.map