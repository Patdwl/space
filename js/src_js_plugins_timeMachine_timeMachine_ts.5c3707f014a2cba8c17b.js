    ...
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.register({
        ...
        cb: function () {
            ...
            orbitManager.playNextSatellite = function (runCount, year) {
                ...
                if (year >= 59 && year < 100) {
                    M.toast({ html: "Time Machine In Year 19".concat(year, "!") });
                }
                else {
                    var yearStr = year < 10 ? "0".concat(year) : "".concat(year);
                    M.toast({ html: "Time Machine In Year 20".concat(yearStr, "!") });
                }
...
//# sourceMappingURL=src_js_plugins_timeMachine_timeMachine_ts.5c3707f014a2cba8c17b.js.map