...
`,this.helpTitle="Analysis Menu",this.helpBody=l.b.html`The Analysis Menu provides a number of tools to help you analyze the data in the current view. The tools are:
  ...
  The larger the variation the bigger the spread in the simulated breakup. The default variations are sufficient to simulate a breakup with a reasonable spread.`,this.selectSatManager_=l.b.getPlugin(p.P)}addHtml(){super.addHtml(),l.b.register({event:o.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,n.Gn)("breakup").addEventListener("submit",(e=>{e.preventDefault(),(0,v.QP)((()=>this.onSubmit_()))}))}}),l.b.register({event:o.RL.selectSatData,cbName:this.PLUGIN_NAME,cb:e=>{(null==e?void 0:e.isSatellite())?(null==e?void 0:e.apogee)-(null==e?void 0:e.perigee)>this.maxDifApogeeVsPerigee_?(this.isMenuButtonActive&&(this.closeSideMenu(),f.x.warn("Cannot create a breakup for non-circular orbits. Working on a fix.")),this.setBottomIconToUnselected(),this.setBottomIconToDisabled()):(this.setBottomIconToEnabled(),this.isMenuButtonActive&&this.updateSccNumInMenu_()):(this.isMenuButtonActive&&this.closeSideMenu(),this.setBottomIconToUnselected(),this.setBottomIconToDisabled())}})}updateSccNumInMenu_(){if(!this.isMenuButtonActive)return;const e=this.selectSatManager_.getSelectedSat(o.C_.EXTRA_ONLY);(null==e?void 0:e.isSatellite())&&((0,n.Gn)("hc-scc").value=e.sccNum)}onSubmit_(){const{simulationTimeObj:e}=l.b.getTimeManager(),t=l.b.getCatalogManager(),{satId:i,breakupCount:a,rascVariation:s,incVariation:n,meanmoVariation:o}=xt.getFormData_(t),r=t.getSat(i),c=r,d=nt.$.calculateTimeVariables(e).gmst,u=(0,y.K7)(r.position,d),p=u.lat,h=u.lon,g=nt.$.getDirection(r,e);"Error"===g&&f.x.warn("Cannot calculate direction of satellite. Try again later.");const m=Lt.l.currentEpoch(e);if(r.tle1=r.tle1.substring(0,18)+m[0]+m[1]+r.tle1.substring(32),l.b.getMainCamera().isAutoPitchYawToTarget=!1,r.apogee-r.perigee>this.maxDifApogeeVsPerigee_)return void f.x.warn("Cannot create a breakup for non-circular orbits. Working on a fix.");const b=r.apogee-r.perigee<300?0:u.alt;let v=new Ct(r,p,h,g,e,b).rotateOrbitToLatLon();const S=v[0],M=v[1],w=new y.oZ(Object.assign(Object.assign({},r),{id:i,tle1:S,tle2:M,active:!0}));t.objectCache[i]=w,t.satCruncher.postMessage({typ:At.Bi.SAT_EDIT,id:i,tle1:S,tle2:M});const C=l.b.getOrbitManager();C.changeOrbitBufferData(i,S,M);const L=15e-5,A=r.eccentricity;let x=0;for(let i=0;i<=4&&!(x>=a);i++){const l=y.Ad.convert6DigitToA5((ft.g.ANALYST_START_ID+x).toString()),d=t.sccNum2Id(l);t.getObject(d);let m=c;const b=-s/2+s*(i/4),v=r.apogee-r.perigee<300?0:u.alt;let S=new Ct(m,p,h,g,e,v,b).rotateOrbitToLatLon();if("Error"===S[0]&&(S=new Ct(m,p,h,g,new Date(e.getTime()+1),v,b).rotateOrbitToLatLon(),"Error"===S[0]))return void f.x.error(new Error(S[1]),"breakup.ts","Error creating breakup!");let w=S[0],k=S[1];for(;x<(i+1)*a/4;x++){let i=parseFloat(M.substring(8,16));i=i+Math.random()*n*2-n;const a=i.toFixed(4).padStart(8,"0");if(8!==a.length)throw new Error(`Inclination length is not 8 - ${a} - ${M}`);m.eccentricity=A,m.eccentricity+=Math.random()*L*2-L;let s=parseFloat(k.substring(52,62));s=s+Math.random()*o*2-o;const l=s.toFixed(8).padStart(11,"0");if(11!==l.length)throw new Error(`meanmo length is not 11 - ${l} - ${k}`);const r=y.Ad.convert6DigitToA5((ft.g.ANALYST_START_ID+x).toString()),c=t.sccNum2Id(r);if(w=`1 ${r}`+w.substring(7),k=`2 ${r} ${a} ${k.substring(17,52)}${l}${k.substring(63)}`,69!==w.length)throw new Error(`Invalid tle1: length is not 69 - ${w}`);if(69!==k.length)throw new Error(`Invalid tle1: length is not 69 - ${k}`);let d;try{d=new y.oZ(Object.assign(Object.assign({},t.objectCache[c]),{id:c,tle1:w,tle2:k,active:!0}))}catch(e){return void f.x.error(e,"breakup.ts","Error creating breakup!")}nt.$.altitudeCheck(d.satrec,e)>1?(t.objectCache[c]=d,t.satCruncher.postMessage({typ:At.Bi.SAT_EDIT,id:c,active:!0,tle1:w,tle2:k}),C.changeOrbitBufferData(c,w,k)):f.x.warn("Breakup Generator Failed")}}a>settingsManager.searchLimit&&(settingsManager.searchLimit=a),l.b.getUiManager().doSearch(`${r.sccNum},Analyst`)}static getFormData_(e){const t=e.sccNum2Id((0,n.Gn)("hc-scc").value),i=parseFloat((0,n.Gn)("hc-per").value),a=parseFloat((0,n.Gn)("hc-inc").value),s=parseFloat((0,n.Gn)("hc-raan").value);return{satId:t,breakupCount:parseInt((0,n.Gn)("hc-count").value),rascVariation:s,incVariation:a,meanmoVariation:i}}}xt.PLUGIN_NAME="Breakup";class kt{static getColors(e){let t,i;switch(e){case"Top Secret//SCI":t="#fce93a",i="black";break;case"Top Secret":t="#ff8c00",i="black";break;case"Secret":t="#ff0000",i="white";break;case"Confidential":t="#0033a0",i="white";break;case"CUI":t="#512b85",i="white";break;case"Unclassified":t="#007a33",i="white";break;default:throw new Error(`Invalid classification: ${e}`)}return{backgroundColor:t,color:i}}static isValidClassification(e){return["Unclassified","Confidential","CUI","Secret","Top Secret","Top Secret//SCI"].includes(e)}}class Et extends u.c{constructor(){super("Classification"),this.isClassificationContainerLoaded_=!1,this.isExpanded_=!1,this.containerDomId="classification-container",this.textStringDomId="classification-string",this.containerHeight=20}init(){super.init(),this.classificationString_=settingsManager.classificationStr||""}updateString(e=this.classificationString_,t="#ffffff",i="#000000"){this.isClassificationContainerLoaded_||this.createContainer_(),""===e?((0,n.Gn)(this.containerDomId).style.display="none",this.updateTopMenuHeight_(!1)):((0,n.Gn)(this.containerDomId).style.display="flex",this.updateTopMenuHeight_(!0)),(0,n.Gn)(this.textStringDomId).innerHTML=e;const a=(0,n.Gn)(this.containerDomId);if(a.style.fontWeight="500",kt.isValidClassification(e)){const a=kt.getColors(e);t=a.backgroundColor,i=a.color}a.style.backgroundColor=t,a.style.color=i,this.classificationString_=e}addHtml(){super.addHtml(),l.b.register({event:o.RL.uiManagerInit,cbName:this.PLUGIN_NAME,cb:this.uiManagerInit_.bind(this)})}createContainer_(){const e=document.createElement("div");e.innerHTML=l.b.html`<span id="${this.textStringDomId}"></span>`,e.id=this.containerDomId,e.style.cssText=`\n      height: ${this.containerHeight}px;\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      `,l.b.containerRoot.insertBefore(e,l.b.containerRoot.firstChild),this.isClassificationContainerLoaded_=!0}uiManagerInit_(){""!==settingsManager.classificationStr?(this.createContainer_(),this.updateString()):f.x.log("Classification string is empty so not loading classification bar")}updateTopMenuHeight_(e){if(this.isExpanded_===e)return;if(!l.b.getPlugin(et.F))return;let t=parseInt(document.documentElement.style.getPropertyValue("--top-menu-height").replace("px",""));isNaN(t)&&(t=0),document.documentElement.style.setProperty("--top-menu-height",t+(e?this.containerHeight:-this.containerHeight)+"px"),this.isExpanded_=e}}new Et;const Tt=i.p+"../img/socrates.png";class It extends u.c{constructor(){super(It.PLUGIN_NAME),this.collisionDataSrc="./tle/SOCRATES.json",this.selectSatIdOnCruncher_=null,this.collisionList_=[],this.bottomIconElementName="menu-satellite-collision",this.bottomIconImg=Tt,this.bottomIconLabel="Collisions",this.sideMenuElementName="socrates-menu",this.sideMenuElementHtml=l.b.html`
  ...
  <br><br>
  Clicking on a row will select the two satellites involved in the collision and change the time to the time of the collision.`,this.dragOptions={isDraggable:!0,minWidth:500,maxWidth:650},this.bottomIconCallback=()=>{this.isMenuButtonActive&&this.parseCollisionData_()}}addJs(){super.addJs(),l.b.register({event:o.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:this.uiManagerFinal_.bind(this)}),l.b.register({event:o.RL.onCruncherMessage,cbName:this.PLUGIN_NAME,cb:()=>{var e;null!==this.selectSatIdOnCruncher_&&(null===(e=l.b.getPlugin(p.P))||void 0===e||e.selectSat(this.selectSatIdOnCruncher_),this.selectSatIdOnCruncher_=null)}})}uiManagerFinal_(){(0,n.Gn)(this.sideMenuElementName).addEventListener("click",(e=>{(0,v.QP)((()=>{var t;const i=e.target.parentElement;if(!i.classList.contains("socrates-object"))return;const a=null===(t=i.dataset)||void 0===t?void 0:t.row;null!==a&&this.eventClicked_(parseInt(a))}))}))}parseCollisionData_(){0===this.collisionList_.length&&fetch(this.collisionDataSrc).then((e=>{e.json().then((e=>{this.collisionList_=e,this.createTable_(),0===this.collisionList_.length&&f.x.warn("No collisions data found!")}))}))}eventClicked_(e){const t=new Date;l.b.getTimeManager().changeStaticOffset(new Date(this.collisionList_[e].toca).getTime()-t.getTime()-3e4),l.b.getMainCamera().isAutoPitchYawToTarget=!1;const i=this.collisionList_[e].sat1.padStart(5,"0"),a=this.collisionList_[e].sat2.padStart(5,"0");l.b.getUiManager().doSearch(`${i},${a}`);const s=l.b.getCatalogManager();this.selectSatIdOnCruncher_=s.sccNum2Id(parseInt(i))}createTable_(){try{const e=(0,n.Gn)("socrates-table");e.innerHTML="",It.createHeaders_(e),this.createBody_(e)}catch(e){f.x.warn("Error processing SOCRATES data!")}}createBody_(e){for(let t=0;t<this.collisionList_.length;t++)this.createRow_(e,t)}static createHeaders_(e){let t=e.insertRow();const i=["TOCA","#1","#2","Max Prob","Min Range (km)","Rel Speed (km/s)"];for(const e of i){const i=t.insertCell();i.appendChild(document.createTextNode(e)),i.setAttribute("style","text-decoration: underline")}}createRow_(e,t){const i=e.insertRow();return i.setAttribute("class","socrates-object link"),i.setAttribute("data-row",t.toString()),It.createCell_(i,this.collisionList_[t].toca.slice(0,19).replace("T"," ")),It.createCell_(i,this.collisionList_[t].sat1),It.createCell_(i,this.collisionList_[t].sat2),It.createCell_(i,this.collisionList_[t].maxProb.toFixed(3)),It.createCell_(i,this.collisionList_[t].minRng.toString()),It.createCell_(i,this.collisionList_[t].relSpeed.toFixed(2)),i}static createCell_(e,t){e.insertCell().appendChild(document.createTextNode(t))}}It.PLUGIN_NAME="collisions";const Nt=()=>{f.x.info("Cruncher failed to meet requirement after two tries!")},Gt=(e,t,i,a=Nt,s=0)=>{e.addEventListener("message",(n=>{i(n.data)?t():s<5?Gt(e,t,i,a,s++):a()}),{once:!0})},_t=i.p+"../img/colors.png";class Pt extends u.c{constructor(){super(Pt.PLUGIN_NAME),this.bottomIconImg=_t,this.bottomIconElementName="menu-color-scheme",this.bottomIconLabel="Color Schemes",this.sideMenuElementName="color-scheme-menu",this.sideMenuElementHtml=l.b.html`
...
`,this.rmbL1ElementName="colors-rmb",this.rmbL1Html=l.b.html`
  ...
  </ul>`,this.rmbCallback=e=>{switch(e){case"colors-default-rmb":Pt.colorsMenuClick("default");break;case"colors-confidence-rmb":Pt.colorsMenuClick("confidence");break;case"colors-rcs-rmb":Pt.colorsMenuClick("rcs");break;case"colors-density-rmb":Pt.colorsMenuClick("neighbors");break;case"colors-sunlight-rmb":Pt.colorsMenuClick("sunlight");break;case"colors-country-rmb":Pt.colorsMenuClick("countries");break;case"colors-velocity-rmb":Pt.colorsMenuClick("velocity");break;case"colors-ageOfElset-rmb":Pt.colorsMenuClick("elset-age")}},this.dragOptions={isDraggable:!0}}addHtml(){super.addHtml(),l.b.register({event:o.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,n.Gn)("colors-menu").querySelectorAll("li").forEach((e=>{e.addEventListener("click",(function(){const e=this.dataset.color;Pt.colorsMenuClick(e)}))}))}})}}Pt.PLUGIN_NAME="Color Menu",Pt.colorsMenuClick=e=>{var t;const i=l.b.getCatalogManager(),a=l.b.getColorSchemeManager(),s=l.b.getUiManager();switch(null===(t=l.b.getPlugin(p.P))||void 0===t||t.selectSat(-1),"sunlight"!==e&&i.satCruncher.postMessage({isSunlightView:!1,typ:At.Bi.SUNLIGHT_VIEW}),e){case"default":ht.j.change("default"),a.setColorScheme(a.default,!0),s.colorSchemeChangeAlert(a.currentColorScheme);break;case"confidence":ht.j.change("confidence"),a.setColorScheme(a.confidence,!0),s.colorSchemeChangeAlert(a.currentColorScheme);break;case"velocity":ht.j.change("velocity"),a.setColorScheme(a.velocity,!0),s.colorSchemeChangeAlert(a.currentColorScheme);break;case"sunlight":i.satCruncher.postMessage({isSunlightView:!0,typ:At.Bi.SUNLIGHT_VIEW}),ht.j.change("sunlight"),s.colorSchemeChangeAlert(a.sunlight),Gt(i.satCruncher,(()=>{a.setColorScheme(a.sunlight,!0)}),(e=>e.satInSun));break;case"near-earth":ht.j.change("near"),a.setColorScheme(a.leo,!0),s.colorSchemeChangeAlert(a.currentColorScheme);break;case"deep-space":ht.j.change("deep"),a.setColorScheme(a.geo,!0),s.colorSchemeChangeAlert(a.currentColorScheme);break;case"elset-age":(0,v.QP)((()=>{ht.j.change("ageOfElset"),a.setColorScheme(a.ageOfElset,!0),s.colorSchemeChangeAlert(a.currentColorScheme)}));break;case"lost-objects":(0,n.Gn)("search").value="",(0,v.QP)((()=>{settingsManager.lostSatStr="",a.setColorScheme(a.lostobjects,!0),(0,n.Gn)("search").value=settingsManager.lostSatStr,s.colorSchemeChangeAlert(a.currentColorScheme),s.doSearch((0,n.Gn)("search").value)}));break;case"rcs":ht.j.change("rcs"),a.setColorScheme(a.rcs,!0),s.colorSchemeChangeAlert(a.currentColorScheme);break;case"smallsats":ht.j.change("small"),a.setColorScheme(a.smallsats,!0),s.colorSchemeChangeAlert(a.currentColorScheme);break;case"neighbors":ht.j.change("neighbors"),a.setColorScheme(a.neighbors,!0),s.colorSchemeChangeAlert(a.currentColorScheme);break;case"countries":ht.j.change("countries"),null!==l.b.getGroupsManager().selectedGroup?a.setColorScheme(a.groupCountries,!0):a.setColorScheme(a.countries,!0),s.colorSchemeChangeAlert(a.currentColorScheme)}l.b.getUiManager().hideSideMenus()};const Rt=new Pt;var Ot=i(3934),Dt=i(6279);class Ft extends u.c{constructor(){super(Ft.PLUGIN_NAME),this.dependencies=[p.P.PLUGIN_NAME],this.bottomIconCallback=()=>{if(this.verifySatelliteSelected()&&this.isMenuButtonActive){const e=l.b.getCatalogManager().getObject(this.selectSatManager_.selectedSat,o.C_.EXTRA_ONLY);(0,n.Gn)(`${this.formPrefix_}-scc`).value=e.sccNum}},this.formPrefix_="ds",this.bottomIconElementName="debris-screening-icon",this.bottomIconImg=it,this.bottomIconLabel="Debris Screening",this.sideMenuElementName="debris-screening-menu",this.sideMenuElementHtml=l.b.html`
...
`,this.rmbCallback=e=>{switch(e){case"dops-curdops-rmb":{let e=l.b.getInputManager().mouse.latLon;const t=l.b.getInputManager().mouse.dragPosition;if(void 0===e||isNaN(e.lat)||isNaN(e.lon)){console.debug("latLon undefined!");const i=nt.$.calculateTimeVariables(l.b.getTimeManager().simulationTimeObj).gmst;e=(0,y.K7)({x:t[0],y:t[1],z:t[2]},i)}const i=Vt.getGpsSats(l.b.getCatalogManager(),l.b.getGroupsManager()),a=jt.getDops(l.b.getTimeManager().simulationTimeObj,i,e.lat,e.lon,0,settingsManager.gpsElevationMask);l.b.getUiManager().toast(`HDOP: ${a.hdop}<br/>VDOP: ${a.vdop}<br/>PDOP: ${a.pdop}<br/>GDOP: ${a.gdop}<br/>TDOP: ${a.tdop}`,"normal",!0)}break;case"dops-24dops-rmb":{const e=l.b.getInputManager().mouse.latLon;if(this.isMenuButtonActive){(0,v.QP)(Vt.updateSideMenu),this.setBottomIconToEnabled();break}(0,n.Gn)("dops-lat").value=e.lat.toFixed(3),(0,n.Gn)("dops-lon").value=e.lon.toFixed(3),(0,n.Gn)("dops-alt").value="0",(0,n.Gn)("dops-el").value=settingsManager.gpsElevationMask.toString(),l.b.runEvent(o.RL.bottomMenuClick,this.bottomIconElementName)}}}}addJs(){super.addJs(),l.b.register({event:o.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,n.Gn)("dops-form").addEventListener("submit",(e=>{e.preventDefault(),Vt.updateSideMenu()}))}})}static updateSideMenu(){const e=l.b.getGroupsManager(),t=l.b.getCatalogManager(),i=l.b.getTimeManager(),a=parseFloat((0,n.Gn)("dops-lat").value),s=parseFloat((0,n.Gn)("dops-lon").value),o=parseFloat((0,n.Gn)("dops-alt").value),r=parseFloat((0,n.Gn)("dops-el").value);settingsManager.gpsElevationMask=r;const c=Vt.getGpsSats(t,e),d=jt.getDopsList((e=>i.getOffsetTimeObj(e)),c,a,s,o,r);jt.updateDopsTable(d)}static getGpsSats(e,t){var i,a;const s=null!==(i=(a=t.groupList).GPSGroup)&&void 0!==i?i:a.GPSGroup=t.createGroup(r.Y.NAME_REGEX,/NAVSTAR/iu,"GPSGroup"),n=[];return s.ids.forEach((t=>{const i=e.getSat(t);i&&n.push(i)})),n}}Vt.PLUGIN_NAME="DOPs Plugin";const Kt=new Vt,Wt=i.p+"../img/edit.png";class Yt extends u.c{constructor(){super(Yt.PLUGIN_NAME),this.dependencies=[p.P.PLUGIN_NAME],this.isRequireSatelliteSelected=!0,this.isIconDisabled=!0,this.isIconDisabledOnLoad=!0,this.helpTitle="Edit Satellite Menu",this.helpBody=l.b.html`The Edit Satellite Menu is used to edit the satellite data.
  ...
  </ul>`,this.rmbCallback=e=>{const t=l.b.getSensorManager(),i=l.b.getColorSchemeManager(),a=l.b.getUiManager(),s=l.b.getCatalogManager(),o=l.b.getInputManager().mouse;switch(e){case"create-observer-rmb":(0,C.$k)((0,n.Gn)("custom-sensor-menu"),1e3),(0,n.Gn)("custom-sensor-icon").classList.add("bmenu-item-selected"),t.isCustomSensorMenuOpen=!0,(0,n.Gn)("cs-telescope").checked||(0,n.Gn)("cs-telescope").click(),(0,n.Gn)("cs-lat").value=o.latLon.lat.toString(),(0,n.Gn)("cs-lon").value=o.latLon.lon.toString(),(0,n.Gn)("cs-hei").value="0",(0,n.Gn)("cs-type").value="Observer",ga((0,n.Gn)("customSensor")),s.satCruncher.postMessage({isSunlightView:!0,typ:At.Bi.SUNLIGHT_VIEW}),ht.j.change("sunlight"),a.colorSchemeChangeAlert(i.sunlight),Gt(s.satCruncher,(()=>{i.setColorScheme(i.sunlight,!0)}),(e=>e.satInSun));break;case"create-sensor-rmb":(0,C.$k)((0,n.Gn)("custom-sensor-menu"),1e3),(0,n.Gn)("custom-sensor-icon").classList.add("bmenu-item-selected"),t.isCustomSensorMenuOpen=!0,(0,n.Gn)("cs-telescope").checked&&(0,n.Gn)("cs-telescope").click(),(0,n.Gn)("cs-lat").value=o.latLon.lat.toString(),(0,n.Gn)("cs-lon").value=o.latLon.lon.toString(),(0,n.Gn)("cs-hei").value="0",(0,n.Gn)("cs-type").value="Phased Array Radar",(0,n.Gn)("cs-minaz").value="0",(0,n.Gn)("cs-maxaz").value="360",(0,n.Gn)("cs-minel").value="10",(0,n.Gn)("cs-maxel").value="90",(0,n.Gn)("cs-minrange").value="0",(0,n.Gn)("cs-maxrange").value="5556",ga((0,n.Gn)("customSensor")),ht.j.change("default"),i.setColorScheme(i.default,!0),a.colorSchemeChangeAlert(settingsManager.currentColorScheme),s.satCruncher.postMessage({isSunlightView:!1,typ:At.Bi.SUNLIGHT_VIEW})}},this.dragOptions={isDraggable:!0},this.helpTitle="Custom Sensor Menu",this.helpBody=l.b.html`
