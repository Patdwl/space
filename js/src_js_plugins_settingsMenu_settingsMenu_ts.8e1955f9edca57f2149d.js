            ...
            (function () {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_1___default()('#settings-color-payload').colorPick({
                    ...
                    onColorSelected: function () {
                        this.element.css('cssText', "background-color: ".concat(this.color, " !important; color: ").concat(this.color, ";"));
...
//# sourceMappingURL=src_js_plugins_settingsMenu_settingsMenu_ts.8e1955f9edca57f2149d.js.map