...
/***/ "./src/js/satSet/satVmagManager.js":
/*!*****************************************!*\
  !*** ./src/js/satSet/satVmagManager.js ***!
  \*****************************************/
...
/* harmony export */   "satVmagManager": () => (/* binding */ satVmagManager)
/* harmony export */ });
var satVmagManager = {};
...
satVmagManager.init = function (satSet) {
  ...
  for (var _i = 0; _i < satVmagManager.sats.length; _i++) {
    satSet.vmagUpdate(satVmagManager.sats[_i]);
  }
};

satVmagManager.starlink = [// Batch 1
{
  satid: 44235,
  vmag: -3
}, {
...
/* harmony import */ var _app_js_satSet_satVmagManager_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @app/js/satSet/satVmagManager.js */ "./src/js/satSet/satVmagManager.js");
 ...
 */
var catalogLoader = function () { return __awaiter(void 0, void 0, void 0, function () {
    var settingsManager, extraSats_1, asciiCatalog_1, e_1;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (settingsManager.offline) {
                    $.get("".concat(settingsManager.installDirectory, "tle/extra.json")).then(function (resp) {
                        extraSats_1 = JSON.parse(resp);
                    });
                }
                asciiCatalog_1 = [];
                if (!settingsManager.isDisableAsciiCatalog) {
                    $.get("".concat(settingsManager.installDirectory, "tle/TLE.txt")).then(function (resp) {
                ...
                if (!settingsManager.isUseDebrisCatalog) return [3 /*break*/, 3];
                return [4 /*yield*/, $.get("".concat(settingsManager.installDirectory, "tle/TLEdebris.json")).then(function (resp) { return parseCatalog(resp, extraSats_1, asciiCatalog_1); })];
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, $.get("".concat(settingsManager.installDirectory, "tle/TLE.json")).then(function (resp) { return parseCatalog(resp, extraSats_1, asciiCatalog_1); })];
            case 4:
                _a.sent();
                _a.label = 5;
...
var parseCatalog = function (resp, extraSats, asciiCatalog) {
    ...
    var limitSatsArray = setupGetVariables();
    // Filter TLEs
    ...
    try {
        if (typeof satSet.getSat(satSet.getIdFromObjNum(44235)).vmag == 'undefined') {
            _app_js_satSet_satVmagManager_js__WEBPACK_IMPORTED_MODULE_2__.satVmagManager.init(satSet);
        }
    }
    catch (e) {
...
var setupGetVariables = function () {
...
var filterTLEDatabase = function (resp, limitSatsArray, extraSats, asciiCatalog) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, dotsManager = _a.dotsManager, objectManager = _a.objectManager, satSet = _a.satSet;
    var tempSatData = [];
    satSet.sccIndex = {};
    satSet.cosparIndex = {};
    ...
    for (i = 0; i < resp.length; i++) {
        resp[i].SCC_NUM = _app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_1__.stringPad.pad0(resp[i].TLE1.substr(2, 5).trim(), 5);
        if (settingsManager.limitSats === '') {
            ...
            resp[i].id = i;
            satSet.sccIndex["".concat(resp[i].SCC_NUM)] = resp[i].id;
            satSet.cosparIndex["".concat(resp[i].intlDes)] = resp[i].id;
            resp[i].active = true;
    ...
    if (typeof extraSats !== 'undefined' && settingsManager.offline) {
        // If extra catalogue
        for (var s = 0; s < extraSats.length; s++) {
            ...
            if (typeof extraSats[s].TLE2 == 'undefined')
                continue; // Don't Process Bad Satellite Information
            if (typeof satSet.sccIndex["".concat(extraSats[s].SCC)] !== 'undefined') {
                i = satSet.sccIndex["".concat(extraSats[s].SCC)];
                ...
                satSet.sccIndex["".concat(extraSats[s].SCC.toString())] = tempSatData.length;
                satSet.cosparIndex["".concat(year, "-").concat(rest)] = tempSatData.length;
    ...
    if (typeof asciiCatalog !== 'undefined' && settingsManager.offline) {
        ...
        for (var s = 0; s < asciiCatalog.length; s++) {
            if (typeof asciiCatalog[s].TLE1 == 'undefined')
                continue; // Don't Process Bad Satellite Information
            if (typeof asciiCatalog[s].TLE2 == 'undefined')
                continue; // Don't Process Bad Satellite Information
            if (typeof satSet.sccIndex["".concat(asciiCatalog[s].SCC)] !== 'undefined') {
                i = satSet.sccIndex["".concat(asciiCatalog[s].SCC)];
                ...
                satSet.sccIndex["".concat(asciiCatalog[s].SCC.toString())] = tempSatData.length;
                satSet.cosparIndex["".concat(year, "-").concat(rest)] = tempSatData.length;
    ...
    if (settingsManager.isExtraSatellitesAdded) {
        ...
        try {
            ...
            $('.legend-trusat-box')[1].parentElement.innerHTML = "<div class=\"Square-Box legend-trusat-box\"></div>".concat(settingsManager.nameOfSpecialSats);
            $('.legend-trusat-box')[2].parentElement.innerHTML = "<div class=\"Square-Box legend-trusat-box\"></div>".concat(settingsManager.nameOfSpecialSats);
            $('.legend-trusat-box')[3].parentElement.innerHTML = "<div class=\"Square-Box legend-trusat-box\"></div>".concat(settingsManager.nameOfSpecialSats);
        }
        catch (e) {
            // Intentionally Blank
        }
    ...
    if (settingsManager.isEnableGsCatalog)
        satSet.initGsData();
    ...
    for (var i_1 = 0; i_1 < objectManager.radarDataSet.length; i_1++) {
        tempSatData.push(objectManager.radarDataSet[i_1]);
    }
...
//# sourceMappingURL=src_js_plugins_catalogLoader_catalogLoader_ts.c3ce5e5cd917736433c5.js.map