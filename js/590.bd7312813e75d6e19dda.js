...
`;let P=!1;const O=()=>{r.bD.register({event:"uiManagerInit",cbName:"initialOrbit",cb:F}),r.bD.register({event:"uiManagerFinal",cbName:"initialOrbit",cb:U}),r.bD.register({event:"bottomMenuClick",cbName:"initialOrbit",cb:B}),r.bD.register({event:"hideSideMenus",cbName:"initialOrbit",cb:_}),r.bD.register({event:"onHelpMenuClick",cbName:"initialOrbit",cb:R})},R=()=>!!P&&(N.v.showAdvice("Initial Orbit Menu",G),!0),_=()=>{(0,m.kW)((0,o.Gn)("obfit-menu"),1e3),(0,o.Gn)("menu-obfit").classList.remove("bmenu-item-selected"),P=!1},F=()=>{(0,o.Gn)("left-menus").insertAdjacentHTML("beforeend",r.bD.html`
  ...
  `),(0,o.Gn)("bottom-icons").insertAdjacentHTML("beforeend",r.bD.html`
  ...
  `)},U=()=>{(0,o.Gn)("obfit-form").addEventListener("submit",(function(e){z(e)}))},B=e=>{if("menu-obfit"===e){const e=r.bD.getUiManager();return P?(P=!1,void e.hideSideMenus()):(settingsManager.isMobileModeEnabled&&e.searchManager.searchToggle(!1),e.hideSideMenus(),(0,m.$k)((0,o.Gn)("obfit-menu"),1e3),P=!0,void(0,o.Gn)("menu-obfit").classList.add("bmenu-item-selected"))}},z=e=>{const t=r.bD.getTimeManager(),i=r.bD.getUiManager();let a=!1,s=!1;const n=H("obfit-t1"),o=H("obfit-x1"),l=H("obfit-y1"),c=H("obfit-z1"),d=H("obfit-xd1"),u=H("obfit-yd1"),g=H("obfit-zd1"),p=H("obfit-t2"),h=H("obfit-x2"),m=H("obfit-y2"),b=H("obfit-z2"),v=H("obfit-xd2"),f=H("obfit-yd2"),S=H("obfit-zd2"),M=H("obfit-t3"),y=H("obfit-x3"),w=H("obfit-y3"),C=H("obfit-z3"),L=H("obfit-xd3"),x=H("obfit-yd3"),D=H("obfit-zd3"),E=[];let T=[];if(isNaN(n))return i.toast("Time 1 is Invalid!","critical"),!1;if(isNaN(o))return i.toast("X 1 is Invalid!","critical"),!1;if(isNaN(l))return i.toast("Y 1 is Invalid!","critical"),!1;if(isNaN(c))return i.toast("Z 1 is Invalid!","critical"),!1;if(isNaN(d))return i.toast("X Dot 1 is Invalid!","critical"),!1;if(isNaN(u))return i.toast("Y Dot 1 is Invalid!","critical"),!1;if(isNaN(g))return i.toast("Z Dot 1 is Invalid!","critical"),!1;T=[n,o,l,c,d,u,g],E.push(T);const{isOb:A,sv:k}=$({isOb:a,obNum:2,t:p,x:h,y:m,z:b,xd:v,yd:f,zd:S,uiManagerInstance:i});a=A,E.push(k),s=!!a&&s;const{isOb:N,sv:G}=$({isOb:s,obNum:3,t:M,x:y,y:w,z:C,xd:L,yd:x,zd:D,uiManagerInstance:i});return s=N,E.push(G),I.svs2analyst(E,t),e.preventDefault(),!0},$=({isOb:e,obNum:t,t:i,x:a,y:s,z:n,xd:o,yd:l,zd:r,uiManagerInstance:c})=>{let d=[];return e&&isNaN(i)&&(e=!1,c.toast(`Time ${t} is Invalid!`,"caution")),e&&isNaN(a)&&(e=!1,c.toast(`X ${t} is Invalid!`,"caution")),e&&isNaN(s)&&(e=!1,c.toast(`Y ${t} is Invalid!`,"caution")),e&&isNaN(n)&&(e=!1,c.toast(`Z ${t} is Invalid!`,"caution")),e&&isNaN(o)&&(e=!1,c.toast(`X Dot ${t} is Invalid!`,"caution")),e&&isNaN(l)&&(e=!1,c.toast(`Y Dot ${t} is Invalid!`,"caution")),e&&isNaN(r)&&(e=!1,c.toast(`Z Dot ${t} is Invalid!`,"caution")),e&&(d=[i,a,s,n,o,l,r]),{isOb:e,sv:d}},H=e=>{const t=(0,o.Gn)(e).value;return t.length>0?parseFloat(t):NaN},j=i.p+"../img/missile.png";var V=i(7705);const K=r.bD.html`The Missile Menu is used for generating notional missile launches between countries.
<br><br>
...
`;var W=i(4378);let Y=!1,J=!1,X=0;const Z=()=>{if(void 0!==W.CC&&W.CC.missileArray.length>0){const e=r.bD.getOrbitManager();for(X=0;X<W.CC.missileArray.length;X++)e.updateOrbitBuffer(W.CC.missileArray[X].id)}},q=()=>{(0,m.kW)((0,o.Gn)("missile-menu"),1e3),(0,o.Gn)("menu-missile").classList.remove("bmenu-item-selected"),Y=!1},Q=e=>{if("menu-missile"===e){const e=r.bD.getUiManager();return Y?(Y=!1,void e.hideSideMenus()):(settingsManager.isMobileModeEnabled&&e.searchManager.searchToggle(!1),e.hideSideMenus(),(0,m.$k)((0,o.Gn)("missile-menu"),1e3),(0,o.Gn)("menu-missile").classList.add("bmenu-item-selected"),void(Y=!0))}},ee=()=>{0!==parseFloat((0,o.Gn)("ms-type").value)?(0,o.Gn)("ms-custom-opt").style.display="none":(0,o.Gn)("ms-custom-opt").style.display="block"},te=()=>{(0,o.Gn)("ms-error").style.display="none"},ie=()=>{-1!==parseInt((0,o.Gn)("ms-target").value)?((0,o.Gn)("ms-tgt-holder-lat").style.display="none",(0,o.Gn)("ms-tgt-holder-lon").style.display="none"):((0,o.Gn)("ms-tgt-holder-lat").style.display="block",(0,o.Gn)("ms-tgt-holder-lon").style.display="block")},ae=()=>{(0,V.QP)((()=>{const e=r.bD.getTimeManager(),t=r.bD.getUiManager();(0,o.Gn)("ms-error").style.display="none";const i=parseFloat((0,o.Gn)("ms-type").value),a=parseFloat((0,o.Gn)("ms-attacker").value);let s=parseFloat((0,o.Gn)("ms-lat-lau").value),n=parseFloat((0,o.Gn)("ms-lon-lau").value);const l=parseFloat((0,o.Gn)("ms-target").value);let c=parseFloat((0,o.Gn)("ms-lat").value),d=parseFloat((0,o.Gn)("ms-lon").value);const u=e.selectedDate.getTime();let g="";if(1===i&&(g="simulation/Russia2USA.json",W.CC.MassRaidPre(u,g)),2===i&&(g="simulation/Russia2USAalt.json",W.CC.MassRaidPre(u,g)),3===i&&(g="simulation/China2USA.json",W.CC.MassRaidPre(u,g)),4===i&&(g="simulation/NorthKorea2USA.json",W.CC.MassRaidPre(u,g)),5===i&&(g="simulation/USA2Russia.json",W.CC.MassRaidPre(u,g)),6===i&&(g="simulation/USA2China.json",W.CC.MassRaidPre(u,g)),7===i&&(g="simulation/USA2NorthKorea.json",W.CC.MassRaidPre(u,g)),0!==i&&t.toast(`${g} Loaded`,"standby",!0),0===i){if(-1===l){if(isNaN(c))return t.toast("Invalid Target Latitude!","critical"),void((0,o.Gn)("loading-screen").style.display="none");if(isNaN(d))return t.toast("Invalid Target Longitude!","critical"),void((0,o.Gn)("loading-screen").style.display="none")}else c=W.CC.globalBMTargets[3*l],d=W.CC.globalBMTargets[3*l+1];if(J){if(isNaN(s))return t.toast("Invalid Launch Latitude!","critical"),void((0,o.Gn)("loading-screen").style.display="none");if(isNaN(n))return t.toast("Invalid Launch Longitude!","critical"),void((0,o.Gn)("loading-screen").style.display="none")}let e,i;const g=r.bD.getCatalogManager();if(a<200){e=a-100,i=500-W.CC.missilesInUse;let t=1200;100!=a&&(s=W.CC.UsaICBM[4*e],n=W.CC.UsaICBM[4*e+1],t=1100),W.CC.Missile(s,n,c,d,3,g.missileSats-i,u,W.CC.UsaICBM[4*e+2],30,2.9,.07,W.CC.UsaICBM[4*e+3],"United States",t)}else if(a<300){e=a-200,i=500-W.CC.missilesInUse;const t=1120;213!=a&&214!=a&&215!=a&&(s=W.CC.RussianICBM[4*e],n=W.CC.RussianICBM[4*e+1]),W.CC.Missile(s,n,c,d,3,g.missileSats-i,u,W.CC.RussianICBM[4*e+2],30,2.9,.07,W.CC.RussianICBM[4*e+3],"Russia",t)}else if(a<400){e=a-300,i=500-W.CC.missilesInUse;const t=1120;321!=a&&(s=W.CC.ChinaICBM[4*e],n=W.CC.ChinaICBM[4*e+1]),W.CC.Missile(s,n,c,d,3,g.missileSats-i,u,W.CC.ChinaICBM[4*e+2],30,2.9,.07,W.CC.ChinaICBM[4*e+3],"China",t)}else if(a<500){e=a-400,i=500-W.CC.missilesInUse;const t=1120;400!=a&&(s=W.CC.NorthKoreanBM[4*e],n=W.CC.NorthKoreanBM[4*e+1]),W.CC.Missile(s,n,c,d,3,g.missileSats-i,u,W.CC.NorthKoreanBM[4*e+2],30,2.9,.07,W.CC.NorthKoreanBM[4*e+3],"North Korea",t)}else if(a<600){e=a-500,i=500-W.CC.missilesInUse;const t=1e3;500!=a&&(s=W.CC.FraSLBM[4*e],n=W.CC.FraSLBM[4*e+1]),W.CC.Missile(s,n,c,d,3,g.missileSats-i,u,W.CC.FraSLBM[4*e+2],30,2.9,.07,W.CC.FraSLBM[4*e+3],"France",t)}else if(a<700){e=a-600,i=500-W.CC.missilesInUse;const t=1200;600!=a&&(s=W.CC.ukSLBM[4*e],n=W.CC.ukSLBM[4*e+1]),W.CC.Missile(s,n,c,d,3,g.missileSats-i,u,W.CC.ukSLBM[4*e+2],30,2.9,.07,W.CC.ukSLBM[4*e+3],"United Kigndom",t)}t.toast(W.CC.lastMissileError,W.CC.lastMissileErrorType),t.doSearch("RV_")}(0,o.Gn)("loading-screen").style.display="none"}))},se=()=>{(0,o.Gn)("left-menus").insertAdjacentHTML("beforeend",r.bD.html`
      ...
      `),(0,o.Gn)("bottom-icons").insertAdjacentHTML("beforeend",r.bD.html`
        ...
        `)},ne=()=>{r.bD.getUiManager().doSearch("RV_")},oe=()=>{(0,n.E)((0,o.Gn)("missile-menu")),(0,o.Gn)("missile").addEventListener("submit",(e=>{e.preventDefault(),ae()})),(0,o.Gn)("ms-attacker").addEventListener("change",ce),(0,o.Gn)("ms-target").addEventListener("change",ie),(0,o.Gn)("ms-error").addEventListener("click",te),(0,o.Gn)("missile").addEventListener("change",ee),(0,o.Gn)("searchRvBtn").addEventListener("click",ne),ce(),ie()},le=()=>{r.bD.register({event:"uiManagerInit",cbName:"missile",cb:se}),r.bD.register({event:"uiManagerFinal",cbName:"missile",cb:oe}),r.bD.register({event:"bottomMenuClick",cbName:"missile",cb:Q}),r.bD.register({event:"hideSideMenus",cbName:"missile",cb:q}),r.bD.register({event:"updateLoop",cbName:"updateMissileOrbits",cb:Z}),r.bD.register({event:"onHelpMenuClick",cbName:"missile",cb:re})},re=()=>!!Y&&(N.v.showAdvice("Missile Menu",K),!0),ce=()=>{J=!1;const e=[100,600,213,214,215,321,500,400];for(let t=0;t<e.length;t++)e[t]==parseInt((0,o.Gn)("ms-attacker").value)&&(J=!0);J?((0,o.Gn)("ms-lau-holder-lat").style.display="block",(0,o.Gn)("ms-lau-holder-lon").style.display="block"):((0,o.Gn)("ms-lau-holder-lat").style.display="none",(0,o.Gn)("ms-lau-holder-lon").style.display="none")},de=i.p+"../img/sat3.png";var ue=i(4579),ge=i(6156);class pe extends u.c{constructor(){super("Satellite View"),this.bottomIconElementName="menu-satview",this.bottomIconLabel="Satellite View",this.bottomIconImg=de,this.isIconDisabledOnLoad=!0,this.bottomIconCallback=()=>{r.bD.getMainCamera().cameraType===ge.iM.SATELLITE?(r.bD.getUiManager().hideSideMenus(),r.bD.getMainCamera().cameraType=ge.iM.FIXED_TO_SAT,(0,o.Gn)(this.bottomIconElementName).classList.remove("bmenu-item-selected")):-1!==r.bD.getCatalogManager().selectedSat?(r.bD.getMainCamera().cameraType=ge.iM.SATELLITE,(0,o.Gn)(this.bottomIconElementName).classList.add("bmenu-item-selected")):(r.bD.getUiManager().toast("Select a Satellite First!","caution"),(0,ue.l)((0,o.Gn)(this.bottomIconElementName)))},this.lastLongAudioTime=0}}const he=new pe,me=i.p+"../audio/beep1.mp3",be=i.p+"../audio/button.mp3",ve=i.p+"../audio/error.mp3",fe=i.p+"../audio/genericBeep1.mp3",Se=i.p+"../audio/genericBeep2.mp3",Me=i.p+"../audio/genericBeep3.mp3",ye=i.p+"../audio/liftoff.mp3",we=i.p+"../audio/pop.mp3",Ce=i.p+"../audio/switch.mp3",Le=i.p+"../audio/toggle-off.mp3",xe=i.p+"../audio/toggle-on.mp3",De=i.p+"../audio/whoosh1.mp3",Ee=i.p+"../audio/whoosh2.mp3",Te=i.p+"../audio/whoosh3.mp3",Ae=i.p+"../audio/whoosh4.mp3",ke=i.p+"../audio/whoosh5.mp3",Ie=i.p+"../audio/whoosh6.mp3",Ne=i.p+"../audio/whoosh7.mp3",Ge=i.p+"../audio/whoosh8.mp3";var Pe=i(8461),Oe=i(2349);class Re extends u.c{constructor(){super("Sound Manager"),this.lastLongAudioTimne=0,this.isMute=!1,this.voices=[],this.sounds={standby:new Audio(we),error:new Audio(ve),click:new Audio(Ce),beep1:new Audio(me),genericBeep1:new Audio(fe),genericBeep2:new Audio(Se),genericBeep3:new Audio(Me),whoosh1:new Audio(De),whoosh2:new Audio(Ee),whoosh3:new Audio(Te),whoosh4:new Audio(Ae),whoosh5:new Audio(ke),whoosh6:new Audio(Ie),whoosh7:new Audio(Ne),whoosh8:new Audio(Ge),button:new Audio(be),toggleOn:new Audio(xe),toggleOff:new Audio(Le),liftoff:new Audio(ye)},this.addJs=()=>{super.addJs(),Pe.I.registerSingleton(Oe.Yv.SoundManager,this),r.bD.register({event:"uiManagerInit",cbName:this.PLUGIN_NAME,cb:()=>{this.voices=speechSynthesis.getVoices()}})}}speak(e){if(this.isMute)return;const t=new SpeechSynthesisUtterance;t.text=e,t.volume=.5,t.rate=1,t.pitch=1,t.voice=this.voices.filter((function(e){return"Google UK English Female"==e.name}))[0],window.speechSynthesis.speak(t)}play(e){if("complete"===document.readyState){if(this.isMute)return;if((0,o.Gn)("loading-screen").classList.contains("fullscreen"))return;let t=1;switch(e){case"genericBeep":return t=Math.floor(3*Math.random())+1,void this.sounds[`genericBeep${t}`].play();case"whoosh":return t=Math.floor(8*Math.random())+1,void this.sounds[`whoosh${t}`].play();case"error":if(this.lastLongAudioTimne+12e5>Date.now())return;return this.lastLongAudioTimne=Date.now(),void this.sounds.error.play();default:return void this.sounds[e].play()}}}}const _e=new Re;var Fe=i(6339),Ue=i(5661);const Be=i.p+"../img/about.png";class ze extends u.c{constructor(){super("About Menu"),this.bottomIconElementName="menu-about-icon",this.bottomIconImg=Be,this.bottomIconLabel="About Menu",this.sideMenuElementName="about-menu",this.sideMenuElementHtml=r.bD.html`
...
`,this.helpTitle="Analysis Menu",this.helpBody=r.bD.html`The Analysis Menu provides a number of tools to help you analyze the data in the current view. The tools are:
  ...
  The larger the variation the bigger the spread in the simulated breakup. The default variations are sufficient to simulate a breakup with a reasonable spread.`}updateSccNumInMenu_(){if(!this.isMenuButtonActive)return;const e=r.bD.getCatalogManager().getSat(r.bD.getCatalogManager().selectedSat,Oe.C_.EXTRA_ONLY);(0,o.Gn)("hc-scc").value=e.sccNum}addHtml(){super.addHtml(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,o.Gn)("breakup").addEventListener("submit",(e=>{e.preventDefault(),(0,V.QP)((()=>this.onSubmit()))}))}}),r.bD.register({event:r.RL.selectSatData,cbName:this.PLUGIN_NAME,cb:e=>{(null==e?void 0:e.TLE1)?(null==e?void 0:e.apogee)-(null==e?void 0:e.perigee)>this.maxDifApogeeVsPerigee_?(this.isMenuButtonActive&&(this.closeSideMenu(),v.x.warn("Cannot create a breakup for non-circular orbits. Working on a fix.")),this.setBottomIconToUnselected(),this.setBottomIconToDisabled()):(this.setBottomIconToEnabled(),this.isMenuButtonActive&&this.updateSccNumInMenu_()):(this.isMenuButtonActive&&this.closeSideMenu(),this.setBottomIconToUnselected(),this.setBottomIconToDisabled())}})}onSubmit(){const e=r.bD.getTimeManager(),t=r.bD.getCatalogManager();let i=t.getIdFromObjNum(parseInt((0,o.Gn)("hc-scc").value));const a=t.getSat(i),s=a,n=dt.x.eci2lla(a.position,e.simulationTimeObj),l=n.lat,c=n.lon,d=e.simulationTimeObj,u=f.$.getDirection(a,e.simulationTimeObj);"Error"===u&&v.x.warn("Cannot calculate direction of satellite. Try again later.");const g=ct.l.currentEpoch(d);if(a.TLE1=a.TLE1.substr(0,18)+g[0]+g[1]+a.TLE1.substr(32),r.bD.getMainCamera().isAutoPitchYawToTarget=!1,a.apogee-a.perigee>this.maxDifApogeeVsPerigee_)return void v.x.warn("Cannot create a breakup for non-circular orbits. Working on a fix.");const p=a.apogee-a.perigee<300?0:n.alt;let h=new rt(a,l,c,u,d,p).rotateOrbitToLatLon();const m=h[0],b=h[1];t.satCruncher.postMessage({typ:"satEdit",id:i,TLE1:m,TLE2:b});const M=r.bD.getOrbitManager();M.changeOrbitBufferData(i,m,b);const y=parseFloat((0,o.Gn)("hc-per").value),w=parseFloat((0,o.Gn)("hc-inc").value),C=parseFloat((0,o.Gn)("hc-raan").value),L=parseInt((0,o.Gn)("hc-count").value),x=15e-5,D=a.eccentricity;let E=0;for(let o=0;o<=4&&!(E>=L);o++){i=t.getIdFromObjNum(9e4+E),t.getSat(i);let r=s;const g=-C/2+C*(o/4),p=a.apogee-a.perigee<300?0:n.alt;let h=new rt(r,l,c,u,d,p,g).rotateOrbitToLatLon();if("Error"===h[0]&&(h=new rt(r,l,c,u,new Date(d.getTime()+1),p,g).rotateOrbitToLatLon(),"Error"===h[0]))return void v.x.error(new Error(h[1]),"breakup.ts","Error creating breakup!");let m=h[0],T=h[1];for(;E<(o+1)*L/4;E++){let a=parseFloat(b.substr(8,8));a=a+Math.random()*w*2-w;const s=lt.J.pad0(a.toFixed(4),8);if(8!==s.length)throw new Error(`Inclination length is not 8 - ${s} - ${b}`);r.eccentricity=D,r.eccentricity+=Math.random()*x*2-x;let n=parseFloat(T.substr(52,10));n=n+Math.random()*y*2-y;const o=lt.J.pad0(n.toFixed(8),11);if(11!==o.length)throw new Error(`meanmo length is not 11 - ${o} - ${T}`);if(i=t.getIdFromObjNum(8e4+E),m=`1 ${8e4+E}`+m.substr(7),T=`2 ${8e4+E} ${s} ${T.substr(17,35)}${o}${T.substr(63)}`,69!==m.length)throw new Error(`Invalid TLE1: length is not 69 - ${m}`);if(69!==T.length)throw new Error(`Invalid TLE1: length is not 69 - ${T}`);let l;r=t.getSat(i),r.TLE1=m,r.TLE2=T,r.active=!0,r.satrec=null;try{l=S.Sgp4.createSatrec(m,T)}catch(e){return void v.x.error(e,"breakup.ts","Error creating breakup!")}f.$.altitudeCheck(l,e.simulationTimeObj)>1?(t.satCruncher.postMessage({typ:"satEdit",id:i,TLE1:m,TLE2:T}),M.changeOrbitBufferData(i,m,T)):v.x.warn("Breakup Generator Failed")}}r.bD.getUiManager().doSearch(`${a.sccNum},Analyst`)}}ut.PLUGIN_NAME="Breakup";const gt=new ut;class pt{static getColors(e){let t,i;switch(e){case"Top Secret//SCI":t="#fce93a",i="black";break;case"Top Secret":t="#ff8c00",i="black";break;case"Secret":t="#ff0000",i="white";break;case"Confidential":t="#0033a0",i="white";break;case"CUI":t="#512b85",i="white";break;case"Unclassified":t="#007a33",i="white";break;default:throw new Error(`Invalid classification: ${e}`)}return{backgroundColor:t,color:i}}static isValidClassification(e){return["Unclassified","Confidential","CUI","Secret","Top Secret","Top Secret//SCI"].includes(e)}}class ht extends u.c{constructor(){super("Classification"),this.isClassificationContainerLoaded_=!1,this.isExpanded_=!1}init(){super.init(),this.classificationString_=settingsManager.classificationStr||""}updateClassificationString(e=this.classificationString_,t="#ffffff",i="#000000"){this.isClassificationContainerLoaded_||this.loadClassificationContainer_(),""===e?((0,o.Gn)("classification-container").style.display="none",this.updateTopMenuHeight_(!1)):((0,o.Gn)("classification-container").style.display="flex",this.updateTopMenuHeight_(!0)),(0,o.Gn)("classification-string").innerHTML=e;const a=(0,o.Gn)("classification-container");if(a.style.fontWeight="500",pt.isValidClassification(e)){const a=pt.getColors(e);t=a.backgroundColor,i=a.color}a.style.backgroundColor=t,a.style.color=i,this.classificationString_=e}addHtml(){super.addHtml(),r.bD.register({event:"uiManagerInit",cbName:this.PLUGIN_NAME,cb:this.uiManagerInit_.bind(this)})}loadClassificationContainer_(){const e=document.createElement("div");e.innerHTML=r.bD.html`<span id="classification-string"></span>`,e.id="classification-container",e.style.cssText="\n      height: 20px;\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      ",(0,o.Gn)("keeptrack-main-container").insertBefore(e,(0,o.Gn)("keeptrack-main-container").firstChild),this.isClassificationContainerLoaded_=!0}uiManagerInit_(){""!==settingsManager.classificationStr&&(this.loadClassificationContainer_(),this.updateClassificationString())}updateTopMenuHeight_(e){if(this.isExpanded_===e)return;let t=parseInt(document.documentElement.style.getPropertyValue("--top-menu-height").replace("px",""));isNaN(t)&&(t=0),document.documentElement.style.setProperty("--top-menu-height",t+(e?20:-20)+"px"),this.isExpanded_=e}}const mt=new ht,bt=i.p+"../img/socrates.png";class vt extends u.c{constructor(){super(vt.PLUGIN_NAME),this.bottomIconElementName="menu-satellite-collision",this.bottomIconImg=bt,this.bottomIconLabel="Collisions",this.sideMenuElementName="socrates-menu",this.sideMenuElementHtml=r.bD.html`
...
`,this.isIconDisabledOnLoad=!0,this.isIconDisabled=!0,this.helpTitle="Debris Screening",this.helpBody=r.bD.html`The Debris Screening menu is used to generate a list of debris objects that could potentially be seen by a satellite. The list is generated by calculating the orbital parameters of the debris objects and comparing them to the orbital parameters of the satellite. The user can choose to generate the list using either the TLE or the SGP4 propagator. The user can also choose to filter the list by the debris object's size and the debris object's magnitude. The user can also choose to filter the list by the debris object's size and the debris object's magnitude. The user can also choose to generate the list using either the TLE or the SGP4 propagator. The user can also choose to filter the list by the debris object's size and the debris object's magnitude.`,this.helpImage=r.bD.html`<img src="${Be}" />
  `}addJs(){super.addJs(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,o.Gn)(`${this.sideMenuElementName}-form`).addEventListener("submit",(e=>{e.preventDefault(),(0,V.QP)((()=>this.onFormSubmit()))})),(0,o.Gn)(`${this.sideMenuElementName}-vis`).addEventListener("click",(e=>{e.preventDefault(),(0,V.QP)((()=>this.onVisClick()))})),(0,o.Gn)(`${this.sideMenuElementName}-clear-vis`).addEventListener("click",(e=>{e.preventDefault(),(0,V.QP)((()=>Lt.onClearVisClick()))}))}}),r.bD.register({event:r.RL.selectSatData,cbName:this.PLUGIN_NAME,cb:e=>{e?this.setBottomIconToEnabled():this.setBottomIconToDisabled()}})}onVisClick(){const e=parseFloat((0,o.Gn)(`${this.formPrefix_}-u`).value),t=parseFloat((0,o.Gn)(`${this.formPrefix_}-v`).value),i=parseFloat((0,o.Gn)(`${this.formPrefix_}-w`).value);r.bD.getScene().searchBox.setCubeSize(e,t,i)}static onClearVisClick(){r.bD.getScene().searchBox.setCubeSize(0,0,0)}onFormSubmit(){let e=r.bD.getCatalogManager().getIdFromObjNum(parseInt((0,o.Gn)(`${this.formPrefix_}-scc`).value));const t=parseFloat((0,o.Gn)(`${this.formPrefix_}-u`).value),i=parseFloat((0,o.Gn)(`${this.formPrefix_}-v`).value),a=parseFloat((0,o.Gn)(`${this.formPrefix_}-w`).value),s=parseFloat((0,o.Gn)(`${this.formPrefix_}-time`).value),n=r.bD.getCatalogManager().getSat(e,Oe.C_.SKIP_POS_VEL),l=r.bD.getCatalogManager().satData.filter((e=>!(!e.satrec||e.perigee>n.apogee||n.perigee>e.apogee))).map((e=>e.id));let c=0,d=[];for(let e=0;e<60*s;e++){c=1e3*e*60;const s=r.bD.getTimeManager().getOffsetTimeObj(c),{m:o}=f.$.calculateTimeVariables(s,n.satrec),u=S.Sgp4.propagate(n.satrec,o);for(let e=0;e<l.length;e++){const n=r.bD.getCatalogManager().getSat(l[e],Oe.C_.SKIP_POS_VEL);if(!n||!n.satrec)continue;const{m:o}=f.$.calculateTimeVariables(s,n.satrec),c=S.Sgp4.propagate(n.satrec,o);if(!c){l.splice(e,1);break}const g=dt.x.sat2ric({position:u.position,velocity:u.velocity},{position:c.position,velocity:c.velocity});if(Math.abs(g.position[0])<t&&Math.abs(g.position[1])<i&&Math.abs(g.position[2])<a){console.log(`${n.sccNum} at ${new Date(s)}`),d.push(n.sccNum),l.splice(e,1);break}}}d=d.filter(((e,t,i)=>i.indexOf(e)===t));let u=d.join(",");u=u.replace(/,\s*$/u,""),r.bD.getUiManager().doSearch(u)}}const xt=new Lt;var Dt=i(769);const Et=i.p+"../img/gps.png";var Tt=i(4032),At=i.n(Tt),kt=i(2658);class It{static calculateDops(e){let t={pdop:"50.00",hdop:"50.00",gdop:"50.00",vdop:"50.00",tdop:"50.00"},i=e.length;if(i<4)return t;const a=At().rep([i,4],0);for(let t=1;t<=i;t++){const{az:i,el:s}=e[t-1],n=[Math.cos(s*b.qW)*Math.sin(i*b.qW),Math.cos(s*b.qW)*Math.cos(i*b.qW),Math.sin(s*b.qW),1];At().setBlock(a,[t-1,0],[t-1,3],[n])}const s=At().dot(At().transpose(a),a),n=At().inv(s),o=Math.sqrt(n[0][0]+n[1][1]+n[2][2]),l=Math.sqrt(n[0][0]+n[1][1]),r=Math.sqrt(n[0][0]+n[1][1]+n[2][2]+n[3][3]),c=Math.sqrt(n[2][2]),d=Math.sqrt(n[3][3]);return t.pdop=(Math.round(100*o)/100).toFixed(2),t.hdop=(Math.round(100*l)/100).toFixed(2),t.gdop=(Math.round(100*r)/100).toFixed(2),t.vdop=(Math.round(100*c)/100).toFixed(2),t.tdop=(Math.round(100*d)/100).toFixed(2),t}static getDops(e,t,i,a,s,n=10){if(void 0===i||void 0===a)return{pdop:"N/A",hdop:"N/A",gdop:"N/A",vdop:"N/A",tdop:"N/A"};let o=i*b.qW,l=a*b.qW;null!=s||(s=0);const{gmst:r}=f.$.calculateTimeVariables(e);let c=[];return t.forEach((e=>{const t=S.Transforms.ecf2rae({lon:l,lat:o,alt:s},S.Transforms.eci2ecf(e.position,r)),i={az:t.az*b.I3,el:t.el*b.I3};i.el>n&&c.push(i)})),It.calculateDops(c)}static updateDopsTable(e){if(!e||0===e.length)throw new Error("No DOPs results found!");let t=(0,o.Gn)("dops");if(!t)throw new Error("Table not found!");t.innerHTML="";let i=t.insertRow(),a=i.insertCell();a.appendChild(document.createTextNode("Time"));let s=i.insertCell();s.appendChild(document.createTextNode("HDOP"));let n=i.insertCell();n.appendChild(document.createTextNode("PDOP"));let l=i.insertCell();l.appendChild(document.createTextNode("GDOP"));for(let o of e)i=t.insertRow(),a=i.insertCell(),a.appendChild(document.createTextNode((0,kt.v)(o.time,"isoDateTime",!0))),s=i.insertCell(),s.appendChild(document.createTextNode(o.dops.hdop)),n=i.insertCell(),n.appendChild(document.createTextNode(o.dops.pdop)),l=i.insertCell(),l.appendChild(document.createTextNode(o.dops.gdop))}static getDopsList(e,t,i,a,s,n){let o=[];for(let l=0;l<1440;l++){const r=e(60*l*b.s9);let c=It.getDops(r,t,i,a,s,n);o.push({time:r,dops:c})}return o}}class Nt extends u.c{constructor(){super(Nt.PLUGIN_NAME),this.bottomIconElementName="menu-dops",this.bottomIconLabel="View DOPs",this.bottomIconImg=Et,this.bottomIconCallback=()=>{this.isMenuButtonActive&&(0,V.QP)(Nt.updateSideMenu)},this.helpTitle="Dilution of Precision (DOP) Menu",this.helpBody=r.bD.html`The Dilution of Precision (DOP) Menu is used to calculate the Dilution of Precision (DOP) for a given location and elevation mask.
    <br><br>
...
`,this.rmbCallback=e=>{switch(e){case"dops-curdops-rmb":{let e=r.bD.getInputManager().mouse.latLon;const i=r.bD.getInputManager().mouse.dragPosition;(void 0===e||isNaN(e.lat)||isNaN(e.lon))&&(console.debug("latLon undefined!"),e=dt.x.eci2lla({x:i[0],y:i[1],z:i[2]},r.bD.getTimeManager().simulationTimeObj));const a=Nt.getGpsSats(r.bD.getCatalogManager(),r.bD.getGroupsManager());var t=It.getDops(r.bD.getTimeManager().simulationTimeObj,a,e.lat,e.lon,0,settingsManager.gpsElevationMask);r.bD.getUiManager().toast(`HDOP: ${t.hdop}<br/>VDOP: ${t.vdop}<br/>PDOP: ${t.pdop}<br/>GDOP: ${t.gdop}<br/>TDOP: ${t.tdop}`,"normal",!0);break}case"dops-24dops-rmb":{const e=r.bD.getInputManager().mouse.latLon;if(this.isMenuButtonActive){(0,V.QP)(Nt.updateSideMenu),this.setBottomIconToEnabled();break}(0,o.Gn)("dops-lat").value=e.lat.toFixed(3),(0,o.Gn)("dops-lon").value=e.lon.toFixed(3),(0,o.Gn)("dops-alt").value="0",(0,o.Gn)("dops-el").value=settingsManager.gpsElevationMask.toString(),r.bD.methods.bottomMenuClick(this.bottomIconElementName)}}}}addJs(){super.addJs(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,o.Gn)("dops-form").addEventListener("submit",(e=>{e.preventDefault(),Nt.updateSideMenu()}))}})}static updateSideMenu(){const e=r.bD.getGroupsManager(),t=r.bD.getCatalogManager(),i=r.bD.getTimeManager(),a=parseFloat((0,o.Gn)("dops-lat").value),s=parseFloat((0,o.Gn)("dops-lon").value),n=parseFloat((0,o.Gn)("dops-alt").value),l=parseFloat((0,o.Gn)("dops-el").value);settingsManager.gpsElevationMask=l;const c=Nt.getGpsSats(t,e),d=It.getDopsList((e=>i.getOffsetTimeObj(e)),c,a,s,n,l);It.updateDopsTable(d)}static getGpsSats(e,t){var i,a;const s=null!==(i=(a=t.groupList).GPSGroup)&&void 0!==i?i:a.GPSGroup=t.createGroup(c.Y.NAME_REGEX,/NAVSTAR/iu,"GPSGroup"),n=[];return s.objects.forEach((t=>{const i=e.getSat(t);n.push(i)})),n}}Nt.PLUGIN_NAME="DOPs Plugin";const Gt=new Nt,Pt=i.p+"../img/edit.png";var Ot=i(4790);class Rt extends u.c{constructor(){super(Rt.PLUGIN_NAME),this.isRequireSatelliteSelected=!0,this.isIconDisabledOnLoad=!0,this.helpTitle="Edit Satellite Menu",this.helpBody=r.bD.html`The Edit Satellite Menu is used to edit the satellite data.
    ...
    `,this.bottomIconElementName="editSat-icon",this.bottomIconImg=Pt,this.bottomIconLabel="Edit Satellite",this.bottomIconCallback=()=>{this.isMenuButtonActive&&Rt.populateSideMenu()},this.dragOptions={isDraggable:!0},this.isRmbOnSat=!0,this.rmbMenuOrder=2,this.rmbL1ElementName="edit-rmb",this.rmbL1Html=r.bD.html`
  <li class="rmb-menu-item" id=${this.rmbL1ElementName}><a href="#">Edit Sat &#x27A4;</a></li>`,this.rmbCallback=(e,t)=>{if(null==t)throw new Error("clickedSat is undefined");switch(e){case"set-pri-sat-rmb":r.bD.getCatalogManager().selectSat(t);break;case"set-sec-sat-rmb":r.bD.getCatalogManager().setSecondarySat(t);break;case"edit-sat-rmb":r.bD.getCatalogManager().setSelectedSat(t),this.isMenuButtonActive||r.bD.getUiManager().bottomIconPress({id:"menu-editSat"})}},this.rmbL2ElementName="edit-rmb-menu",this.rmbL2Html=r.bD.html`
    <ul class='dropdown-contents'>
    ...
    </ul>`}addHtml(){super.addHtml(),r.bD.register({event:r.RL.uiManagerFinal,cbName:"editSat",cb:()=>{(0,o.Gn)("editSat-newTLE").addEventListener("click",Rt.editSatNewTleClick),(0,o.Gn)("editSat").addEventListener("submit",(function(e){e.preventDefault(),Rt.editSatSubmit()})),(0,o.Gn)(`${Rt.elementPrefix}-per`).addEventListener("change",(function(){const e=(0,o.Gn)("es-per").value;if(""===e)return;const t=1440/parseFloat(e);(0,o.Gn)("es-meanmo").value=t.toFixed(8)})),(0,o.Gn)(`${Rt.elementPrefix}-meanmo`).addEventListener("change",(function(){const e=(0,o.Gn)(`${Rt.elementPrefix}-meanmo`).value;if(""===e)return;const t=(1440/parseFloat(e)).toFixed(8);(0,o.Gn)(`${Rt.elementPrefix}-per`).value=t})),(0,o.Gn)("editSat-save").addEventListener("click",Rt.editSatSaveClick),(0,o.Gn)("editSat-open").addEventListener("click",(function(){(0,o.Gn)("editSat-file").click()})),(0,o.Gn)("editSat-file").addEventListener("change",(function(e){window.FileReader&&(Rt.doReaderActions(e),e.preventDefault())})),(0,o.Gn)(`${Rt.elementPrefix}-error`).addEventListener("click",(function(){(0,o.Gn)(`${Rt.elementPrefix}-error`).style.display="none"}))}})}static doReaderActions(e){try{const t=new FileReader;t.onload=Rt.readerOnLoad,t.readAsText(e.target.files[0])}catch(e){v.x.error(e,"doReaderActions","Error reading file!")}}static readerOnLoad(e){if(2!==e.target.readyState)return;if(e.target.error)return void v.x.warn("Error while reading file!");const t=r.bD.getTimeManager(),i=r.bD.getOrbitManager(),a=r.bD.getUiManager(),s=JSON.parse(e.target.result),n=parseInt(lt.J.pad0(s.TLE1.substr(2,5).trim(),5)),o=r.bD.getCatalogManager().getIdFromObjNum(n),l=r.bD.getCatalogManager().getSat(o,Oe.C_.EXTRA_ONLY);let c;try{c=S.Sgp4.createSatrec(s.TLE1,s.TLE2)}catch(e){return void v.x.error(e,"edit-sat.ts","Error creating satellite record!")}f.$.altitudeCheck(c,t.simulationTimeObj)>1?(r.bD.getCatalogManager().satCruncher.postMessage({typ:"satEdit",id:l.id,active:!0,TLE1:s.TLE1,TLE2:s.TLE2}),i.changeOrbitBufferData(l.id,s.TLE1,s.TLE2),l.active=!0):a.toast("Failed to propagate satellite. Try different parameters or if you are confident they are correct report this issue.","caution",!0)}static populateSideMenu(){const e=r.bD.getCatalogManager().getSat(r.bD.getCatalogManager().selectedSat,Oe.C_.EXTRA_ONLY);(0,o.Gn)(`${Rt.elementPrefix}-scc`).value=e.sccNum;const t=lt.J.pad0((e.inclination*b.I3).toFixed(4),8);(0,o.Gn)(`${Rt.elementPrefix}-inc`).value=lt.J.pad0(t,8),(0,o.Gn)(`${Rt.elementPrefix}-year`).value=e.TLE1.substr(18,2),(0,o.Gn)(`${Rt.elementPrefix}-day`).value=e.TLE1.substr(20,12),(0,o.Gn)(`${Rt.elementPrefix}-meanmo`).value=e.TLE2.substr(52,11),(0,o.Gn)(`${Rt.elementPrefix}-per`).value=(1440/parseFloat(e.TLE2.substr(52,11))).toFixed(4);const i=lt.J.pad0((e.raan*b.I3).toFixed(4),8);(0,o.Gn)(`${Rt.elementPrefix}-rasc`).value=lt.J.pad0(i,8),(0,o.Gn)(`${Rt.elementPrefix}-ecen`).value=e.eccentricity.toFixed(7).substr(2,7);const a=lt.J.pad0((e.argPe*b.I3).toFixed(4),8);(0,o.Gn)(`${Rt.elementPrefix}-argPe`).value=lt.J.pad0(a,8),(0,o.Gn)(`${Rt.elementPrefix}-meana`).value=e.TLE2.substr(43,8)}static editSatNewTleClick(){(0,V.QP)(Rt.editSatNewTleClickFadeIn)}static editSatNewTleClickFadeIn(){const e=r.bD.getTimeManager(),t=r.bD.getUiManager();try{const i=r.bD.getCatalogManager().getIdFromObjNum(parseInt((0,o.Gn)(`${Rt.elementPrefix}-scc`).value)),a=r.bD.getCatalogManager().getSat(i),s=dt.x.eci2lla(a.position,e.simulationTimeObj);let n=s.lon,l=s.lat,c=s.alt;const d=f.$.getDirection(a,e.simulationTimeObj);"Error"===d&&t.toast("Cannot calculate direction of satellite. Try again later.","caution");const u=e.simulationTimeObj,g=ct.l.currentEpoch(u);let p;a.TLE1=a.TLE1.substr(0,18)+g[0]+g[1]+a.TLE1.substr(32),r.bD.getMainCamera().isAutoPitchYawToTarget=!1,p=a.apogee-a.perigee<300?new rt(a,l,n,d,u).rotateOrbitToLatLon():new rt(a,l,n,d,u,c).rotateOrbitToLatLon();const h=p[0],m=p[1];if("Error"===h)return void t.toast(`${m}`,"critical",!0);r.bD.getCatalogManager().satCruncher.postMessage({typ:"satEdit",id:i,TLE1:h,TLE2:m}),r.bD.getOrbitManager().changeOrbitBufferData(i,h,m);const v=r.bD.getCatalogManager().getSat(r.bD.getCatalogManager().selectedSat,Oe.C_.EXTRA_ONLY);(0,o.Gn)(`${Rt.elementPrefix}-scc`).value=v.sccNum;const S=lt.J.pad0((v.inclination*b.I3).toFixed(4),8);(0,o.Gn)(`${Rt.elementPrefix}-inc`).value=lt.J.pad0(S,8),(0,o.Gn)(`${Rt.elementPrefix}-year`).value=v.TLE1.substr(18,2),(0,o.Gn)(`${Rt.elementPrefix}-day`).value=v.TLE1.substr(20,12),(0,o.Gn)(`${Rt.elementPrefix}-meanmo`).value=v.TLE2.substr(52,11),(0,o.Gn)(`${Rt.elementPrefix}-per`).value=(1440/parseFloat(v.TLE2.substr(52,11))).toFixed(4);const M=lt.J.pad0((v.raan*b.I3).toFixed(4),8);(0,o.Gn)(`${Rt.elementPrefix}-rasc`).value=lt.J.pad0(M,8),(0,o.Gn)(`${Rt.elementPrefix}-ecen`).value=v.eccentricity.toFixed(7).substr(2,7);const y=lt.J.pad0((v.argPe*b.I3).toFixed(4),8);(0,o.Gn)(`${Rt.elementPrefix}-argPe`).value=lt.J.pad0(y,8),(0,o.Gn)(`${Rt.elementPrefix}-meana`).value=v.TLE2.substr(43,8)}catch(e){v.x.warn(e)}}static editSatSubmit(){const e=r.bD.getCatalogManager(),t=r.bD.getTimeManager(),i=r.bD.getUiManager();(0,o.Gn)(`${Rt.elementPrefix}-error`).style.display="none";const a=(0,o.Gn)(`${Rt.elementPrefix}-scc`).value,s=e.getIdFromObjNum(parseInt(a));null===s&&v.x.info("Not a Real Satellite");const n=e.getSat(s,Oe.C_.EXTRA_ONLY),l=n.TLE1.substr(9,8);let c=(0,o.Gn)(`${Rt.elementPrefix}-inc`).value,d=(0,o.Gn)(`${Rt.elementPrefix}-meanmo`).value,u=(0,o.Gn)(`${Rt.elementPrefix}-rasc`).value;const g=(0,o.Gn)(`${Rt.elementPrefix}-ecen`).value;let p=(0,o.Gn)(`${Rt.elementPrefix}-argPe`).value,h=(0,o.Gn)(`${Rt.elementPrefix}-meana`).value;const m=(0,o.Gn)(`${Rt.elementPrefix}-year`).value,b=(0,o.Gn)(`${Rt.elementPrefix}-day`).value,{TLE1:M,TLE2:y}=Ot.L.createTle({sat:n,inc:c,meanmo:d,rasc:u,argPe:p,meana:h,ecen:g,epochyr:m,epochday:b,intl:l,scc:a});let w;try{w=S.Sgp4.createSatrec(M,y)}catch(e){return void v.x.error(e,"edit-sat.ts","Error creating satellite record!")}f.$.altitudeCheck(w,t.simulationTimeObj)>1?(e.satCruncher.postMessage({typ:"satEdit",id:s,active:!0,TLE1:M,TLE2:y}),r.bD.getOrbitManager().changeOrbitBufferData(s,M,y),n.active=!0,n.satrec=null):i.toast("Failed to propagate satellite. Try different parameters or if you are confident they are correct report this issue.","caution",!0)}static editSatSaveClick(e){const t=r.bD.getCatalogManager();try{const e=(0,o.Gn)(`${Rt.elementPrefix}-scc`).value,i=t.getIdFromObjNum(parseInt(e)),a=t.getSat(i,Oe.C_.EXTRA_ONLY),s={TLE1:a.TLE1,TLE2:a.TLE2},n=JSON.stringify(s),l=new Blob([n],{type:"text/plain;charset=utf-8"});(0,Ke.saveAs)(l,e+".tle")}catch(e){}e.preventDefault()}}Rt.PLUGIN_NAME="Edit Sat",Rt.elementPrefix="es";const _t=new Rt,Ft=i.p+"../img/find2.png";var Ut=i(5561),Bt=i(5326);class zt extends u.c{static checkAz(e,t,i){return e.filter((e=>e.az>=t&&e.az<=i))}static checkEl(e,t,i){return e.filter((e=>e.el>=t&&e.el<=i))}static checkInview(e){const t=r.bD.getDotsManager();return e.filter((e=>1===t.inViewData[e.id]))}static checkObjtype(e,t){return e.filter((e=>e.type===t))}static checkRange(e,t,i){return e.filter((e=>e.rng>=t&&e.rng<=i))}static limitPossibles(e,t){const i=r.bD.getUiManager();return e.length>=t&&i.toast(`Too many results, limited to ${t}`,"serious"),e.slice(0,t)}static searchSats(e){let{az:t,el:i,rng:a,countryCode:s,inc:n,azMarg:l,elMarg:c,rngMarg:d,incMarg:u,period:g,periodMarg:p,rcs:h,rcsMarg:m,objType:b,raan:v,raanMarg:f,argPe:S,argPeMarg:M,bus:y,shape:w,payload:C}=e;const L=!isNaN(t)&&isFinite(t),x=!isNaN(i)&&isFinite(i),D=!isNaN(a)&&isFinite(a),E=!isNaN(n)&&isFinite(n),T=!isNaN(v)&&isFinite(v),A=!isNaN(S)&&isFinite(S),k=!isNaN(g)&&isFinite(g),I=!isNaN(h)&&isFinite(h),N="All"!==s,G="All"!==y,P="All"!==w,O="All"!==C;if(l=!isNaN(l)&&isFinite(l)?l:5,c=!isNaN(c)&&isFinite(c)?c:5,d=!isNaN(d)&&isFinite(d)?d:200,u=!isNaN(u)&&isFinite(u)?u:1,p=!isNaN(p)&&isFinite(p)?p:.5,m=!isNaN(m)&&isFinite(m)?m:h/10,f=!isNaN(f)&&isFinite(f)?f:1,M=!isNaN(M)&&isFinite(M)?M:1,!(x||D||L||E||k||I||A||T||N||G||P||O))throw new Error("No Search Criteria Entered");let R=r.bD.getCatalogManager().getSatsFromSatData().filter((e=>!e.static&&!e.missile&&e.active)).map((e=>{var t;const i=r.bD.getSensorManager();if((null===(t=i.currentSensors)||void 0===t?void 0:t.length)>0){const t=Bt.J.getTearr(e,i.currentSensors);return Object.assign(Object.assign({},e),{az:t.az,el:t.el,rng:t.rng,inView:t.inView})}return e}));R=E||k||!(L||x||D)?R:zt.checkInview(R),R=0!==b?zt.checkObjtype(R,b):R,L&&(R=zt.checkAz(R,t-l,t+l)),x&&(R=zt.checkEl(R,i-c,i+c)),D&&(R=zt.checkRange(R,a-d,a+d)),E&&(R=zt.checkInc(R,n-u,n+u)),T&&(R=zt.checkRaan(R,v-f,v+f)),A&&(R=zt.checkArgPe(R,S-M,S+M)),k&&(R=zt.checkPeriod(R,g-p,g+p)),I&&(R=zt.checkRcs(R,h-m,h+m)),"All"!==s&&(R=R.filter((e=>s.split("|").includes(e.country)))),"All"!==y&&(R=R.filter((e=>e.bus===y))),"All"!==w&&(R=R.filter((e=>e.shape===w))),"All"!==C&&(R=R.filter((e=>{var t,i,a;return(null===(a=null===(i=null===(t=e.payload)||void 0===t?void 0:t.split(" ")[0])||void 0===i?void 0:i.split("-")[0])||void 0===a?void 0:a.replace(/[^a-zA-Z]/gu,""))===C}))),R=zt.limitPossibles(R,settingsManager.searchLimit);let _="";return R.forEach(((e,t)=>{_+=t<R.length-1?`${e.sccNum},`:`${e.sccNum}`})),(0,o.Gn)("search").value=_,r.bD.getUiManager().doSearch((0,o.Gn)("search").value),R}findByLooksSubmit(){return e=this,t=void 0,a=function*(){const e=r.bD.getUiManager(),t=parseFloat((0,o.Gn)("fbl-azimuth").value),i=parseFloat((0,o.Gn)("fbl-elevation").value),a=parseFloat((0,o.Gn)("fbl-range").value),s=parseFloat((0,o.Gn)("fbl-inc").value),n=parseFloat((0,o.Gn)("fbl-period").value),l=parseFloat((0,o.Gn)("fbl-rcs").value),c=parseFloat((0,o.Gn)("fbl-azimuth-margin").value),d=parseFloat((0,o.Gn)("fbl-elevation-margin").value),u=parseFloat((0,o.Gn)("fbl-range-margin").value),g=parseFloat((0,o.Gn)("fbl-inc-margin").value),p=parseFloat((0,o.Gn)("fbl-period-margin").value),h=parseFloat((0,o.Gn)("fbl-rcs-margin").value),m=parseInt((0,o.Gn)("fbl-type").value),b=parseFloat((0,o.Gn)("fbl-raan").value),v=parseFloat((0,o.Gn)("fbl-raan-margin").value),f=parseFloat((0,o.Gn)("fbl-argPe").value),S=parseFloat((0,o.Gn)("fbl-argPe-margin").value),M=(0,o.Gn)("fbl-country").value,y=(0,o.Gn)("fbl-bus").value,w=(0,o.Gn)("fbl-payload").value,C=(0,o.Gn)("fbl-shape").value;(0,o.Gn)("search").value="";try{const o={az:t,el:i,rng:a,inc:s,azMarg:c,elMarg:d,rngMarg:u,incMarg:g,period:n,periodMarg:p,rcs:l,rcsMarg:h,objType:m,raan:b,raanMarg:v,argPe:f,argPeMarg:S,countryCode:M,bus:y,payload:w,shape:C};this.lastResults=zt.searchSats(o),0===this.lastResults.length&&e.toast("No Satellites Found","critical")}catch(t){"No Search Criteria Entered"===t.message&&e.toast("No Search Criteria Entered","critical")}},new((i=void 0)||(i=Promise))((function(s,n){function o(e){try{r(a.next(e))}catch(e){n(e)}}function l(e){try{r(a.throw(e))}catch(e){n(e)}}function r(e){var t;e.done?s(e.value):(t=e.value,t instanceof i?t:new i((function(e){e(t)}))).then(o,l)}r((a=a.apply(e,t||[])).next())}));var e,t,i,a}addJs(){super.addJs(),r.bD.register({event:"uiManagerInit",cbName:"findSat",cb:()=>{(0,o.Gn)("fbl-error").addEventListener("click",(function(){(0,o.Gn)("fbl-error").style.display="none"}))}}),r.bD.register({event:"uiManagerFinal",cbName:"findSat",cb:this.uiManagerFinal.bind(this)})}constructor(){super(zt.PLUGIN_NAME),this.lastResults=[],this.sideMenuElementName="findByLooks-menu",this.sideMenuElementHtml=r.bD.html`
...
`}printLastResults(){v.x.info(this.lastResults.map((e=>e.name)).join("\n"))}uiManagerFinal(){const e=r.bD.getCatalogManager().getSatsFromSatData();(0,o.Gn)("findByLooks-form").addEventListener("submit",(e=>{e.preventDefault(),(0,V.QP)((()=>{this.findByLooksSubmit(),(0,V.Zk)()}))})),(0,je.d)(e.filter((e=>e.bus)).map((e=>e.bus))).sort(((e,t)=>e.toLowerCase().localeCompare(t.toLowerCase()))).forEach((e=>{(0,o.Gn)("fbl-bus").insertAdjacentHTML("beforeend",`<option value="${e}">${e}</option>`)})),Ut.hA.forEach((e=>{(0,o.Gn)("fbl-country").insertAdjacentHTML("beforeend",`<option value="${Ut.cs[e]}">${e}</option>`)})),(0,je.d)(e.filter((e=>e.shape)).map((e=>e.shape))).sort(((e,t)=>e.toLowerCase().localeCompare(t.toLowerCase()))).forEach((e=>{(0,o.Gn)("fbl-shape").insertAdjacentHTML("beforeend",`<option value="${e}">${e}</option>`)}));const t=e.filter((e=>e.payload)).map((e=>e.payload.split(" ")[0].split("-")[0].replace(/[^a-zA-Z]/gu,""))).filter((e=>e.length>=3));(0,je.d)(t).sort(((e,t)=>e.toLowerCase().localeCompare(t.toLowerCase()))).forEach((e=>{""!==e&&e.length>3&&(0,o.Gn)("fbl-payload").insertAdjacentHTML("beforeend",`<option value="${e}">${e}</option>`)}))}static checkArgPe(e,t,i){return e.filter((e=>e.argPe*b.I3<i&&e.argPe*b.I3>t))}static checkInc(e,t,i){return e.filter((e=>e.inclination*b.I3<i&&e.inclination*b.I3>t))}static checkPeriod(e,t,i){return e.filter((e=>e.period>t&&e.period<i))}static checkRaan(e,t,i){return e.filter((e=>e.raan*b.I3<i&&e.raan*b.I3>t))}static checkRcs(e,t,i){return e.filter((e=>parseFloat(e.R)>t&&parseFloat(e.R)<i))}}zt.PLUGIN_NAME="findSat";const $t=new zt;class Ht{constructor(){this.PLUGIN_NAME="Gamepad",this.deadzone=.55,this.buttonsPressedHistory=[],this.buttonsPressed=[]}init(){window.addEventListener("gamepadconnected",(e=>{settingsManager.cruncherReady?this.initializeGamepad(e.gamepad):r.bD.register({event:r.RL.uiManagerInit,cbName:this.PLUGIN_NAME,cb:()=>this.initializeGamepad(e.gamepad)})})),window.addEventListener("gamepaddisconnected",(()=>{r.bD.getUiManager().toast("Gamepad disconnected","critical"),this.currentController=null}))}initializeGamepad(e){r.bD.getUiManager().toast("Gamepad connected","normal"),this.currentController||r.bD.register({event:r.RL.updateLoop,cbName:this.PLUGIN_NAME,cb:this.updateGamepad.bind(this)}),this.currentController=e}updateGamepad(e){null!=e||(e=0);const t=Ht.getController(e);null!==t&&(this.currentController=t,this.updateZoom_(),this.updateLeftStick_(),this.updateRightStick_(),this.updateButtons_())}updateButtons_(){this.currentController.buttons.forEach(((e,t)=>{if(e.pressed&&!this.buttonsPressed[t])switch(this.buttonsPressed[t]=!0,this.buttonsPressedHistory.push(t),this.buttonsPressedHistory.length>8&&this.buttonsPressedHistory.shift(),t){case 0:this.btnA_();break;case 1:this.btnB_();break;case 2:this.btnX_();break;case 3:this.btnY_();break;case 4:this.btnLeftBumper();break;case 5:this.btnRightBumper_();break;case 8:this.btnHome_();break;case 9:this.btnStart_();break;case 10:this.btnLeftStick_();break;case 11:this.btnRightStick_();break;case 12:this.btnDpadUp_();break;case 13:this.btnDpadDown_();break;case 14:this.btnDpadLeft_();break;case 15:this.btnDpadRight_();break;case 16:this.btnXbox()}else!e.pressed&&this.buttonsPressed[t]&&(this.buttonsPressed[t]=!1)}))}btnA_(){settingsManager.isLimitedGamepadControls||(console.log("A"),r.bD.getCatalogManager().selectSat(r.bD.getHoverManager().hoveringSat))}btnB_(){settingsManager.isLimitedGamepadControls||(console.log("B"),r.bD.getCatalogManager().selectSat(-1),r.bD.getMainCamera().zoomTarget=.8)}btnX_(){settingsManager.isLimitedGamepadControls||(console.log("X"),r.bD.getMainCamera().autoRotate())}btnY_(){console.log("Y")}btnLeftBumper(){if(settingsManager.isLimitedGamepadControls)return;console.log("Left Bumper");const e=r.bD.getCatalogManager(),t=e.selectedSat-1;if(t>=0)e.selectSat(t);else{const t=e.satData.filter((e=>e.TLE1&&e.active)),i=t[t.length-1].id;e.selectSat(i)}}btnRightBumper_(){if(settingsManager.isLimitedGamepadControls)return;console.log("Right Bumper");const e=r.bD.getCatalogManager(),t=e.satData.filter((e=>e.TLE1&&e.active)),i=t[t.length-1].id,a=e.selectedSat+1;a<=i?e.selectSat(a):e.selectSat(0)}btnHome_(){settingsManager.isLimitedGamepadControls||(console.log("Home"),r.bD.getMainCamera().isPanReset=!0,r.bD.getMainCamera().isLocalRotateReset=!0,r.bD.getMainCamera().ftsRotateReset=!0)}btnXbox(){console.log("Xbox Button")}btnStart_(){console.log("Start")}btnLeftStick_(){console.log("Left Stick")}btnRightStick_(){console.log("Right Stick")}btnDpadUp_(){console.log("D-Pad Up"),settingsManager.isAutoRotateD=!1,settingsManager.isAutoRotateU=!settingsManager.isAutoRotateU,r.bD.getMainCamera().autoRotate(!0)}btnDpadDown_(){console.log("D-Pad Down"),settingsManager.isAutoRotateU=!1,settingsManager.isAutoRotateD=!settingsManager.isAutoRotateD,r.bD.getMainCamera().autoRotate(!0)}btnDpadLeft_(){console.log("D-Pad Left"),settingsManager.isAutoRotateR=!1,settingsManager.isAutoRotateL=!settingsManager.isAutoRotateL,r.bD.getMainCamera().autoRotate(!0)}btnDpadRight_(){console.log("Right"),settingsManager.isAutoRotateL=!1,settingsManager.isAutoRotateR=!settingsManager.isAutoRotateR,r.bD.getMainCamera().autoRotate(!0)}updateZoom_(){const e=this.currentController.buttons[6].value,t=this.currentController.buttons[7].value;if(0===e&&0===t)return;const i=r.bD.getRenderer();let a=r.bD.getMainCamera().zoomLevel();switch(r.bD.getMainCamera().cameraType){case ge.iM.DEFAULT:case ge.iM.OFFSET:case ge.iM.FIXED_TO_SAT:a+=e/500*i.dt,a-=t/500*i.dt,r.bD.getMainCamera().zoomTarget=a,r.bD.getMainCamera().camZoomSnappedOnSat=!1,r.bD.getMainCamera().isAutoPitchYawToTarget=!1,a<r.bD.getMainCamera().zoomLevel()?r.bD.getMainCamera().isZoomIn=!0:r.bD.getMainCamera().isZoomIn=!1;break;case ge.iM.FPS:case ge.iM.SATELLITE:case ge.iM.PLANETARIUM:case ge.iM.ASTRONOMY:0!==e&&(r.bD.getMainCamera().fpsVertSpeed+=Math.pow(2*e,3)*i.dt*settingsManager.cameraMovementSpeed),0!==t&&(r.bD.getMainCamera().fpsVertSpeed-=Math.pow(2*t,3)*i.dt*settingsManager.cameraMovementSpeed)}}updateLeftStick_(){const e=this.currentController.axes[0],t=this.currentController.axes[1];if(e>this.deadzone||e<-this.deadzone||t>this.deadzone||t<-this.deadzone){r.bD.getMainCamera().autoRotate(!1);const i=r.bD.getRenderer();switch(settingsManager.lastGamepadMovement=Date.now(),r.bD.getMainCamera().cameraType){case ge.iM.DEFAULT:case ge.iM.OFFSET:case ge.iM.FIXED_TO_SAT:r.bD.getMainCamera().camAngleSnappedOnSat=!1,r.bD.getMainCamera().isAutoPitchYawToTarget=!1,r.bD.getMainCamera().camPitchSpeed-=Math.pow(t,3)/200*i.dt*settingsManager.cameraMovementSpeed,r.bD.getMainCamera().camYawSpeed+=Math.pow(e,3)/200*i.dt*settingsManager.cameraMovementSpeed;break;case ge.iM.FPS:case ge.iM.SATELLITE:case ge.iM.PLANETARIUM:case ge.iM.ASTRONOMY:(t>this.deadzone||t<-this.deadzone)&&(r.bD.getMainCamera().fpsForwardSpeed=-Math.pow(t,3)*i.dt),(e>this.deadzone||e<-this.deadzone)&&(r.bD.getMainCamera().fpsSideSpeed=Math.pow(e,3)*i.dt)}}}updateRightStick_(){if(settingsManager.isLimitedGamepadControls)return;const e=this.currentController.axes[2],t=this.currentController.axes[3],i=r.bD.getRenderer();if(r.bD.getMainCamera().isLocalRotateOverride=!1,t>this.deadzone||t<-this.deadzone||e>this.deadzone||e<-this.deadzone)switch(r.bD.getMainCamera().autoRotate(!1),r.bD.getMainCamera().cameraType){case ge.iM.DEFAULT:case ge.iM.OFFSET:case ge.iM.FIXED_TO_SAT:r.bD.getMainCamera().isLocalRotateOverride=!0,r.bD.getMainCamera().localRotateDif.pitch=200*-t,r.bD.getMainCamera().localRotateDif.yaw=200*-e;break;case ge.iM.FPS:case ge.iM.SATELLITE:case ge.iM.PLANETARIUM:case ge.iM.ASTRONOMY:r.bD.getMainCamera().camPitchSpeed+=t/100*i.dt*settingsManager.cameraMovementSpeed,r.bD.getMainCamera().camYawSpeed-=e/100*i.dt*settingsManager.cameraMovementSpeed}}vibrate(e){this.currentController&&this.currentController.vibrationActuator.playEffect("dual-rumble",{duration:e||300,strongMagnitude:1,weakMagnitude:1,startDelay:0})}static getController(e=0){const t=navigator.getGamepads().filter((e=>null!==e));return t.length>e&&null!==t[e]?t[e]:null}}const jt=new Ht;var Vt=i(5999);const Kt=i.p+"../img/calendar.png";class Wt extends u.c{constructor(){super("Launch Menu"),this.bottomIconElementName="menu-launches",this.bottomIconImg=Kt,this.bottomIconLabel="Launch Calendar",this.bottomIconCallback=()=>{if(this.isMenuButtonActive){settingsManager.isPreventColorboxClose=!0,setTimeout((function(){settingsManager.isPreventColorboxClose=!1}),2e3);const e=(new Date).getFullYear();(0,Vt.Us)(`https://space.skyrocket.de/doc_chr/lau${e}.htm`,{callback:this.closeColorbox_.bind(this)})}},this.isForceHideSideMenus=!0}closeColorbox_(){this.isMenuButtonActive&&(this.isMenuButtonActive=!1,(0,o.Gn)(this.bottomIconElementName).classList.remove("bmenu-item-selected"))}}const Yt=new Wt,Jt=i.p+"../img/rocket.png";var Xt=i(7092);class Zt extends u.c{constructor(){super(Zt.PLUGIN_NAME),this.bottomIconCallback=()=>{if(!this.isMenuButtonActive)return;if(!this.verifySatelliteSelected())return;const e=r.bD.getCatalogManager().getSat(r.bD.getCatalogManager().selectedSat,Oe.C_.EXTRA_ONLY);(0,o.Gn)("nl-scc").value=e.sccNum,(0,o.Gn)("nl-inc").value=lt.J.pad0((e.inclination*b.I3).toFixed(4),8)},this.bottomIconElementName="menu-new-launch",this.bottomIconLabel="New Launch",this.bottomIconImg=Jt,this.isIconDisabledOnLoad=!0,this.isIconDisabled=!0,this.sideMenuElementName="newLaunch-menu",this.sideMenuElementHtml=r.bD.html`
  ...
  `,this.helpTitle="New Launch Menu",this.helpBody=r.bD.html`The New Launch Menu is used for generating notional orbital launches by modifying existing satellites with similar parameters.
    ...
    The objects relationship with other orbital objects will be incorrect.`,this.dragOptions={isDraggable:!0},this.isDoingCalculations=!1,this.submitCallback=()=>{var e;if(this.isDoingCalculations)return;this.isDoingCalculations=!0;const t=r.bD.getTimeManager(),i=r.bD.getCatalogManager(),a=r.bD.getUiManager(),s=r.bD.getColorSchemeManager();(0,V.wU)();const n=(0,o.Gn)("nl-scc").value,l=i.getIdFromObjNum(parseInt(n));let c=i.getSat(l);const d=(0,o.Gn)("nl-updown").value,u=(0,o.Gn)("nl-facility").value;let g,p;if(!i.isLaunchSiteManagerLoaded)throw new Error("Launch Site Manager not loaded!");for(const e in i.launchSites)i.launchSites[e].name===u&&(g=i.launchSites[e].lat,p=i.launchSites[e].lon);p>180&&(p-=360);const h=new Date,m=new Date(h.getUTCFullYear(),h.getUTCMonth(),h.getUTCDate(),0,0,0);m.setUTCHours(0);const b=t.staticOffset;t.changeStaticOffset(m.getTime()-h.getTime()),s.setColorScheme(settingsManager.currentColorScheme,!0),r.bD.getMainCamera().isAutoPitchYawToTarget=!1;const M=t.simulationTimeObj,y=new rt(c,g,p,d,M).rotateOrbitToLatLon(),w=y[0],C=y[1];if("Error"===w||69!==w.length||69!==C.length)return"Error"===w?a.toast(`Failed to Create TLE: ${C}`,"critical"):69!==w.length?a.toast(`Invalid TLE1 Created: length is not 69 - ${w}`,"critical"):69!==C.length&&a.toast(`Invalid TLE2 Created: length is not 69 - ${C}`,"critical"),t.changeStaticOffset(b),this.isDoingCalculations=!1,void(0,V.Zk)();let L;a.toast("Time is now relative to launch time.","standby"),null===(e=r.bD.getSoundManager())||void 0===e||e.play("liftoff"),c.satrec=null;try{L=S.Sgp4.createSatrec(w,C)}catch(e){return void v.x.error(e,"new-launch.ts","Error creating satellite record!")}f.$.altitudeCheck(L,M)>1?(i.satCruncher.postMessage({typ:"satEdit",id:l,active:!0,TLE1:w,TLE2:C}),r.bD.getOrbitManager().changeOrbitBufferData(l,w,C)):a.toast("Failed Altitude Test - Try a Different Satellite!","critical"),(0,Mt.J)(i.satCruncher,(()=>{this.isDoingCalculations=!1,(0,V.Zk)()}),(e=>void 0!==e.satPos),(()=>{this.isDoingCalculations=!1,(0,V.Zk)(),a.toast("Cruncher failed to meet requirement after two tries! Is this launch even possible?","critical")}))}}addJs(){super.addJs(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,o.Gn)(this.sideMenuElementName+"-form").addEventListener("change",(()=>{const e=r.bD.getCatalogManager().getSat(r.bD.getCatalogManager().selectedSat,Oe.C_.EXTRA_ONLY);this.preValidate_(e)}))}}),r.bD.register({event:r.RL.selectSatData,cbName:this.PLUGIN_NAME,cb:e=>{e?((0,o.Gn)("nl-scc").value=e.sccNum,(0,o.Gn)(this.bottomIconElementName).classList.remove("bmenu-item-disabled"),this.isIconDisabled=!1,this.preValidate_(e)):((0,o.Gn)(this.bottomIconElementName).classList.add("bmenu-item-disabled"),this.isIconDisabled=!0)}})}preValidate_(e){const t=(0,o.Gn)("nl-facility").value,i=Xt.E[t].lat;let a=e.inclination*b.I3;a=a>90?180-a:a;const s=(0,o.Gn)(this.sideMenuElementName+"-submit");a<i?(s.disabled=!0,s.textContent="Inclination Too Low!"):(s.disabled=!1,s.textContent="Create Launch Nominal ▶")}}Zt.PLUGIN_NAME="New Launch";const qt=new Zt,Qt=i.p+"../img/calendar2.png",ei=(e,t)=>e?e.length<=t?e:`${e.slice(0,t)}...`:"Unknown";class ti extends u.c{constructor(){super(ti.PLUGIN_NAME),this.bottomIconCallback=()=>{this.isMenuButtonActive&&("localhost"===window.location.hostname&&r.bD.getUiManager().toast("This feature is a static table when in offline mode.","caution"),this.showTable())},this.bottomIconElementName="menu-nextLaunch",this.bottomIconImg=Qt,this.bottomIconLabel="Next Launches",this.dragOptions={isDraggable:!0,maxWidth:650,minWidth:450},this.helpTitle="Next Launches Menu",this.helpBody=r.bD.html`The Next Launches Menu pulls data from <a href="https://thespacedevs.com/" target="_blank">The Space Devs</a> to display upcoming launches.`,this.sideMenuElementName="nextLaunch-menu",this.sideMenuElementHtml=r.bD.html`
      ...
      <div class="row">
        <center>
          <button id="export-launch-info" class="btn btn-ui waves-effect waves-light">Export Launch Info &#9658;</button>
              ...
              `),(0,o.Gn)("orbit-references-link").addEventListener("click",this.orbitReferencesLinkClick.bind(this)),this.doOnce=!0))}})}orbitReferencesLinkClick(){const e=r.bD.getCatalogManager(),t=e.getSat(e.selectedSat);let i=e.analSatSet[0].id+2e4,a="";const s=S.Sgp4.createSatrec(t.TLE1,t.TLE2),n=s.ecco.toFixed(7).substr(2,7),o=(s.nodeo*b.I3).toString(),l=(s.argpo*b.I3).toString(),c=t.TLE2.substr(8,8),d=t.TLE2.substr(52,10),u=t.TLE1.substr(18,2),g=t.TLE1.substr(20,12),p=t.TLE1.substr(9,8),h=lt.J.pad0(t.TLE1.substr(2,5).trim(),5),m=1440/parseFloat(d);let v=0;for(let s=0;s<360;s++){const r=lt.J.pad0(v.toFixed(4),8),{TLE1:b,TLE2:f}=Ot.L.createTle({sat:t,inc:c,meanmo:d,rasc:o,argPe:l,meana:r,ecen:n,epochyr:u,epochday:g,intl:p,scc:h});if(a+=e.insertNewAnalystSatellite(b,f,i+s,(1e5+s).toString()).sccNum.toString()+",",v+=360/m*4,v>=360)break}a=a.substr(0,a.length-1),r.bD.getUiManager().doSearch(a),this.isReferenceSatsActive=!0}}ri.PLUGIN_NAME="Orbit References";const ci=new ri,di=i.p+"../img/scatter-plot3.png";var ui=i(3845),gi=i(8120);i(2322);class pi extends u.c{constructor(){super(pi.PLUGIN_NAME),this.dependencies=[li.P.PLUGIN_NAME],this.bottomIconElementName="ecf-plots-bottom-icon",this.bottomIconLabel="ECF Plots",this.bottomIconImg=di,this.bottomIconCallback=()=>{this.isMenuButtonActive&&this.createPlot(pi.getPlotData(),(0,o.Gn)(this.plotCanvasId))},this.plotCanvasId="plot-analysis-chart-ecf",this.isRequireSatelliteSelected=!0,this.isIconDisabledOnLoad=!0,this.helpTitle="ECF Plots Menu",this.helpBody=r.bD.html`
  <p>
  ...
  <br><br>
  For some constellations, notional uplink/downlinks and/or crosslinks will be drawn between satellites in the constellation.`,this.dragOptions={isDraggable:!0}}addHtml(){super.addHtml(),r.bD.register({event:"uiManagerFinal",cbName:"constellations",cb:()=>{(0,o.Gn)("constellation-menu").querySelectorAll("li").forEach((e=>{e.addEventListener("click",(function(e){Gi.constellationMenuClick(e.target.dataset.group)}))}))}})}static constellationMenuClick(e){const t=r.bD.getTimeManager(),i=r.bD.getCatalogManager(),a=r.bD.getGroupsManager();if(void 0!==a){switch(e){case"SpaceStations":a.groupList[e]||a.createGroup(c.Y.SCC_NUM,[25544,48274],e);break;case"GlonassGroup":a.groupList[e]||a.createGroup(c.Y.NAME_REGEX,/GLONASS/u,e);break;case"GalileoGroup":a.groupList[e]||a.createGroup(c.Y.NAME_REGEX,/GALILEO/u,e);break;case"GPSGroup":a.groupList[e]||a.createGroup(c.Y.NAME_REGEX,/NAVSTAR/u,e);break;case"AmatuerRadio":a.groupList[e]||a.createGroup(c.Y.SCC_NUM,[7530,14781,20442,22826,24278,25338,25397,25544,26931,27607,27844,27848,28895,32785,32788,32789,32791,33493,33498,33499,35932,35933,35935,37224,37839,37841,37855,38760,39090,39134,39136,39161,39417,39430,39436,39439,39440,39444,39469,39770,40014,40021,40024,40025,40030,40032,40042,40043,40057,40071,40074,40377,40378,40379,40380,40654,40719,40900,40903,40906,40907,40908,40910,40911,40912,40926,40927,40928,40931,40967,40968,41168,41171,41340,41459,41460,41465,41474,41600,41619,41789,41932,41935,42017],e);break;case"aehf":a.groupList[e]||a.createGroup(c.Y.SCC_NUM,i.id2satnum(i.satLinkManager.aehf),e),(0,V.QP)((()=>{Ni.Bz.clear(),i.satLinkManager.showLinks(Ni.Bz,Ii.W6.Aehf,t)}));break;case"wgs":a.groupList[e]||a.createGroup(c.Y.SCC_NUM,i.id2satnum(i.satLinkManager.wgs.concat(i.satLinkManager.dscs)),e),(0,V.QP)((()=>{Ni.Bz.clear(),i.satLinkManager.showLinks(Ni.Bz,Ii.W6.Wgs,t)}));break;case"starlink":a.groupList[e]||a.createGroup(c.Y.NAME_REGEX,/STARLINK/u,e),(0,V.QP)((()=>{Ni.Bz.clear(),i.satLinkManager.showLinks(Ni.Bz,Ii.W6.Starlink,t)}));break;case"sbirs":a.groupList[e]||a.createGroup(c.Y.SCC_NUM,i.id2satnum(i.satLinkManager.sbirs),e),(0,V.QP)((()=>{Ni.Bz.clear(),i.satLinkManager.showLinks(Ni.Bz,Ii.W6.Sbirs,t)}));break;default:throw new Error("Unknown group name: "+e)}Gi.groupSelected(e)}}static groupSelected(e){if(void 0===e)return;const t=r.bD.getCatalogManager(),i=r.bD.getGroupsManager();if(void 0===i.groupList[e])throw new Error("Unknown group name: "+e);const a=(0,o.Gn)("search");i.selectGroup(i.groupList[e]),a.innerHTML=i.groupList[e].objects.reduce(((e,i)=>`${e}${t.getSat(i).sccNum},`),"").slice(0,-1),t.setSelectedSat(-1);const s=r.bD.getUiManager();s.searchManager.doSearch(i.groupList[e].objects.map((e=>t.getSat(e).sccNum)).join(",")),settingsManager.isMobileModeEnabled&&s.searchManager.searchToggle(!0),s.hideSideMenus()}}Gi.PLUGIN_NAME="Sat Constellations";const Pi=new Gi,Oi=i.p+"../img/sat2.png";class Ri extends u.c{constructor(){super("Satellite Field of View"),this.bottomIconCallback=()=>{this.isMenuButtonActive?(this.enableFovView_(),settingsManager.isSatOverflyModeOn=!0):(this.disableFovView_(),settingsManager.isSatOverflyModeOn=!1)},this.isRequireSatelliteSelected=!0,this.bottomIconElementName="menu-sat-fov",this.bottomIconLabel="Satellite FOV",this.bottomIconImg=Oi,this.isIconDisabledOnLoad=!0,this.isIconDisabled=!0}addJs(){super.addJs(),r.bD.register({event:r.RL.changeSensorMarkers,cbName:this.PLUGIN_NAME,cb:e=>{e!==this.PLUGIN_NAME&&(0,o.Gn)(this.bottomIconElementName).classList.remove("bmenu-item-selected")}})}disableFovView_(){const e=r.bD.getCatalogManager();settingsManager.isSatOverflyModeOn=!1,this.setBottomIconToUnselected(),e.satCruncher.postMessage({typ:"isShowSatOverfly",isShowSatOverfly:"reset"})}static getSatFieldOfView_(){const e=(0,o.Gn)("satFieldOfView",!0);if(!e)return 30;if(""===e.value)return v.x.warn("No Satellite FOV value entered. Using default value of 30 degrees."),30;const t=parseFloat(e.value);return isNaN(t)||t<0||t>180?(v.x.warn("Invalid Satellite FOV value. Using default value of 30 degrees."),30):t}enableFovView_(){const e=r.bD.getCatalogManager(),t=r.bD.getUiManager(),i=r.bD.getColorSchemeManager();r.bD.methods.changeSensorMarkers(this.PLUGIN_NAME),settingsManager.isShowSurvFence=!1,settingsManager.isFOVBubbleModeOn=!1,settingsManager.isSatOverflyModeOn=!0,this.setBottomIconToSelected(),""!==(0,o.Gn)("search").value&&t.doSearch((0,o.Gn)("search").value);const a=Ri.getSatFieldOfView_();e.satCruncher.postMessage({isShowFOVBubble:"reset",isShowSurvFence:"disable"}),e.satCruncher.postMessage({typ:"isShowSatOverfly",isShowSatOverfly:"enable",selectedSatFOV:a}),i.setColorScheme(settingsManager.currentColorScheme,!0)}}const _i=new Ri,Fi=i.p+"../img/photoManager.png";class Ui extends u.c{constructor(){super(Ui.PLUGIN_NAME),this.bottomIconElementName="menu-sat-photos",this.bottomIconLabel="SatellitePhotos",this.bottomIconImg=Fi,this.sideMenuElementName="sat-photo-menu",this.sideMenuElementHtml=r.bD.html`
  ...
  `,this.saveHiResPhoto=e=>{switch(e){case"hd":settingsManager.hiResWidth=1920,settingsManager.hiResHeight=1080;break;case"4k":settingsManager.hiResWidth=3840,settingsManager.hiResHeight=2160;break;case"8k":settingsManager.hiResWidth=7680,settingsManager.hiResHeight=4320}this.queuedScreenshot_=!0},this.queuedScreenshot_=!1}addJs(){super.addJs(),r.bD.register({event:r.RL.altCanvasResize,cbName:this.PLUGIN_NAME,cb:()=>this.queuedScreenshot_}),r.bD.register({event:r.RL.endOfDraw,cbName:this.PLUGIN_NAME,cb:()=>{this.queuedScreenshot_&&this.takeScreenShot()}})}takeScreenShot(){let e=document.createElement("a");e.download="keeptrack.png";let t=(new Date).getUTCFullYear(),i=settingsManager.copyrightOveride?"":`©${t} KEEPTRACK.SPACE`;e.href=Ki.watermarkedDataUrl(i),e.click(),this.queuedScreenshot_=!1}static watermarkedDataUrl(e){const t=r.bD.getRenderer().domElement,i=document.createElement("canvas"),a=i.getContext("2d");let s=i.width=t.width,n=i.height=t.height;a.drawImage(t,0,0),a.font="24px nasalization";let o=a.measureText(e).width;a.globalAlpha=1,a.fillStyle="white",a.fillText(e,s-o-30,n-30);const{classificationstr:l,classificationColor:c}=Ki.calculateClassificationText();""!==l&&(a.font="24px nasalization",a.globalAlpha=1,a.fillStyle=c,o=a.measureText(l).width,a.fillText(l,s/2-o,n-20),a.fillText(l,s/2-o,34)),document.body.appendChild(i);let d=i.toDataURL();return i.parentNode.removeChild(i),d}static calculateClassificationText(){return""===settingsManager.classificationStr?{classificationstr:"",classificationColor:""}:{classificationstr:settingsManager.classificationStr,classificationColor:pt.getColors(settingsManager.classificationStr).backgroundColor}}}const Wi=new Ki,Yi=i.p+"../img/fov.png";class Ji extends u.c{constructor(){super("Sensor Field of View"),this.bottomIconCallback=()=>{this.verifySensorSelected()&&(settingsManager.isFOVBubbleModeOn&&!settingsManager.isShowSurvFence?this.disableFovView_():settingsManager.isFOVBubbleModeOn||this.enableFovView())},this.bottomIconElementName="menu-sensor-fov",this.bottomIconLabel="Sensor FOV",this.bottomIconImg=Yi,this.isIconDisabledOnLoad=!0,this.isIconDisabled=!0}addJs(){super.addJs(),r.bD.register({event:r.RL.setSensor,cbName:this.PLUGIN_NAME,cb:e=>{e?((0,o.Gn)(this.bottomIconElementName).classList.remove(u.c.iconDisabledClassString),this.isIconDisabled=!1):((0,o.Gn)(this.bottomIconElementName).classList.add(u.c.iconDisabledClassString),this.isIconDisabled=!0,this.isMenuButtonActive=!1,(0,o.Gn)(this.bottomIconElementName).classList.remove(u.c.iconSelectedClassString))}}),r.bD.register({event:r.RL.changeSensorMarkers,cbName:this.PLUGIN_NAME,cb:e=>{e!==this.PLUGIN_NAME&&(0,o.Gn)(this.bottomIconElementName).classList.remove(u.c.iconSelectedClassString)}})}disableFovView_(){settingsManager.isFOVBubbleModeOn=!1,this.setBottomIconToUnselected(),r.bD.getCatalogManager().satCruncher.postMessage({isShowFOVBubble:"reset",isShowSurvFence:"disable"})}enableFovView(){r.bD.methods.changeSensorMarkers(this.PLUGIN_NAME),settingsManager.isFOVBubbleModeOn=!0,settingsManager.isSatOverflyModeOn=!1,settingsManager.isShowSurvFence=!1,this.setBottomIconToSelected(),r.bD.getCatalogManager().satCruncher.postMessage({isShowFOVBubble:"enable",isShowSurvFence:"disable"}),r.bD.getCatalogManager().satCruncher.postMessage({typ:"isShowSatOverfly",isShowSatOverfly:"reset"})}}const Xi=new Ji,Zi=i.p+"../img/fence.png";class qi extends u.c{constructor(){super(qi.PLUGIN_NAME),this.bottomIconCallback=()=>{const e=r.bD.getCatalogManager();settingsManager.isShowSurvFence?this.disableSurvView_(e):this.enableSurvView_(e)},this.bottomIconElementName="menu-sensor-surv-fence",this.bottomIconLabel="Sensor Fence",this.bottomIconImg=Zi,this.isIconDisabledOnLoad=!0,this.isIconDisabled=!0,this.isRequireSensorSelected=!0,settingsManager.isShowSurvFence=!1}disableSurvView_(e){settingsManager.isShowSurvFence=!1,(0,o.Gn)(this.bottomIconElementName).classList.remove(u.c.iconSelectedClassString),e.satCruncher.postMessage({isShowSurvFence:"disable",isShowFOVBubble:"reset"})}enableSurvView_(e){r.bD.methods.changeSensorMarkers(this.PLUGIN_NAME),settingsManager.isShowSurvFence=!0,settingsManager.isSatOverflyModeOn=!1,(0,o.Gn)(this.bottomIconElementName).classList.add(u.c.iconSelectedClassString),e.satCruncher.postMessage({isShowFOVBubble:"enable",isShowSurvFence:"enable"}),e.satCruncher.postMessage({typ:"isShowSatOverfly",isShowSatOverfly:"reset"})}addJs(){super.addJs(),r.bD.register({event:r.RL.setSensor,cbName:this.PLUGIN_NAME,cb:e=>{e?((0,o.Gn)(this.bottomIconElementName).classList.remove(u.c.iconDisabledClassString),this.isIconDisabled=!1):((0,o.Gn)(this.bottomIconElementName).classList.add(u.c.iconDisabledClassString),this.isIconDisabled=!0,this.isMenuButtonActive=!1,(0,o.Gn)(this.bottomIconElementName).classList.remove(u.c.iconSelectedClassString))}}),r.bD.register({event:r.RL.changeSensorMarkers,cbName:this.PLUGIN_NAME,cb:e=>{e!==this.PLUGIN_NAME&&(0,o.Gn)(this.bottomIconElementName).classList.remove(u.c.iconSelectedClassString)}})}}qi.PLUGIN_NAME="Sensor Surveillance Fence";const Qi=new qi,ea=i.p+"../img/custom.png";var ta=i(3023);class ia{static updateSensorPosition(e){const t=r.bD.getTimeManager(),i=r.bD.getCatalogManager(),a=r.bD.getSensorManager(),{lon:s,lat:n,alt:o,minaz:l,maxaz:c,minel:d,maxel:u,minrange:g,maxrange:p}=ia.updateSettingsManager(e);a.whichRadar="CUSTOM",ia.updateCustomSensorUi_();const h={lat:n,lon:s,alt:o,obsminaz:l,obsmaxaz:c,obsminel:d,obsmaxel:u,obsminrange:g,obsmaxrange:p};i.satCruncher.postMessage({typ:"sensor",setlatlong:!0,sensor:h}),ta.E.updateSensorUiStyling([h]),i.setSelectedSat(-1);const m=r.bD.getMainCamera();p>6e3?m.changeZoom(ge.$R.GEO):m.changeZoom(ge.$R.LEO),m.camSnap((0,Si.Lx)(n),(0,Si.Zs)(s,t.simulationTimeObj))}static updateSettingsManager(e){return settingsManager.geolocation.lat=e.coords.latitude,settingsManager.geolocation.lon=e.coords.longitude,settingsManager.geolocation.alt=e.coords.altitude/1e3,settingsManager.geolocation.minaz=0,settingsManager.geolocation.maxaz=360,settingsManager.geolocation.minel=30,settingsManager.geolocation.maxel=90,settingsManager.geolocation.minrange=0,settingsManager.geolocation.maxrange=1e5,settingsManager.geolocation}static useCurrentGeolocationAsSensor(){"https:"===location.protocol&&!settingsManager.geolocationUsed&&settingsManager.isMobileModeEnabled&&navigator.geolocation.getCurrentPosition(ia.updateSensorPosition)}static updateCustomSensorUi_(){if(!settingsManager.geolocation)throw new Error("geolocation is not defined");if("number"!=typeof settingsManager.geolocation.lat)throw new Error("geolocation.lat is not valid");if("number"!=typeof settingsManager.geolocation.lon)throw new Error("geolocation.lon is not valid");if("number"!=typeof settingsManager.geolocation.alt)throw new Error("geolocation.alt is not valid");try{const e=(0,o.Gn)("cs-lat"),t=(0,o.Gn)("cs-lon"),i=(0,o.Gn)("cs-hei");e.value=settingsManager.geolocation.lat.toString(),e.dispatchEvent(new Event("change")),t.value=settingsManager.geolocation.lon.toString(),t.dispatchEvent(new Event("change")),i.value=settingsManager.geolocation.alt.toString(),i.dispatchEvent(new Event("change")),(0,o.Gn)("cs-telescope").checked=!0,(0,o.Gn)("cs-minaz").disabled=!0,(0,o.Gn)("cs-maxaz").disabled=!0,(0,o.Gn)("cs-minel").disabled=!0,(0,o.Gn)("cs-maxel").disabled=!0,(0,o.Gn)("cs-minrange").disabled=!0,(0,o.Gn)("cs-maxrange").disabled=!0,(0,o.Gn)("cs-minaz-div").style.display="none",(0,o.Gn)("cs-maxaz-div").style.display="none",(0,o.Gn)("cs-minel-div").style.display="none",(0,o.Gn)("cs-maxel-div").style.display="none",(0,o.Gn)("cs-minrange-div").style.display="none",(0,o.Gn)("cs-maxrange-div").style.display="none",(0,o.Gn)("cs-minaz").value="0",(0,o.Gn)("cs-maxaz").value="360",(0,o.Gn)("cs-minel").value="10",(0,o.Gn)("cs-maxel").value="90",(0,o.Gn)("cs-minrange").value="100",(0,o.Gn)("cs-maxrange").value="50000",(0,o.Gn)("sensor-type").innerHTML="Telescope",(0,o.Gn)("sensor-info-title").innerHTML="Custom Sensor",(0,o.Gn)("sensor-country").innerHTML="Custom Sensor"}catch(e){v.x.debug("Error updating custom sensor UI. Is the plugin loaded?")}}}const aa=i.p+"../img/multi-site.png";class sa extends u.c{constructor(){super(sa.PLUGIN_NAME),this.isRequireSatelliteSelected=!0,this.isRequireSensorSelected=!1,this.bottomIconCallback=()=>{const e=r.bD.getCatalogManager().getSelectedSat();this.refreshSideMenuData(e)},this.lookanglesLength=1,this.lookanglesInterval=30,this.disabledSensors=[],this.bottomIconElementName="multi-site-look-angles-icon",this.bottomIconLabel="Multi-Site Looks",this.bottomIconImg=aa,this.isIconDisabledOnLoad=!0,this.isIconDisabled=!0,this.dragOptions={isDraggable:!0,minWidth:350,maxWidth:500},this.helpTitle="Multi-Site Look Angles Menu",this.helpBody=r.bD.html`
    ...
    </div>`}addHtml(){super.addHtml(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{var e;null===(e=(0,o.Gn)("multi-site-look-angles-export"))||void 0===e||e.addEventListener("click",(()=>{const e=r.bD.getSensorManager().lastMultiSiteArray.map((e=>({time:e.time,sensor:e.objName,az:e.az.toFixed(2),el:e.el.toFixed(2),rng:e.rng.toFixed(2)})));(0,Ve.Eb)(e,"multiSiteLooks")}))}}),r.bD.register({event:r.RL.selectSatData,cbName:this.PLUGIN_NAME,cb:e=>{this.checkIfCanBeEnabled_(e)}})}checkIfCanBeEnabled_(e){(null==e?void 0:e.TLE1)&&r.bD.getSensorManager().isSensorSelected()?(this.setBottomIconToEnabled(),this.isMenuButtonActive&&e&&this.refreshSideMenuData(e)):(this.isMenuButtonActive&&this.closeSideMenu(),this.setBottomIconToDisabled())}addJs(){super.addJs(),r.bD.register({event:r.RL.staticOffsetChange,cbName:this.PLUGIN_NAME,cb:()=>{const e=r.bD.getCatalogManager().getSelectedSat();this.refreshSideMenuData(e)}})}refreshSideMenuData(e){this.isMenuButtonActive&&e&&(0,V.QP)((()=>{const t=(0,o.Gn)("multi-site-look-angles-sensor-list");t.innerHTML="";const i=[];for(const a of r.bD.getSensorManager().sensorListUS){const s=document.createElement("button");s.classList.add("btn","btn-ui","waves-effect","waves-light"),this.disabledSensors.includes(a)&&s.classList.add("btn-red"),i.push(a),s.innerText=a.shortName,s.addEventListener("click",(()=>{s.classList.contains("btn-red")?(s.classList.remove("btn-red"),this.disabledSensors.splice(this.disabledSensors.indexOf(a),1)):(s.classList.add("btn-red"),this.disabledSensors.push(a)),this.getlookanglesMultiSite_(e,i.filter((e=>!this.disabledSensors.includes(e))))})),t.appendChild(s),t.appendChild(document.createTextNode(" "))}this.getlookanglesMultiSite_(e,i.filter((e=>!this.disabledSensors.includes(e))))}))}getlookanglesMultiSite_(e,t){const i=r.bD.getTimeManager(),a=r.bD.getSensorManager(),s=r.bD.getCatalogManager().staticSet;if(!t){t=[];for(const e in s){const i=s[e];t.push(i)}}const n=!a.isSensorSelected(),o=[...a.currentSensors],l=b.rE/(e.satrec.no*b.rE/b.gc),c=[];for(const a of t){if(a.obsmaxrange<e.perigee&&(!a.obsmaxrange2||a.obsmaxrange2<e.perigee))continue;ta.E.updateSensorUiStyling([a]);let t=0;for(let s=0;s<24*this.lookanglesLength*60*60;s+=this.lookanglesInterval){t=1e3*s;let n=i.getOffsetTimeObj(t),o=sa.propagateMultiSite_(n,e.satrec,a);""!==o.time&&(c.push(o),s+=60*l*.75)}}c.sort(((e,t)=>new Date(e.time).getTime()-new Date(t.time).getTime())),a.lastMultiSiteArray=c,n?a.setCurrentSensor(a.defaultSensor):a.setCurrentSensor(o),sa.populateMultiSiteTable_(c)}static propagateMultiSite_(e,t,i){const a=f.$.getRae(e,t,i);return f.$.checkIsInView(i,a)?{time:e.toISOString(),el:a.el,az:a.az,rng:a.rng,objName:i.objName}:{time:"",el:0,az:0,rng:0,objName:""}}static populateMultiSiteTable_(e){const t=r.bD.getSensorManager(),i=r.bD.getCatalogManager().staticSet,a=(0,o.Gn)("multi-site-look-angles-table");a.innerHTML="";let s=a.insertRow(),n=s.insertCell();n.appendChild(document.createTextNode("Time")),n.setAttribute("style","text-decoration: underline");let l=s.insertCell();l.appendChild(document.createTextNode("El")),l.setAttribute("style","text-decoration: underline");let c=s.insertCell();c.appendChild(document.createTextNode("Az")),c.setAttribute("style","text-decoration: underline");let d=s.insertCell();d.appendChild(document.createTextNode("Rng")),d.setAttribute("style","text-decoration: underline");let u=s.insertCell();u.appendChild(document.createTextNode("Sensor")),u.setAttribute("style","text-decoration: underline");const g=r.bD.getTimeManager();for(const o of e){const e=i.find((e=>e.objName===o.objName));e&&(s=a.insertRow(),s.setAttribute("class","link"),n=s.insertCell(),n.appendChild(document.createTextNode((0,kt.v)(o.time,"isoDateTime",!0))),l=s.insertCell(),l.appendChild(document.createTextNode(o.el.toFixed(1))),c=s.insertCell(),c.appendChild(document.createTextNode(o.az.toFixed(0))),d=s.insertCell(),d.appendChild(document.createTextNode(o.rng.toFixed(0))),u=s.insertCell(),u.appendChild(document.createTextNode(e.shortName)),s.addEventListener("click",(()=>{g.changeStaticOffset(new Date(o.time).getTime()-(new Date).getTime()),t.setSensor(e,e.staticNum)})))}}}sa.PLUGIN_NAME="Multi Site Look Angles";const na=new sa;class oa extends u.c{constructor(){super(sa.PLUGIN_NAME),this.bottomIconCallback=()=>{if(this.isMenuButtonActive){const e=r.bD.getSensorManager();e.isSensorSelected()&&((0,o.Gn)("cs-lat").value=e.currentSensors[0].lat.toString(),(0,o.Gn)("cs-lon").value=e.currentSensors[0].lon.toString(),(0,o.Gn)("cs-hei").value=e.currentSensors[0].alt.toString())}},this.bottomIconElementName="custom-sensor-icon",this.bottomIconLabel="Custom Sensor",this.bottomIconImg=ea,this.sideMenuElementName="custom-sensor-menu",this.sideMenuElementHtml=r.bD.html`
  ...
  <br><br>
  If you are trying to edit an existing sensor, you can select it from the sensor list first and the custom sensor will be updated with the selected sensor's information.`}addHtml(){super.addHtml(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{oa.addCustomSensorFormSubmitListener(),oa.addTelescopeClickListener_(),oa.addCustomSensorBtnCLickListener_(),oa.addClearCustomSensorListener_(),oa.addUseGeolocationListener_()}})}static addCustomSensorFormSubmitListener(){(0,o.Gn)("customSensor").addEventListener("submit",(e=>{e.preventDefault()}))}static addUseGeolocationListener_(){(0,o.Gn)("cs-geolocation").addEventListener("click",ia.useCurrentGeolocationAsSensor)}static addClearCustomSensorListener_(){(0,o.Gn)("cs-clear").addEventListener("click",(()=>{r.bD.getSensorManager().clearSecondarySensors()}))}static addCustomSensorBtnCLickListener_(){(0,o.Gn)("cs-submit").addEventListener("click",(()=>{oa.processCustomSensorSubmit_()}))}static processCustomSensorSubmit_(){var e,t,i,a,s;null===(e=(0,o.Gn)("menu-sensor-info"))||void 0===e||e.classList.remove("bmenu-item-disabled"),null===(t=(0,o.Gn)("menu-fov-bubble"))||void 0===t||t.classList.remove("bmenu-item-disabled"),null===(i=(0,o.Gn)("menu-surveillance"))||void 0===i||i.classList.remove("bmenu-item-disabled"),null===(a=(0,o.Gn)("menu-planetarium"))||void 0===a||a.classList.remove("bmenu-item-disabled"),null===(s=(0,o.Gn)("menu-astronomy"))||void 0===s||s.classList.remove("bmenu-item-disabled"),(0,o.Gn)("sensor-type").value=(0,o.Gn)("cs-type").value.replace(/</gu,"&lt;").replace(/>/gu,"&gt;"),(0,o.Gn)("sensor-info-title").innerHTML="Custom Sensor",(0,o.Gn)("sensor-country").innerHTML="Custom Sensor";const n=oa.str2Deg((0,o.Gn)("cs-lon").value),l=oa.str2Deg((0,o.Gn)("cs-lat").value),c=(0,o.Gn)("cs-hei").value,d=(0,o.Gn)("cs-type").value,u=(0,o.Gn)("cs-minaz").value,g=(0,o.Gn)("cs-maxaz").value,p=(0,o.Gn)("cs-minel").value,h=(0,o.Gn)("cs-maxel").value,m=(0,o.Gn)("cs-minrange").value,b=(0,o.Gn)("cs-maxrange").value;let f=S.SpaceObjectType.OBSERVER;switch(d){case"Observer":f=S.SpaceObjectType.OBSERVER;break;case"Optical":f=S.SpaceObjectType.OPTICAL;break;case"Mechanical":f=S.SpaceObjectType.MECHANICAL;break;case"Phased Array Radar":f=S.SpaceObjectType.PHASED_ARRAY_RADAR;break;default:v.x.info("Unknown sensor type: "+d),f=S.SpaceObjectType.OBSERVER}r.bD.getSensorManager().addSecondarySensor({id:null,lat:l,lon:n,alt:oa.str2Km(c),obsminaz:oa.str2Deg(u),obsmaxaz:oa.str2Deg(g),obsminel:oa.str2Deg(p),obsmaxel:oa.str2Deg(h),obsminrange:oa.str2Km(m),obsmaxrange:oa.str2Km(b),type:f,name:"Custom Sensor",uiName:"Custom Sensor",system:"Custom Sensor",country:"Custom Sensor",objName:"Custom Sensor",operator:"Custom Sensor",zoom:oa.str2Km(b)>6e3?ge.$R.GEO:ge.$R.LEO,volume:!1})}static addTelescopeClickListener_(){(0,o.Gn)("cs-telescope").addEventListener("click",(()=>{if((0,o.Gn)("cs-telescope").checked)(0,o.Gn)("cs-minaz-div").style.display="none",(0,o.Gn)("cs-maxaz-div").style.display="none",(0,o.Gn)("cs-minel-div").style.display="none",(0,o.Gn)("cs-maxel-div").style.display="none",(0,o.Gn)("cs-minrange-div").style.display="none",(0,o.Gn)("cs-maxrange-div").style.display="none",(0,o.Gn)("cs-minaz").value="0",(0,o.Gn)("cs-maxaz").value="360",(0,o.Gn)("cs-minel").value="10",(0,o.Gn)("cs-maxel").value="90",(0,o.Gn)("cs-minrange").value="100",(0,o.Gn)("cs-maxrange").value="1000000";else{(0,o.Gn)("cs-minaz-div").style.display="block",(0,o.Gn)("cs-maxaz-div").style.display="block",(0,o.Gn)("cs-minel-div").style.display="block",(0,o.Gn)("cs-maxel-div").style.display="block",(0,o.Gn)("cs-minrange-div").style.display="block",(0,o.Gn)("cs-maxrange-div").style.display="block";const e=r.bD.getSensorManager();e.isSensorSelected()&&((0,o.Gn)("cs-minaz").value=e.currentSensors[0].obsminaz.toString(),(0,o.Gn)("cs-maxaz").value=e.currentSensors[0].obsmaxaz.toString(),(0,o.Gn)("cs-minel").value=e.currentSensors[0].obsminel.toString(),(0,o.Gn)("cs-maxel").value=e.currentSensors[0].obsmaxel.toString(),(0,o.Gn)("cs-minrange").value=e.currentSensors[0].obsminrange.toString(),(0,o.Gn)("cs-maxrange").value=e.currentSensors[0].obsmaxrange.toString())}}))}static str2Km(e){return parseFloat(e)}static str2Deg(e){return parseFloat(e)}}oa.PLUGIN_NAME="Custom Sensor";const la=new oa,ra=i.p+"../img/lookangles.png";class ca extends u.c{constructor(){super(ca.PLUGIN_NAME),this.isRequireSatelliteSelected=!0,this.isRequireSensorSelected=!0,this.bottomIconCallback=()=>{this.refreshSideMenuData()},this.bottomIconElementName="look-angles-icon",this.bottomIconLabel="Look Angles",this.bottomIconImg=ra,this.isIconDisabledOnLoad=!0,this.isIconDisabled=!0,this.dragOptions={isDraggable:!0,minWidth:300,maxWidth:450},this.helpTitle="Look Angles Menu",this.helpBody=r.bD.html`
    ...
    </div>`,this.refreshSideMenuData=()=>{this.isMenuButtonActive&&(0,V.QP)((()=>{const e=r.bD.getCatalogManager().getSat(r.bD.getCatalogManager().selectedSat,Oe.C_.EXTRA_ONLY);this.getlookangles(e)}))}}addHtml(){super.addHtml(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{var e;(0,o.Gn)("look-angles-length").addEventListener("change",(()=>{this.lookanglesLength=parseInt((0,o.Gn)("look-angles-length").value),this.refreshSideMenuData()})),(0,o.Gn)("look-angles-interval").addEventListener("change",(()=>{this.lookanglesInterval=parseInt((0,o.Gn)("look-angles-interval").value),this.refreshSideMenuData()})),null===(e=(0,o.Gn)("export-look-angles"))||void 0===e||e.addEventListener("click",(()=>{(0,Ve.Eb)(this.lastlooksArray,"Look-Angles")})),(0,o.Gn)("settings-riseset").addEventListener("change",this.settingsRisesetChange.bind(this));const t=r.bD.getCatalogManager().getSelectedSat();this.checkIfCanBeEnabled_(t)}}),r.bD.register({event:r.RL.selectSatData,cbName:this.PLUGIN_NAME,cb:e=>{this.checkIfCanBeEnabled_(e)}}),r.bD.register({event:r.RL.resetSensor,cbName:this.PLUGIN_NAME,cb:()=>{this.checkIfCanBeEnabled_(null)}})}checkIfCanBeEnabled_(e){(null==e?void 0:e.TLE1)&&r.bD.getSensorManager().isSensorSelected()?(this.setBottomIconToEnabled(),this.isMenuButtonActive&&e&&this.getlookangles(e)):(this.isMenuButtonActive&&this.closeSideMenu(),this.setBottomIconToDisabled())}addJs(){super.addJs(),r.bD.register({event:r.RL.staticOffsetChange,cbName:this.PLUGIN_NAME,cb:()=>{this.refreshSideMenuData()}})}getlookangles(e,t){const i=r.bD.getTimeManager();if(!t){const e=r.bD.getSensorManager();if(!e.isSensorSelected())return console.debug("satellite.getlookangles requires a sensor to be set!"),[];t=e.currentSensors}let a=this.isRiseSetLookangles?1:this.lookanglesInterval,s=[],n=0;for(let o=0;o<24*this.lookanglesLength*60*60;o+=a){n=1e3*o;let a=i.getOffsetTimeObj(n),l=Bt.J.getTearData(a,e.satrec,t,this.isRiseSetLookangles);if(""!==l.time&&s.push(l),s.length>=1500)break}return s.sort(((e,t)=>new Date(e.time).getTime()-new Date(t.time).getTime())),this.lastlooksArray=s,(()=>{let e=(0,o.Gn)("looks");e.innerHTML="";let t=e.insertRow(),a=t.insertCell();a.appendChild(document.createTextNode("Time")),a.setAttribute("style","text-decoration: underline");let n=t.insertCell();n.appendChild(document.createTextNode("El")),n.setAttribute("style","text-decoration: underline");let l=t.insertCell();l.appendChild(document.createTextNode("Az")),l.setAttribute("style","text-decoration: underline");let c=t.insertCell();c.appendChild(document.createTextNode("Rng")),c.setAttribute("style","text-decoration: underline");for(const t of s)if(e.rows.length>0){const s=e.insertRow();s.setAttribute("class","link"),a=s.insertCell(),a.appendChild(document.createTextNode((0,kt.v)(t.time,"isoDateTime",!1))),a.addEventListener("click",(()=>{i.changeStaticOffset(new Date((0,kt.v)(t.time,"isoDateTime",!1)+"z").getTime()-i.realTime),i.calculateSimulationTime(),r.bD.methods.updateDateTime(new Date(i.dynamicOffsetEpoch+i.staticOffset))})),n=s.insertCell(),n.appendChild(document.createTextNode(t.el.toFixed(1))),l=s.insertCell(),l.appendChild(document.createTextNode(t.az.toFixed(0))),c=s.insertCell(),c.appendChild(document.createTextNode(t.rng.toFixed(0)))}})(),s}settingsRisesetChange(e,t){if(null==e)throw new Error("e is undefined");null!=t||(t=(0,o.Gn)("settings-riseset").checked),this.isRiseSetLookangles=!!t,this.refreshSideMenuData()}}ca.PLUGIN_NAME="Look Angles";const da=new ca,ua=i.p+"../img/radio-tower.png";class ga extends u.c{constructor(){super(ga.PLUGIN_NAME),this.isRequireSensorSelected=!0,this.bottomIconCallback=()=>{this.getSensorInfo(),this.checkIfLinesVisible_(r.bD.getLineManager())},this.bottomIconElementName="sensor-info-icon",this.bottomIconLabel="Sensor Info",this.bottomIconImg=ua,this.isIconDisabledOnLoad=!0,this.isIconDisabled=!0,this.sideMenuElementName="sensor-info-menu",this.sideMenuElementHtml=r.bD.html`
    ...
    <br>
    Additionally, lines can be quickly created from the sensor to the sun or moon from this menu.`}addHtml(){super.addHtml(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{this.addSensorToSunBtnListener_(),this.addSensorToMoonBtnListener()}}),r.bD.register({event:r.RL.onLineAdded,cbName:this.PLUGIN_NAME,cb:e=>{this.checkIfLinesVisible_(e)}})}checkIfLinesVisible_(e){this.isSunLineVisible_=e.drawLineList.some((e=>e.type===Ni.jv.SENSOR_TO_SUN)),this.isSunLineVisible_?((0,o.Gn)("sensor-sun-btn").textContent="Remove Line to Sun  ▶",this.isSunLineVisible_=!0):((0,o.Gn)("sensor-sun-btn").textContent="Add Line to Sun  ▶",this.isSunLineVisible_=!1),this.isMonnLineVisible_=e.drawLineList.some((e=>e.type===Ni.jv.SENSOR_TO_MOON)),this.isMonnLineVisible_?((0,o.Gn)("sensor-moon-btn").textContent="Remove Line to Moon  ▶",this.isMonnLineVisible_=!0):((0,o.Gn)("sensor-moon-btn").textContent="Add Line to Moon  ▶",this.isMonnLineVisible_=!1)}addSensorToMoonBtnListener(){(0,o.Gn)("sensor-moon-btn").addEventListener("click",(()=>{if(this.isMonnLineVisible_){const e=r.bD.getLineManager();for(const t of e.drawLineList)if(t.type===Ni.jv.SENSOR_TO_MOON)return e.drawLineList.splice(e.drawLineList.indexOf(t),1),(0,o.Gn)("sensor-moon-btn").textContent="Add Line to Moon  ▶",void(this.isMonnLineVisible_=!1)}else{const e=r.bD.getSensorManager().currentSensors;1!==e.length&&r.bD.getUiManager().toast("Please Select Only One Sensor","caution");const t=r.bD.getScene();r.bD.getLineManager().create(Ni.jv.SENSOR_TO_MOON,[r.bD.getCatalogManager().getSensorFromSensorName(e[0].name),t.moon.position[0],t.moon.position[1],t.moon.position[2]],"w"),(0,o.Gn)("sensor-moon-btn").textContent="Remove Line to Moon  ▶",this.isMonnLineVisible_=!0}}))}addSensorToSunBtnListener_(){(0,o.Gn)("sensor-sun-btn").addEventListener("click",(()=>{if(this.isSunLineVisible_){const e=r.bD.getLineManager();for(const t of e.drawLineList)if(t.type===Ni.jv.SENSOR_TO_SUN)return e.drawLineList.splice(e.drawLineList.indexOf(t),1),(0,o.Gn)("sensor-sun-btn").textContent="Add Line to Sun  ▶",void(this.isSunLineVisible_=!1)}else{const e=r.bD.getSensorManager().currentSensors;1!==e.length&&r.bD.getUiManager().toast("Please Select Only One Sensor","caution");const t=r.bD.getScene();r.bD.getLineManager().create(Ni.jv.SENSOR_TO_SUN,[r.bD.getCatalogManager().getSensorFromSensorName(e[0].name),t.sun.position[0],t.sun.position[1],t.sun.position[2]],"o"),(0,o.Gn)("sensor-sun-btn").textContent="Remove Line to Sun  ▶",this.isSunLineVisible_=!0}}))}getSensorInfo(){if(!this.isHtmlAdded)return;const e=r.bD.getSensorManager().currentSensors[0];(0,o.Gn)("sensor-latitude").innerHTML=e.lat.toString(),(0,o.Gn)("sensor-longitude").innerHTML=e.lon.toString(),(0,o.Gn)("sensor-minazimuth").innerHTML=e.obsminaz.toString(),(0,o.Gn)("sensor-maxazimuth").innerHTML=e.obsmaxaz.toString(),(0,o.Gn)("sensor-minelevation").innerHTML=e.obsminel.toString(),(0,o.Gn)("sensor-maxelevation").innerHTML=e.obsmaxel.toString(),(0,o.Gn)("sensor-minrange").innerHTML=e.obsminrange.toString(),(0,o.Gn)("sensor-maxrange").innerHTML=e.obsmaxrange.toString()}}ga.PLUGIN_NAME="Sensor Info";const pa=new ga,ha=i.p+"../img/radar.png";var ma=i(6246),ba=i(5623);class va extends u.c{constructor(){super(va.PLUGIN_NAME),this.dependencies=[Ct.s.PLUGIN_NAME],this.bottomIconCallback=()=>{var e;this.isMenuButtonActive&&((null===(e=r.bD.getPlugin(et))||void 0===e?void 0:e.isMenuButtonActive)?(0,ba.l)("sensor-top-link").forEach((e=>{e.style.display="none"})):(0,ba.l)("sensor-top-link").forEach((e=>{e.style.gridTemplateColumns="repeat(2,1fr)",e.style.display=""})))},this.dragOptions={isDraggable:!0,minWidth:500,maxWidth:700},this.bottomIconElementName="sensor-list-icon",this.bottomIconLabel="Sensors",this.bottomIconImg=ha,this.sideMenuElementName="sensor-list-menu",this.sideMenuElementHtml=r.bD.html`
  ...
  If you have public data on additional sensors or corrections to existing sensor information please contact me at <a href="mailto:theodore.kruczek@gmail.com">theodore.kruczek@gmail.com</a>.`}addHtml(){super.addHtml(),r.bD.register({event:r.RL.uiManagerInit,cbName:this.PLUGIN_NAME,cb:()=>{(0,o.Gn)("nav-mobile").insertAdjacentHTML("beforeend",r.bD.html`<div id="sensor-selected" class="waves-effect waves-light"></div>`)}}),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,o.Gn)("sensor-selected").addEventListener("click",(()=>{r.bD.methods.bottomMenuClick(this.bottomIconElementName)})),(0,o.Gn)("sensor-list-content").addEventListener("click",(e=>{let t=e.target;if(!e.target.classList.contains("menu-selectable")&&(t=e.target.parentElement,!t.classList.contains("menu-selectable")))return;if("reset-sensor-button"===t.id)return void r.bD.getSensorManager().resetSensorSelected();const i=t.dataset.sensor;this.sensorListContentClick(i)}))}}),r.bD.register({event:"selectSatData",cbName:"sensor",cb:e=>{null!=e&&(null===r.bD.getPlugin(li.P)||this.isSensorLinksAdded||((0,o.Gn)("sat-info-top-links").insertAdjacentHTML("beforeend",r.bD.html`
                ...
                `),(0,o.Gn)("sensors-in-fov-link").addEventListener("click",(()=>{const e=r.bD.getCatalogManager();Object.keys(ma.T).forEach((t=>{const i=ma.T[t],a=e.getSat(e.selectedSat);Bt.J.getTearr(a,[i]).inView&&r.bD.getLineManager().create(Ni.jv.MULTI_SENSORS_TO_SAT,[a.id,e.getSensorFromSensorName(i.name)],"g")}))})),this.isSensorLinksAdded=!0))}}),r.bD.register({event:r.RL.setSensor,cbName:this.PLUGIN_NAME,cb:e=>{(0,o.Gn)("reset-sensor-button").style.display=e?"block":"none"}})}sensorListContentClick(e){if(!this.isMenuButtonActive)return;const t=r.bD.getSensorManager();if(void 0!==e){switch(e){case"cspocAll":t.setSensor("SSN");break;case"mwAll":t.setSensor("NATO-MW");break;case"mdAll":t.setSensor("MD-ALL");break;case"esocAll":t.setSensor("ESOC-ALL");break;case"llAll":t.setSensor("LEO-LABS");break;case"rusAll":t.setSensor("RUS-ALL");break;case"prcAll":t.setSensor("PRC-ALL");break;default:t.setSensor(ma.T[`${e}`])}r.bD.getCatalogManager().setSelectedSat(-1);try{r.bD.getMainCamera().lookAtLatLon(t.currentSensors[0].lat,t.currentSensors[0].lon,t.currentSensors[0].zoom,r.bD.getTimeManager().selectedDate)}catch(e){v.x.warn("Error in sensorListContentClick: "+e)}settingsManager.currentColorScheme==r.bD.getColorSchemeManager().default&&qe.j.change("default")}else v.x.debug("The menu item was clicked but the menu was not defined.")}static createLiForSensor(e){return r.bD.html`
      ...
      <div class="row">
        ...
        <div class="center-align">
          <button id="stf-clear-all" class="btn btn-ui waves-effect waves-light" type="button" name="action">Clear All STFs &#9658;</button>
  ...
  </div>`}addHtml(){super.addHtml(),r.bD.register({event:r.RL.selectSatData,cbName:this.PLUGIN_NAME,cb:e=>{null!=e&&(this.isAddStfLinksOnce||((0,o.Gn)("sat-info-top-links").insertAdjacentHTML("beforeend",r.bD.html`
            ...
            `),(0,o.Gn)("stf-on-object-link").addEventListener("click",this.stfOnObjectLinkClick.bind(this)),this.isAddStfLinksOnce=!0))}})}addJs(){super.addJs(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,o.Gn)("stfForm").addEventListener("submit",(e=>{e.preventDefault(),this.onSubmit.bind(this)()})),(0,o.Gn)("stf-remove-last").addEventListener("click",(()=>{r.bD.getSensorManager().removeStf()})),(0,o.Gn)("stf-clear-all").addEventListener("click",(()=>{r.bD.getSensorManager().clearStf()}))}}),r.bD.register({event:"resetSensor",cbName:"shortTermFences",cb:this.closeAndDisable.bind(this)}),r.bD.register({event:"setSensor",cbName:"shortTermFences",cb:(e,t)=>{null==e&&null==t?(this.closeAndDisable(),(0,m.kW)((0,o.Gn)(this.sideMenuElementName),1e3)):this.setBottomIconToEnabled()}})}closeAndDisable(){this.isMenuButtonActive=!1,this.setBottomIconToUnselected(),this.setBottomIconToDisabled(),r.bD.getUiManager().hideSideMenus()}onSubmit(){var e;if(!this.verifySensorSelected())return;const t=r.bD.getSensorManager(),{lat:i,lon:a,alt:s}=t.currentSensors[0],n=parseFloat((0,o.Gn)("stf-az").value),l=parseFloat((0,o.Gn)("stf-azExt").value),c=parseFloat((0,o.Gn)("stf-el").value),d=parseFloat((0,o.Gn)("stf-elExt").value),u=parseFloat((0,o.Gn)("stf-rng").value),g=parseFloat((0,o.Gn)("stf-rngExt").value),p=n-l<0?n-l+360:n-l/2,h=n+l>360?n+l-360:n+l/2,m=c-d/2,b=c+d/2,S=u-g/2,M=u+g/2,y={lat:i,lon:a,alt:s,obsminaz:p,obsmaxaz:h,obsminel:m,obsmaxel:b,obsminrange:S,obsmaxrange:M,type:"Short Range Fence"};f.$.checkIsInView(t.currentSensors[0],{az:p,el:m,rng:S})&&f.$.checkIsInView(t.currentSensors[0],{az:h,el:b,rng:M})?(t.addStf(y),null===(e=r.bD.getPlugin(Ji))||void 0===e||e.enableFovView()):v.x.warn("STF is not in view of the sensor!")}stfOnObjectLinkClick(){const e=r.bD.getSensorManager();if(!this.verifySensorSelected())return;if(!this.verifySatelliteSelected())return;const t=r.bD.getCatalogManager(),i=Bt.J.getTearr(t.getSat(t.selectedSat),e.currentSensors);(0,o.Gn)("stf-az").value=i.az.toFixed(1),(0,o.Gn)("stf-el").value=i.el.toFixed(1),(0,o.Gn)("stf-rng").value=i.rng.toFixed(1),r.bD.getUiManager().hideSideMenus(),(0,m.$k)((0,o.Gn)("stf-menu"),1e3),this.isMenuButtonActive=!0,this.setBottomIconToSelected()}}Ta.PLUGIN_NAME="Short Term Fences";const Aa=new Ta;var ka=i(3067);class Ia extends u.c{constructor(){super("Social Media"),this.dependencies=["Top Menu"]}addHtml(){super.addHtml(),r.bD.register({event:"uiManagerFinal",cbName:this.PLUGIN_NAME,cb:Ia.uiManagerFinal_})}static uiManagerFinal_(){const e=document.createElement("li");e.innerHTML=r.bD.html`
  ...
  </div>`,this.helpTitle="Settings Menu",this.helpBody=r.bD.html`The Settings menu allows you to configure the application.`,this.isNotColorPickerInitialSetup=!1}addHtml(){super.addHtml(),r.bD.register({event:r.RL.uiManagerFinal,cbName:this.PLUGIN_NAME,cb:()=>{(0,o.Gn)("video-director-form").addEventListener("change",Oa.onFormChange),(0,o.Gn)("video-director-form").addEventListener("submit",Oa.onSubmit),(0,o.Gn)("video-director-rotate").addEventListener("click",(()=>{var e;null===(e=r.bD.getSoundManager())||void 0===e||e.play("button"),r.bD.getMainCamera().autoRotate(!0)}))}})}static onFormChange(e){var t,i,a;if(null==e)throw new Error("e is undefined");switch(null===(t=e.target)||void 0===t?void 0:t.id){case"video-director-rotateL":case"video-director-rotateR":case"video-director-rotateU":case"video-director-rotateD":case"video-director-panL":case"video-director-panR":case"video-director-panU":case"video-director-panD":case"video-director-zoomIn":case"video-director-zoomOut":(0,o.Gn)(e.target.id).checked?null===(i=r.bD.getSoundManager())||void 0===i||i.play("toggleOn"):null===(a=r.bD.getSoundManager())||void 0===a||a.play("toggleOff")}(0,o.Gn)("video-director-selectedColor").checked&&0!==settingsManager.selectedColor[3]?(settingsManager.selectedColorFallback=settingsManager.selectedColor,settingsManager.selectedColor=[0,0,0,0]):settingsManager.selectedColor=settingsManager.selectedColorFallback,settingsManager.autoRotateSpeed=parseFloat((0,o.Gn)("video-director-rotateSpeed").value),settingsManager.autoPanSpeed=parseFloat((0,o.Gn)("video-director-panSpeed").value),settingsManager.autoZoomSpeed=parseFloat((0,o.Gn)("video-director-zoomSpeed").value);const s=(0,o.Gn)("video-director-rotateL").checked,n=(0,o.Gn)("video-director-rotateR").checked,l=(0,o.Gn)("video-director-rotateU").checked,c=(0,o.Gn)("video-director-rotateD").checked,d=(0,o.Gn)("video-director-panL").checked,u=(0,o.Gn)("video-director-panR").checked,g=(0,o.Gn)("video-director-panU").checked,p=(0,o.Gn)("video-director-panD").checked,h=(0,o.Gn)("video-director-zoomIn").checked,m=(0,o.Gn)("video-director-zoomOut").checked;s&&!settingsManager.isAutoRotateL&&((0,o.Gn)("video-director-rotateR").checked=!1),n&&!settingsManager.isAutoRotateR&&((0,o.Gn)("video-director-rotateL").checked=!1),l&&!settingsManager.isAutoRotateU&&((0,o.Gn)("video-director-rotateD").checked=!1),c&&!settingsManager.isAutoRotateD&&((0,o.Gn)("video-director-rotateU").checked=!1),d&&!settingsManager.isAutoPanL&&((0,o.Gn)("video-director-panR").checked=!1),u&&!settingsManager.isAutoPanR&&((0,o.Gn)("video-director-panL").checked=!1),g&&!settingsManager.isAutoPanU&&((0,o.Gn)("video-director-panD").checked=!1),p&&!settingsManager.isAutoPanD&&((0,o.Gn)("video-director-panU").checked=!1),h&&!settingsManager.isAutoZoomIn&&((0,o.Gn)("video-director-zoomOut").checked=!1),m&&!settingsManager.isAutoZoomOut&&((0,o.Gn)("video-director-zoomIn").checked=!1)}static onSubmit(e){var t;if(null==e)throw new Error("e is undefined");e.preventDefault(),null===(t=r.bD.getSoundManager())||void 0===t||t.play("button"),settingsManager.isAutoRotateR=(0,o.Gn)("video-director-rotateR").checked,settingsManager.isAutoRotateL=(0,o.Gn)("video-director-rotateL").checked,settingsManager.isAutoRotateU=(0,o.Gn)("video-director-rotateU").checked,settingsManager.isAutoRotateD=(0,o.Gn)("video-director-rotateD").checked,settingsManager.isAutoPanR=(0,o.Gn)("video-director-panR").checked,settingsManager.isAutoPanL=(0,o.Gn)("video-director-panL").checked,settingsManager.isAutoPanU=(0,o.Gn)("video-director-panU").checked,settingsManager.isAutoPanD=(0,o.Gn)("video-director-panD").checked,settingsManager.isAutoZoomIn=(0,o.Gn)("video-director-zoomIn").checked,settingsManager.isAutoZoomOut=(0,o.Gn)("video-director-zoomOut").checked}}Oa.PLUGIN_NAME="Video Director";const Ra=new Oa;var _a=i(2939),Fa=i(5474);const Ua=(e,t)=>{return i=void 0,a=void 0,n=function*(){null!=t||(t={});try{t.debug&&Dt.x.init();const i=new li.P;i.init(),Pe.I.registerSingleton(Oe.Yv.SelectSatManager,i),t.topMenu&&Fe.t.init(),t.satInfoboxCore&&oi.P.init(),t.updateSelectBoxCore&&Pa.i.init(),t.datetime&&Ct.t.init(),t.social&&Na.init(),t.classificationBar&&mt.init(),t.sensor&&(fa.init(),pa.init(),la.init(),da.init(),na.init()),t.watchlist&&(_a.P.init(),Fa.n.init()),t.nextLaunch&&ii.init(),t.findSat&&$t.init(),t.shortTermFences&&Aa.init(),t.orbitReferences&&ci.init(),t.collisions&&ft.init(),t.breakup&&gt.init(),t.debrisScreening&&xt.init(),t.editSat&&_t.init(),t.newLaunch&&qt.init(),t.initialOrbit&&O(),t.missile&&le(),t.stereoMap&&Ga.M.init(),t.sensorFov&&Xi.init(),t.sensorSurv&&Qi.init(),t.satelliteView&&he.init(),t.satelliteFov&&_i.init(),t.planetarium&&tt.init(),t.astronomy&&at.init(),t.nightToggle&&ni.init(),t.dops&&Gt.init(),t.constellations&&Pi.init(),t.countries&&p.init(),t.colorsMenu&&wt.init(),t.screenshot&&Wi.init(),t.launchCalendar&&Yt.init(),t.timeMachine&&La.M.init(),t.photoManager&&Bi.init(),t.screenRecorder&&ji.init(),t.analysis&&Xe.init(),t.plotAnalysis&&vi.init(),t.plotAnalysis&&hi.init(),t.plotAnalysis&&Di.init(),t.plotAnalysis&&Ai.init(),t.plotAnalysis&&yi.init(),t.plotAnalysis&&Ci.init(),t.aboutManager&&$e.init(),t.settingsMenu&&Da.init(),t.soundManager&&_e.init(),t.gamepad&&jt.init(),t.videoDirector&&Ra.init(),e.register({event:r.RL.uiManagerFinal,cbName:"core",cb:()=>{Ba(t)}})}catch(e){v.x.info("Error loading core plugins:"+e.message)}},new((s=void 0)||(s=Promise))((function(e,t){function o(e){try{r(n.next(e))}catch(e){t(e)}}function l(e){try{r(n.throw(e))}catch(e){t(e)}}function r(t){var i;t.done?e(t.value):(i=t.value,i instanceof s?i:new s((function(e){e(i)}))).then(o,l)}r((n=n.apply(i,a||[])).next())}));var i,a,s,n},Ba=e=>{const t=(0,o.Gn)("bottom-icons-container");if(t){const e=t.offsetHeight;document.documentElement.style.setProperty("--bottom-menu-height",e+"px")}else document.documentElement.style.setProperty("--bottom-menu-height","0px");if(e.topMenu){let e=parseInt(document.documentElement.style.getPropertyValue("--top-menu-height").replace("px",""));isNaN(e)&&(e=0),settingsManager.isMobileModeEnabled?document.documentElement.style.setProperty("--top-menu-height",e+17+"px"):document.documentElement.style.setProperty("--top-menu-height",e+22+"px")}(0,o.Gn)("bottom-icons")&&""==(0,o.Gn)("bottom-icons").innerText&&((0,o.Gn)("nav-footer").style.visibility="hidden");const i=(0,o.Gn)("bottom-icons-container");if(i){const e=i.offsetHeight;document.documentElement.style.setProperty("--bottom-menu-top",e+"px")}e.aboutManager&&((0,o.Gn)("versionNumber-text").innerHTML=`${settingsManager.versionNumber} - ${settingsManager.versionDate}`),"keeptrack.space"!==window.location.hostname&&"www.keeptrack.space"!==window.location.hostname||za(),(0,o.Gn)("bottom-icons-container").addEventListener("mousewheel",(e=>{e.preventDefault(),((e,t)=>{const i=e.scrollTop+.15*t;e.scrollTop=i})(e.currentTarget,e.deltaY)}),{passive:!1})},za=()=>{const e=document.createElement("script");e.type="text/javascript",e.setAttribute("async","true"),e.setAttribute("src","https://www.googletagmanager.com/gtag/js?id=G-ENHWK6L0X7"),document.documentElement.firstChild.appendChild(e),window.dataLayer=window.dataLayer||[];const t=function(e,t){window.dataLayer.push(arguments)};t("js",new Date),t("config","G-ENHWK6L0X7")}}}]);