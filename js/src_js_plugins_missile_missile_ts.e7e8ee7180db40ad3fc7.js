...
const getMissileTEARR = (missile, sensors) => {
    ...
    if (sensor.obsminaz > sensor.obsmaxaz) {
        if (((currentTEARR.az >= sensor.obsminaz || currentTEARR.az <= sensor.obsmaxaz) && currentTEARR.el >= sensor.obsminel && currentTEARR.el <= sensor.obsmaxel && currentTEARR.rng <= sensor.obsmaxrange && currentTEARR.rng >= sensor.obsminrange) ||
...
//# sourceMappingURL=src_js_plugins_missile_missile_ts.e7e8ee7180db40ad3fc7.js.map