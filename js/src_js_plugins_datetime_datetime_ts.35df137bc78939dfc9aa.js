...
var datetimeTextClick = function () {
    ...
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.methods.updateDateTime(new Date(timeManager.calculateSimulationTime()));
...
var datetimeInputFormChange = function (jestOverride) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, timeManager = _a.timeManager, uiManager = _a.uiManager;
    var selectedDate = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#datetime-input-tb').datepicker('getDate') || jestOverride;
    var today = new Date();
    var jday = timeManager.getDayOfYear(timeManager.calculateSimulationTime());
    ...
    // TODO: Migrate to watchlist.ts
    try {
        _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.watchlist.lastOverlayUpdateTime = timeManager.realTime * 1 - 7000;
        uiManager.updateNextPassOverlay(true);
    }
    catch (_b) {
        // Ignore
...
//# sourceMappingURL=src_js_plugins_datetime_datetime_ts.35df137bc78939dfc9aa.js.map