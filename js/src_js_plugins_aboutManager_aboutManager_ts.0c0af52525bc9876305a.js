...
const init = () => {
        ...
        cb: (iconName) => {
            if (iconName === 'menu-about') {
                ...
                if (isAboutSelected) {
                    ...
                    _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.uiManager.hideSideMenus();
                    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#about-menu').effect('slide', { direction: 'left', mode: 'show' }, 1000);
                    isAboutSelected = true;
                    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-about').addClass('bmenu-item-selected');
                    return;
                }
            }
        },
    ...
    _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.register({
        ...
        cbName: 'about',
        cb: () => {
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#about-menu').effect('slide', { direction: 'left', mode: 'hide' }, 1000);
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-about').removeClass('bmenu-item-selected');
            isAboutSelected = false;
        },
    });
};
...
//# sourceMappingURL=src_js_plugins_aboutManager_aboutManager_ts.0c0af52525bc9876305a.js.map