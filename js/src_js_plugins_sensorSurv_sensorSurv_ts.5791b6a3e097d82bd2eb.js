    ...
    if (iconName === 'menu-surveillance') {
        if (!sensorManager.checkSensorSelected()) {
            ...
            if (settingsManager.plugins.topMenu)
                _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.adviceManager.adviceList.survFenceDisabled();
            uiManager.toast(`Select a Sensor First!`, 'caution');
            if (!jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-surveillance:animated').length) {
                jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-surveillance').effect('shake', {
                    distance: 10,
                });
            }
            return;
        ...
        if (settingsManager.isShowSurvFence) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-surveillance').addClass('bmenu-item-selected');
...
//# sourceMappingURL=src_js_plugins_sensorSurv_sensorSurv_ts.5791b6a3e097d82bd2eb.js.map