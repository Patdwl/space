...
var updateSelectBoxCoreCallback = function (sat) {
    ...
    $('#jday').html(jday);
    if (((_a = settingsManager.plugins) === null || _a === void 0 ? void 0 : _a.stereoMap) && _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.mapManager.isMapMenuOpen && timeManager.now > settingsManager.lastMapUpdateTime + 30000) {
...
//# sourceMappingURL=src_js_plugins_updateSelectBox_updateSelectBoxCore_ts.24fd5f292af7a88f103a.js.map