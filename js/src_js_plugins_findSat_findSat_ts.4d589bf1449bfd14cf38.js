...
var newLaunchSubmit = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, timeManager = _a.timeManager, mainCamera = _a.mainCamera, satellite = _a.satellite, satSet = _a.satSet, orbitManager = _a.orbitManager, uiManager = _a.uiManager;
    ...
    var TLEs = satellite.getOrbitByLatLon(sat, launchLat, launchLon, upOrDown, simulationTimeObj);
    var TLE1 = TLEs[0];
    var TLE2 = TLEs[1];
...
//# sourceMappingURL=src_js_plugins_findSat_findSat_ts.4d589bf1449bfd14cf38.js.map