...
const init = () => {
    ...
    _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.register({
        ...
        cb: () => {
            // Bottom Icon
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#nav-mobile2').prepend(_app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.html `
        <li>
...
//# sourceMappingURL=src_js_plugins_social_social_ts.fd695246a655548f905d.js.map