...
var _initTable = function (tbl, launchList) {
    ...
    for (var i = 0; i < launchList.length; i++) {
        ...
        if (typeof launchList[i].missionURL == 'undefined' || launchList[i].missionURL == '') {
            nameHTML = "".concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_0__.truncateString)(nameText, 15));
        }
        else {
            nameHTML = "<a class='iframe' href=\"".concat(launchList[i].missionURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_0__.truncateString)(nameText, 15), "</a>");
        }
        ...
        if (typeof launchList[i].locationURL == 'undefined' || launchList[i].locationURL == '') {
            locationHTML = "".concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_0__.truncateString)(launchList[i].location, 25));
        }
        else {
            if (window.location.protocol === 'http:') {
                locationHTML = "<a class='iframe' href=\"".concat(launchList[i].locationURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_0__.truncateString)(launchList[i].location, 25), "</a>");
            }
            else {
                locationHTML = "<a class='iframe' href=\"".concat(launchList[i].locationURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_0__.truncateString)(launchList[i].location, 25), "</a>");
            }
        ...
        if (typeof launchList[i].agencyURL == 'undefined') {
            agencyHTML = "".concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_0__.truncateString)(launchList[i].agency, 30));
        }
        else {
            if (window.location.protocol === 'http:') {
                agencyHTML = "<a class='iframe' href=\"".concat(launchList[i].agencyURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_0__.truncateString)(launchList[i].agency, 30), "</a>");
            }
            else {
                agencyHTML = "<a class='iframe' href=\"".concat(launchList[i].agencyURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_0__.truncateString)(launchList[i].agency, 30), "</a>");
            }
...
//# sourceMappingURL=src_js_plugins_nextLaunch_nextLaunch_ts.d82fd34ae690916580ec.js.map