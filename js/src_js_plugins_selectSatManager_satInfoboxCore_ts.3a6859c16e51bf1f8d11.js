...
var sensorInfo = function (sat) {
    ...
    if (settingsManager.plugins.sensor) {
        if (_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.sensorManager.checkSensorSelected()) {
...
var launchData = function (sat) {
    ...
    // /////////////////////////////////////////////////////////////////////////
    var country = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.objectManager.extractCountry(sat.C);
    ...
    if (sat.missile) {
        ...
        site = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.objectManager.extractLaunchSite(sat.LS);
    }
    ...
    if (sat.missile) {
        ...
        satLvString = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.objectManager.extractLiftVehicle(sat.LV); // Replace with link if available
...
var nearObjectsLinkClick = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, uiManager = _a.uiManager, satSet = _a.satSet, objectManager = _a.objectManager;
...
var nearOrbitsLink = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, satSet = _a.satSet, searchBox = _a.searchBox, satellite = _a.satellite;
    // searchBox.doArraySearch(satellite.findNearbyObjectsByOrbit(satSet.getSat(objectManager.selectedSat)));
    var searchStr = searchBox.doArraySearch(satellite.findNearbyObjectsByOrbit(satSet.getSat(_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.objectManager.selectedSat)));
    searchBox.doSearch(searchStr, false);
};
var allObjectsLink = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, uiManager = _a.uiManager, satSet = _a.satSet, objectManager = _a.objectManager;
    if (objectManager.selectedSat === -1) {
        return;
    }
...
var orbitalData = function (sat) {
    ...
    if (!sat.missile) {
        ...
        $('#sat-inclination').html((sat.inclination * _app_js_lib_constants_js__WEBPACK_IMPORTED_MODULE_1__.RAD2DEG).toFixed(2) + '°');
        $('#sat-eccentricity').html(sat.eccentricity.toFixed(3));
        $('#sat-period').html(sat.period.toFixed(2) + ' min');
        $('#sat-period').tooltip({
            // delay: 50,
            html: 'Mean Motion: ' + (_app_js_lib_constants_js__WEBPACK_IMPORTED_MODULE_1__.MINUTES_PER_DAY / sat.period).toFixed(2),
            position: 'left',
        });
        // TODO: Error checking on Iframe
        var now = new Date();
        var jday = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.timeManager.getDayOfYear(now);
        now = now.getFullYear();
        ...
        if (!_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.objectManager.isSensorManagerLoaded) {
            ...
            now = new Date(_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.timeManager.dynamicOffsetEpoch + _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.timeManager.propOffset);
            var sunTime = _app_js_lib_suncalc_js__WEBPACK_IMPORTED_MODULE_2__.SunCalc.getTimes(now, _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.sensorManager.currentSensor.lat, _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.sensorManager.currentSensor.lon);
            var satInSun = -1;
            if (typeof sat.isInSun !== 'undefined') {
                satInSun = sat.isInSun();
            }
            // If No Sensor, then Ignore Sun Exclusion
            if (_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.sensorManager.currentSensor.lat === null) {
                $('#sat-sun').hide();
                return;
            }
            else {
            ...
            if (_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.sensorManager.currentSensor.type !== 'Optical' && _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.sensorManager.currentSensor.type !== 'Observer') {
...
var satMissionData = function (sat) {
    ...
    if (!sat.missile) {
        ...
        if (typeof sat.S1 != 'undefined' && sat.S1 != '') {
            $('#sat-source1').html("<a class=\"iframe\" href=\"".concat(sat.S1, "\">").concat(sat.S1.split('//').splice(1), "</a>"));
            $('#sat-source1w').show();
        }
        else {
        ...
        if (typeof sat.S2 != 'undefined' && sat.S2 != '') {
            $('#sat-source2').html("<a class=\"iframe\" href=\"".concat(sat.S2, "\">").concat(sat.S2.split('//').splice(1), "</a>"));
            $('#sat-source2w').show();
        }
        else {
        ...
        if (typeof sat.S3 != 'undefined' && sat.S3 != '') {
            $('#sat-source3').html("<a class=\"iframe\" href=\"".concat(sat.S3, "\">").concat(sat.S3.split('//').splice(1), "</a>"));
            $('#sat-source3w').show();
        }
        else {
        ...
        if (typeof sat.S4 != 'undefined' && sat.S4 != '') {
            $('#sat-source4').html("<a class=\"iframe\" href=\"".concat(sat.S4, "\">").concat(sat.S4.split('//').splice(1), "</a>"));
            $('#sat-source4w').show();
        }
        else {
        ...
        if (typeof sat.S5 != 'undefined' && sat.S5 != '') {
            $('#sat-source5').html("<a class=\"iframe\" href=\"".concat(sat.S5, "\">").concat(sat.S5.split('//').splice(1), "</a>"));
            $('#sat-source5w').show();
        }
        else {
        ...
        if (typeof sat.S6 != 'undefined' && sat.S6 != '') {
            $('#sat-source6').html("<a class=\"iframe\" href=\"".concat(sat.S6, "\">").concat(sat.S6.split('//').splice(1), "</a>"));
            $('#sat-source6w').show();
        }
        else {
        ...
        if (typeof sat.S7 != 'undefined' && sat.S7 != '') {
            $('#sat-source7').html("<a class=\"iframe\" href=\"".concat(sat.S7, "\">").concat(sat.S7.split('//').splice(1), "</a>"));
            $('#sat-source7w').show();
        }
        else {
        ...
        if (typeof sat.URL != 'undefined' && sat.URL != '') {
            $('#sat-source8').html("<a class=\"iframe\" href=\"".concat(sat.URL, "\">").concat(sat.URL.split('//').splice(1), "</a>"));
            $('#sat-source8w').show();
        }
        else {
...
var intelData = function (sat, satId) {
    if (satId !== -1) {
...
//# sourceMappingURL=src_js_plugins_selectSatManager_satInfoboxCore_ts.3a6859c16e51bf1f8d11.js.map