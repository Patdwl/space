...
var init = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs, adviceManager = _a.adviceManager, objectManager = _a.objectManager, uiManager = _a.uiManager;
    // Add HTML
    ...
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.register({
        ...
        cb: function (iconName) {
            if (iconName === 'menu-satview') {
                var mainCamera = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.mainCamera;
...
//# sourceMappingURL=src_js_plugins_satelliteView_satelliteView_ts.2eb7cb1ab0496413b179.js.map