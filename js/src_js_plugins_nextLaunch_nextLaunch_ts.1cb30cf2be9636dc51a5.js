...
var makeTableHeaders = function (tbl) {
...
var initTable = function (tbl, launchList) {
    ...
    for (var i = 0; i < launchList.length; i++) {
        ...
        if (typeof launchList[i].missionURL == 'undefined' || launchList[i].missionURL == '') {
            nameHTML = "".concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.truncateString)(nameText, 15));
        }
        else {
            nameHTML = "<a class='iframe' href=\"".concat(launchList[i].missionURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.truncateString)(nameText, 15), "</a>");
        }
        // Rocket Name HTML Setup
        var rocketHTML = void 0;
        if (typeof launchList[i].rocketURL == 'undefined') {
            rocketHTML = "".concat(launchList[i].rocket);
        }
        else {
            rocketHTML = "<a class='iframe' href=\"".concat(launchList[i].rocketURL, "\">").concat(launchList[i].rocket, "</a>");
        }
        // Set Name and Rocket HTML
        tdN.innerHTML = "".concat(nameHTML, "<br />").concat(rocketHTML);
        // Location Name HTML Setup
        var locationHTML = void 0;
        if (typeof launchList[i].locationURL == 'undefined' || launchList[i].locationURL == '') {
            locationHTML = "".concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.truncateString)(launchList[i].location, 25));
        }
        else {
            if (window.location.protocol === 'http:') {
                locationHTML = "<a class='iframe' href=\"".concat(launchList[i].locationURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.truncateString)(launchList[i].location, 25), "</a>");
            }
            else {
                locationHTML = "<a class='iframe' href=\"".concat(launchList[i].locationURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.truncateString)(launchList[i].location, 25), "</a>");
            }
        ...
        if (typeof launchList[i].agencyURL == 'undefined') {
            agencyHTML = "".concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.truncateString)(launchList[i].agency, 30));
        }
        else {
            if (window.location.protocol === 'http:') {
                agencyHTML = "<a class='iframe' href=\"".concat(launchList[i].agencyURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.truncateString)(launchList[i].agency, 30), "</a>");
            }
            else {
                agencyHTML = "<a class='iframe' href=\"".concat(launchList[i].agencyURL, "\">").concat((0,_app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.truncateString)(launchList[i].agency, 30), "</a>");
            }
        ...
        // Country Cell
        var tdC = tr.insertCell();
        tdC.innerHTML = "<span class=\"badge dark-blue-badge\" data-badge-caption=\"".concat(launchList[i].country, "\"></span>");
    }
};
...
var nextLaunchManager = {
    ...
    init: function () {
        ...
        if (window.location.hostname === 'localhost')
            return;
        jquery__WEBPACK_IMPORTED_MODULE_3___default().get('https://ll.thespacedevs.com/2.0.0/launch/upcoming/?format=json&limit=20&mode=detailed')
            .done(function (resp) { return nextLaunchManager.processData(resp); })
            .fail(function () { return console.debug("https://ll.thespacedevs.com/2.0.0/ is Unavailable!"); });
    },
    showTable: function () {
        var tbl = getTableElement();
...
//# sourceMappingURL=src_js_plugins_nextLaunch_nextLaunch_ts.1cb30cf2be9636dc51a5.js.map