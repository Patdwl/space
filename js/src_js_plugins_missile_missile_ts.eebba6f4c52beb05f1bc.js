...
/* harmony export */   "missileChange": () => (/* binding */ missileChange),
/* harmony export */   "msErrorClick": () => (/* binding */ msErrorClick),
/* harmony export */   "msTargetChange": () => (/* binding */ msTargetChange),
/* harmony export */   "missileSubmit": () => (/* binding */ missileSubmit),
/* harmony export */   "uiManagerInit": () => (/* binding */ uiManagerInit),
/* harmony export */   "init": () => (/* binding */ init),
/* harmony export */   "msAttackerChange": () => (/* binding */ msAttackerChange)
/* harmony export */ });
...
/* harmony import */ var _app_img_icons_missile_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @app/img/icons/missile.png */ "./src/img/icons/missile.png");




_app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.missileManager = _missileManager__WEBPACK_IMPORTED_MODULE_2__.missileManager;
...
const updateLoop = () => {
    if (typeof _missileManager__WEBPACK_IMPORTED_MODULE_2__.missileManager != 'undefined' && _missileManager__WEBPACK_IMPORTED_MODULE_2__.missileManager.missileArray.length > 0) {
        const { drawManager, orbitManager } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
...
const hideSideMenus = () => {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#missile-menu').effect('slide', { direction: 'left', mode: 'hide' }, 1000);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-missile').removeClass('bmenu-item-selected');
...
const bottomMenuClick = (iconName) => {
    if (iconName === 'menu-missile') {
        ...
        if (isMissileMenuOpen) {
            ...
            uiManager.hideSideMenus();
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#missile-menu').effect('slide', { direction: 'left', mode: 'show' }, 1000);
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-missile').addClass('bmenu-item-selected');
...
const missileChange = () => {
    if (parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-type').val()) !== 0) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-custom-opt').hide();
    }
    else {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-custom-opt').show();
    }
};
const msErrorClick = () => {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-error').hide();
};
const msTargetChange = () => {
    if (parseInt(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-target').val()) !== -1) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-tgt-holder-lat').hide();
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-tgt-holder-lon').hide();
    }
    else {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-tgt-holder-lat').show();
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-tgt-holder-lon').show();
    }
};
const missileSubmit = () => {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#loading-screen').fadeIn(1000, () => {
        const { uiManager, satSet, timeManager } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-error').hide();
        const type = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-type').val());
        const attacker = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-attacker').val());
        let lauLat = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-lat-lau').val());
        let lauLon = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-lon-lau').val());
        const target = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-target').val());
        let tgtLat = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-lat').val());
        let tgtLon = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-lon').val());
        ...
        if (type === 0) {
            if (target === -1) {
                ...
                if (isNaN(tgtLat)) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#loading-screen').hide();
                    return;
                }
                if (isNaN(tgtLon)) {
...
const uiManagerInit = () => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#bottom-icons').append(_app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.html `
        <div id="menu-missile" class="bmenu-item">
          <img
            alt="missile"
            src="" delayedsrc=${_app_img_icons_missile_png__WEBPACK_IMPORTED_MODULE_3__}
          />
          <span class="bmenu-title">Missile</span>
          <div class="status-icon"></div>
        </div>
      `);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#missile').on('submit', (e) => {
        missileSubmit();
        e.preventDefault();
    });
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#missile-menu').resizable({
        handles: 'e',
        stop: function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-attacker').on('change', msAttackerChange);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-target').on('change', msTargetChange);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-error').on('click', msErrorClick);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#missile').on('change', missileChange);
};
const init = () => {
    // Add HTML
...
const msAttackerChange = () => {
    isSub = false;
    const subList = [100, 600, 213, 214, 215, 321, 500, 400];
    for (let i = 0; i < subList.length; i++) {
        if (subList[i] == parseInt(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-attacker').val())) {
            isSub = true;
        }
    }
    if (!isSub) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-lau-holder-lat').hide();
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-lau-holder-lon').hide();
    }
    else {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-lau-holder-lat').show();
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#ms-lau-holder-lon').show();
    }
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MassRaidPre": () => (/* binding */ MassRaidPre),
/* harmony export */   "clearMissiles": () => (/* binding */ clearMissiles),
/* harmony export */   "Missile": () => (/* binding */ Missile),
/* harmony export */   "getMissileTEARR": () => (/* binding */ getMissileTEARR),
/* harmony export */   "_Pressure": () => (/* binding */ _Pressure),
/* harmony export */   "_Temperature": () => (/* binding */ _Temperature),
/* harmony export */   "_CD": () => (/* binding */ _CD),
/* harmony export */   "_ThrustFun": () => (/* binding */ _ThrustFun),
/* harmony export */   "_CoordinateCalculator": () => (/* binding */ _CoordinateCalculator),
/* harmony export */   "_IterationFun": () => (/* binding */ _IterationFun),
/* harmony export */   "_Bisection": () => (/* binding */ _Bisection),
/* harmony export */   "_QuickRun": () => (/* binding */ _QuickRun),
...
/* harmony import */ var _app_js_timeManager_transforms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @app/js/timeManager/transforms */ "./src/js/timeManager/transforms.ts");
...
const { satellite, sensorManager, timeManager } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
let EarthRadius, EarthMass, FuelDensity, BurnRate, WarheadMass, R, G, h;
const missileArray = [];
// External Functions
// This function stalls Jest for multiple minutes.
/* istanbul ignore next */
const MassRaidPre = (time, simFile) => {
    const { satSet, orbitManager } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
    missileManager.clearMissiles();
    jquery__WEBPACK_IMPORTED_MODULE_4___default().get(simFile, function (newMissileArray) {
        ...
        for (let i = 0; i < newMissileArray.length; i++) {
            ...
            const missileObj = satSet.getSat(x);
            if (missileObj) {
                missileObj.id = satSetLen - 500 + i;
                _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.satSet.satCruncher.postMessage({
                    id: missileObj.id,
                    typ: 'newMissile',
        ...
        _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.uiManager.doSearch('RV_');
    });
};
const clearMissiles = () => {
    const { satSet } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
    missileManager.missilesInUse = 0;
    _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.uiManager.doSearch('');
...
// This function stalls Jest for multiple minutes.
/* istanbul ignore next */
const Missile = (CurrentLatitude, CurrentLongitude, TargetLatitude, TargetLongitude, NumberWarheads, MissileObjectNum, CurrentTime, MissileDesc, Length, Diameter, NewBurnRate, MaxMissileRange, country, minAltitude) => {
    ...
    const { satSet, orbitManager } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
    const missileObj = satSet.getSat(MissileObjectNum);
    ...
    if (missileObj) {
        ...
        missileObj.type = _app_js_api_SpaceObjectType__WEBPACK_IMPORTED_MODULE_1__.SpaceObjectType.UNKNOWN;
        ...
        if (missileObj.apogee)
            delete missileObj.apogee;
        if (missileObj.argPe)
            delete missileObj.argPe;
        if (missileObj.eccentricity)
            delete missileObj.eccentricity;
        if (missileObj.inclination)
            delete missileObj.inclination;
        // maxAlt is used for zoom controls
        if (missileObj.meanMotion)
            delete missileObj.meanMotion;
        if (missileObj.perigee)
            delete missileObj.perigee;
        if (missileObj.period)
            delete missileObj.period;
        if (missileObj.raan)
            delete missileObj.raan;
        if (missileObj.semiMajorAxis)
            delete missileObj.semiMajorAxis;
        if (missileObj.semiMinorAxis)
            delete missileObj.semiMinorAxis;
        if (MissileDesc)
...
const getMissileTEARR = (missile, sensors) => {
    ...
    let j = (0,_app_js_timeManager_transforms__WEBPACK_IMPORTED_MODULE_3__.jday)(now.getUTCFullYear(), now.getUTCMonth() + 1, // NOTE:, this function requires months in range 1-12.
    now.getUTCDate(), now.getUTCHours(), now.getUTCMinutes(), now.getUTCSeconds()); // Converts time to jday (TLEs use epoch year/day)
    j += now.getUTCMilliseconds() * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.MILLISECONDS_PER_DAY;
    ...
    const cosLat = Math.cos(missile.latList[curMissileTime] * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.DEG2RAD);
    const sinLat = Math.sin(missile.latList[curMissileTime] * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.DEG2RAD);
    const cosLon = Math.cos(missile.lonList[curMissileTime] * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.DEG2RAD + gmst);
    const sinLon = Math.sin(missile.lonList[curMissileTime] * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.DEG2RAD + gmst);
    const x = (_app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.RADIUS_OF_EARTH + missile.altList[curMissileTime]) * cosLat * cosLon;
    const y = (_app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.RADIUS_OF_EARTH + missile.altList[curMissileTime]) * cosLat * sinLon;
    const z = (_app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.RADIUS_OF_EARTH + missile.altList[curMissileTime]) * sinLat;
    ...
    try {
        ...
        currentTEARR.az = lookAngles.az * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.RAD2DEG;
        currentTEARR.el = lookAngles.el * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_2__.RAD2DEG;
...
const _ThrustFun = (MassOut, Altitude, FuelArea, NozzleAltitude) => {
...
const _CoordinateCalculator = (CurrentLatitude, CurrentLongitude, TargetLatitude, TargetLongitude) => {
    ...
    for (let i = 0; i < LatList1.length; i++)
        EstLatList.push(LatList1[i]);
    for (let i = 0; i < LatList2.length; i++)
        EstLatList.push(LatList2[i]);
    for (let i = 0; i < LatList3.length; i++)
        EstLatList.push(LatList3[i]);
    for (let i = 0; i < LongList1.length; i++)
        EstLongList.push(LongList1[i]);
    for (let i = 0; i < LongList2.length; i++)
        EstLongList.push(LongList2[i]);
    for (let i = 0; i < LongList3.length; i++)
        EstLongList.push(LongList3[i]);
    return [EstLatList, EstLongList, (Alpha1 * 180) / Math.PI, ArcLength, EstDistanceList, GoalDistance];
};
const _IterationFun = (FuelArea, FuelMass, RocketArea, Altitude, RocketCasingMass, NozzleAltitude, drdt, dthetadt, Distance, ArcDistance, MassIn, AngleCoefficient) => {
...
const _Bisection = (FuelArea1, FuelArea2, FuelMass, FuelVolume, RocketArea, Altitude, RocketCasingMass1, RocketCasingMass2, RocketCasingMass3, NozzleAltitude1, drdt, dthetadt, Distance, ArcDistance, MassIn, _ArcLength, GoalDistance) => {
    ...
    while (error > 0.01 && Math.abs(AC2 - AC1) >= 0.0001) {
        ACNew = (AC1 + AC2) / 2;
        error =
            Math.abs((GoalDistance -
                _QuickRun(FuelArea1, FuelArea2, FuelMass, FuelVolume, RocketArea, Altitude, RocketCasingMass1, RocketCasingMass2, RocketCasingMass3, NozzleAltitude1, drdt, dthetadt, Distance, ArcDistance, MassIn, ACNew)) /
                GoalDistance) * 100;
...
const _QuickRun = (FuelArea1, FuelArea2, FuelMass, FuelVolume, RocketArea, Altitude, RocketCasingMass1, RocketCasingMass2, RocketCasingMass3, NozzleAltitude1, drdt, dthetadt, Distance, ArcDistance, MassIn, AngleCoefficient) => {
...
/***/ "./src/img/icons/missile.png":
/*!***********************************!*\
  !*** ./src/img/icons/missile.png ***!
  \***********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "5f4c427b815b5c170415.png";

/***/ })

}]);
//# sourceMappingURL=src_js_plugins_missile_missile_ts.eebba6f4c52beb05f1bc.js.map