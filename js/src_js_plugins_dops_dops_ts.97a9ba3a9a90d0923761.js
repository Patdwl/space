...
var dopsFormSubmit = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#loading-screen').fadeIn(1000, function () {
        var lat = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-lat').val());
        var lon = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-lon').val());
        var alt = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-alt').val());
        var el = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-el').val());
        _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.settingsManager.gpsElevationMask = el;
        _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.satellite.updateDopsTable(lat, lon, alt);
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-dops').addClass('bmenu-item-selected');
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#loading-screen').fadeOut('slow');
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-menu').effect('slide', { direction: 'left', mode: 'show' }, 1000);
    });
};
var uiManagerInit = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-form').on('submit', function (e) {
        dopsFormSubmit();
        e.preventDefault();
    });
    // Allow resizing of the side menu
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-menu').resizable({
        handles: 'e',
        stop: function () {
...
var adviceReady = function () {
    ...
    aM.adviceList.socrates = function () {
        ...
        aM.showAdvice('SOCRATES Near Conjunction List', 'Did you know that objects frequently come close to colliding? Using data from Center for Space Standars and Innovation you can find upcomming possible collisions.', jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-satellite-collision'), 'bottom');
    };
    aM.adviceArray.push(aM.adviceList.socrates);
};
var loadingScreenFadeIn = function () {
    var lat = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-lat').val());
    var lon = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-lon').val());
    var alt = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-alt').val());
    var el = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-el').val());
...
var bottomMenuClick = function (iconName) {
    if (iconName === 'menu-dops') {
        if (isDOPMenuOpen) {
            ...
            _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.uiManager.hideSideMenus();
            isDOPMenuOpen = true;
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#loading-screen').fadeIn(1000, loadingScreenFadeIn);
            return;
        }
    }
};
var hideSideMenus = function () {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#dops-menu').effect('slide', { direction: 'left', mode: 'hide' }, 1000);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-dops').removeClass('bmenu-item-selected');
    isDOPMenuOpen = false;
};
var init = function () {
    // Add HTML
...
//# sourceMappingURL=src_js_plugins_dops_dops_ts.97a9ba3a9a90d0923761.js.map