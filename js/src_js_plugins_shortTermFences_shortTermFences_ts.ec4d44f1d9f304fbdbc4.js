...
var init = function () {
    ...
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.register({
        method: 'resetSensor',
        cbName: 'shortTermFences',
        cb: function () { return resetSensor(); },
    });
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.register({
        method: 'setSensor',
        cbName: 'shortTermFences',
        cb: function (sensor, id) { return setSensor(sensor, id); },
    });
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.register({
...
var bottomMenuClick = function (iconName) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, sensorManager = _a.sensorManager, uiManager = _a.uiManager;
...
var selectSatData = function (stfInfoLinks) {
    if (!stfInfoLinks) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#sat-info-top-links').append(_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n        <div id=\"stf-on-object-link\" class=\"link sat-infobox-links\">Build Short Term Fence on this object...</div>\n      "], ["\n        <div id=\"stf-on-object-link\" class=\"link sat-infobox-links\">Build Short Term Fence on this object...</div>\n      "]))));
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#stf-on-object-link').on('click', stfOnObjectLinkClick);
    }
};
var setSensor = function (sensor, id) {
...
var stfFormOnSubmit = function (e) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, sensorManager = _a.sensorManager, satellite = _a.satellite, satSet = _a.satSet, uiManager = _a.uiManager;
    e.preventDefault();
    if (!sensorManager.checkSensorSelected()) {
        uiManager.toast("Select a Sensor First!", 'caution', true);
        return;
    ...
    var az = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#stf-az').val());
    var azExt = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#stf-azExt').val());
    var el = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#stf-el').val());
    var elExt = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#stf-elExt').val());
    var rng = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#stf-rng').val());
    var rngExt = parseFloat(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#stf-rngExt').val());
    ...
    _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.sensorFov.enableFovView();
};
var stfOnObjectLinkClick = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, satellite = _a.satellite, uiManager = _a.uiManager, sensorManager = _a.sensorManager, objectManager = _a.objectManager, satSet = _a.satSet;
    if (!sensorManager.checkSensorSelected()) {
        // No Sensor Selected
        uiManager.toast("Select a Sensor First!", 'caution', true);
        return;
...
//# sourceMappingURL=src_js_plugins_shortTermFences_shortTermFences_ts.ec4d44f1d9f304fbdbc4.js.map