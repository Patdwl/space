...
const orbitReferencesLinkClick = () => {
    ...
    for (let i = 0; i < 360; i++) {
        ...
        let rasc = (satrec.nodeo * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_1__.RAD2DEG).toPrecision(7);
        const rascA = rasc.split('.');
        rascA[0] = rascA[0].substr(-3, 3);
        rascA[1] = rascA[1].substr(0, 4);
        rasc = (rascA[0] + '.' + rascA[1]).toString();
        let argPe = (satrec.argpo * _app_js_lib_constants__WEBPACK_IMPORTED_MODULE_1__.RAD2DEG).toPrecision(7);
...
//# sourceMappingURL=src_js_plugins_orbitReferences_orbitReferences_ts.edcd9773d5b825a52428.js.map