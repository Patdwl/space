...
var uiManagerInit = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#time-machine-icon').on('click', timeMachineIconClick);
};
var bottomMenuClick = function (iconName) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs, orbitManager = _a.orbitManager, groupsManager = _a.groupsManager, satSet = _a.satSet, ColorScheme = _a.ColorScheme;
...
var orbitManagerInit = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs, orbitManager = _a.orbitManager, satSet = _a.satSet, ColorScheme = _a.ColorScheme, groupsManager = _a.groupsManager;
    orbitManager.playNextSatellite = function (runCount, year) {
        if (!_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.orbitManager.isTimeMachineVisible)
            return;
        ...
        if (year >= 59 && year < 100) {
            _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.uiManager.toast("Time Machine In Year 19".concat(year, "!"), 'normal');
        }
        else {
            var yearStr = year < 10 ? "0".concat(year) : "".concat(year);
            _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.uiManager.toast("Time Machine In Year 20".concat(yearStr, "!"), 'normal');
        }
...
var timeMachineIconClick = function () {
    var searchBox = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.searchBox;
...
var timeMachineRemoveSatellite = function (runCount, orbitManager, groupsManager, satSet, ColorScheme) {
    if (runCount !== orbitManager.historyOfSatellitesRunCount)
        return;
...
//# sourceMappingURL=src_js_plugins_timeMachine_timeMachine_ts.a67d801769cfc3147241.js.map