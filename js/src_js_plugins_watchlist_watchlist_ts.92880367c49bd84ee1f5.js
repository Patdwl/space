...
const onCruncherReady = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (watchlistJSON === null || watchlistJSON === '[]') {
        try {
            watchlistJSON = yield jquery__WEBPACK_IMPORTED_MODULE_3___default().get(`${settingsManager.installDirectory}tle/watchlist.json`);
        }
        catch (_b) {
            watchlistJSON = null;
        }
...
//# sourceMappingURL=src_js_plugins_watchlist_watchlist_ts.92880367c49bd84ee1f5.js.map