...
/* harmony export */ });
/* harmony import */ var _app_js_uiManager_search_box__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @app/js/uiManager/search-box */ "./src/js/uiManager/search-box.js");
  ...
  var _ref3 = _asyncToGenerator(function* (svs, satSet, timeManager, satellite) {
    try {
      om.iod(svs, timeManager, satellite).then(tles => {
        ...
        _app_js_uiManager_search_box__WEBPACK_IMPORTED_MODULE_0__.searchBox.doSearch('100500', true);
      }).catch(error => {
        console.debug(error);
      });
    } catch (error) {
...
var obfitFormSubmit = function (e) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs, uiManager = _a.uiManager, satSet = _a.satSet, timeManager = _a.timeManager, satellite = _a.satellite;
...
//# sourceMappingURL=src_js_plugins_initialOrbit_initialOrbit_ts.f3d91028dcf7b74c80ae.js.map