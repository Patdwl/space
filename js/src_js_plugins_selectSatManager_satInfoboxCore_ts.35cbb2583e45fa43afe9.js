...
var orbitalData = function (sat) {
    ...
    if (!sat.missile) {
        ...
        if (!_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.objectManager.isSensorManagerLoaded) {
            ...
            now = new Date(_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.timeManager.propRealTime + _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.timeManager.propOffset);
...
//# sourceMappingURL=src_js_plugins_selectSatManager_satInfoboxCore_ts.35cbb2583e45fa43afe9.js.map