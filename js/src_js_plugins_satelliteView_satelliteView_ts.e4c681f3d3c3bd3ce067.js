...
var init = function () {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs, objectManager = _a.objectManager, settingsManager = _a.settingsManager, uiManager = _a.uiManager;
    // Add HTML
        ...
        cb: function (iconName) {
            if (iconName === 'menu-satview') {
                ...
                if (cameraManager.cameraType.current === cameraManager.cameraType.satellite) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-satview').removeClass('bmenu-item-selected');
                    return;
                }
                else {
                    if (objectManager.selectedSat !== -1) {
                        cameraManager.cameraType.current = cameraManager.cameraType.satellite; // Activate Satellite Camera Mode
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-satview').addClass('bmenu-item-selected');
                        // isSatView = true;
                    }
                    else {
                        uiManager.toast("Select a Satellite First!", 'caution');
                        if (settingsManager.plugins.topMenu)
                            _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.adviceManager.adviceList.satViewDisabled();
                        if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-satview:animated').length) {
                            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-satview').effect('shake', {
                                distance: 10,
                            });
                        }
                    }
...
//# sourceMappingURL=src_js_plugins_satelliteView_satelliteView_ts.e4c681f3d3c3bd3ce067.js.map