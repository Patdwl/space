...
var bottomMenuClick = function (iconName) {
    ...
    if (iconName === 'menu-newLaunch') {
        if (isNewLaunchMenuOpen) {
            ...
            if (_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.objectManager.selectedSat !== -1) {
                ...
                var sat = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.satSet.getSatExtraOnly(_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.objectManager.selectedSat);
                jquery__WEBPACK_IMPORTED_MODULE_2___default()('#nl-scc').val(sat.SCC_NUM);
                ...
                _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs.uiManager.toast("Select a Satellite First!", 'caution');
...
//# sourceMappingURL=src_js_plugins_newLaunch_newLaunch_ts.60e0de0b0ccffd5cb12a.js.map