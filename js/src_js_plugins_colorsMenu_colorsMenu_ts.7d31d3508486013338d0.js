...
const hideSideMenus = () => {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#color-scheme-menu').effect('slide', { direction: 'left', mode: 'hide' }, 1000);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-color-scheme').removeClass('bmenu-item-selected');
...
const uiManagerInit = () => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#bottom-icons').append(_app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.html `
      ...
      `);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#colors-menu>ul>li').on('click', function () {
        const colorName = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).data('color');
        colorsMenuClick(colorName);
    });
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#color-scheme-menu').resizable({
        handles: 'e',
        stop: function () {
...
const bottomMenuClick = (iconName) => {
    ...
    if (iconName === 'menu-color-scheme') {
        if (isColorSchemeMenuOpen) {
            ...
            uiManager.hideSideMenus();
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#color-scheme-menu').effect('slide', { direction: 'left', mode: 'show' }, 1000);
            isColorSchemeMenuOpen = true;
            jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-color-scheme').addClass('bmenu-item-selected');
            return;
        }
    }
};
const colorsMenuClick = (colorName) => {
    const { colorSchemeManager, satSet, objectManager, uiManager } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
...
//# sourceMappingURL=src_js_plugins_colorsMenu_colorsMenu_ts.7d31d3508486013338d0.js.map