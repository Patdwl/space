"use strict";
(self["webpackChunkkeeptrack_space"] = self["webpackChunkkeeptrack_space"] || []).push([["src_js_plugins_catalogLoader_catalogLoader_ts"],{

/***/ "./src/js/plugins/catalogLoader/catalogLoader.ts":
/*!*******************************************************!*\
  !*** ./src/js/plugins/catalogLoader/catalogLoader.ts ***!
  \*******************************************************/
...
/* harmony export */   "catalogLoader": () => (/* binding */ catalogLoader),
/* harmony export */   "parseCatalog": () => (/* binding */ parseCatalog),
/* harmony export */   "setupGetVariables": () => (/* binding */ setupGetVariables),
/* harmony export */   "filterTLEDatabase": () => (/* binding */ filterTLEDatabase),
 ...
 */
const catalogLoader = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!settingsManager.isDisableAsciiCatalog) {
            $.get(`${settingsManager.installDirectory}tle/TLE.txt`).then((resp) => {
                ...
                for (let i = 0; i < content.length; i = i + 2) {
                    asciiCatalog.push({
                        SCC: _app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_1__.stringPad.pad0(content[i].substr(2, 5).trim(), 5),
                        TLE1: content[i],
                        TLE2: content[i + 1],
                    });
                }
...
const parseCatalog = (resp, extraSats, asciiCatalog) => {
...
const setupGetVariables = () => {
    const { satSet, timeManager } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
    let obslatitude;
    let obslongitude;
    let obsheight;
    let obsminaz;
...
const filterTLEDatabase = (resp, limitSatsArray, extraSats, asciiCatalog) => {
    const { dotsManager, objectManager, satSet } = _app_js_api_keepTrackApi__WEBPACK_IMPORTED_MODULE_0__.keepTrackApi.programs;
    const tempSatData = [];
    satSet.sccIndex = {};
    satSet.cosparIndex = {};
    ...
    for (i = 0; i < resp.length; i++) {
        resp[i].sccNum = _app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_1__.stringPad.pad0(resp[i].TLE1.substr(2, 5).trim(), 5);
...
//# sourceMappingURL=src_js_plugins_catalogLoader_catalogLoader_ts.3f717770e3f163e11c94.js.map