...
var CanvasRecorder = /** @class */ (function () {
    function CanvasRecorder(videoBitsPerSec) {
        var _this = this;
        this.checkIfRecording = function () { return _this.isVideoRecording; };
        this.setIsRecording = function (bool) {
            _this.isVideoRecording = bool;
        };
        var recordedBlobs = [];
        ...
        var startCapture = function (displayMediaOptions) {
            ...
            if (window.location.protocol === 'https:' || settingsManager.offline) {
                if ('getDisplayMedia' in navigator) {
                    return navigator.getDisplayMedia(displayMediaOptions).catch(function (err) {
        ...
        var startRecording = function () {
            var selectCapture = new Promise(function (resolve) {
...
//# sourceMappingURL=src_js_plugins_recorderManager_recorderManager_ts.89f591fced815740614e.js.map