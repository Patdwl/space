...
/* harmony import */ var _app_js_satSet_satVmagManager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @app/js/satSet/satVmagManager.js */ "./src/js/satSet/satVmagManager.js");
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (settingsManager.offline) {
                    $.get('./tle/extra.json').then(function (resp) {
                        extraSats_1 = JSON.parse(resp);
                    });
                }
                asciiCatalog_1 = [];
                $.get('./tle/TLE.txt').then(function (resp) {
                    var content = resp.split('\n');
                    for (var i = 0; i < content.length; i = i + 2) {
                        asciiCatalog_1.push({
                            SCC: _app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.stringPad.pad0(content[i].substr(2, 5).trim(), 5),
                            TLE1: content[i],
                            TLE2: content[i + 1]
                        });
                    }
                });
                return [4 /*yield*/, __webpack_require__.e(/*! import() */ "src_tle_TLE_json").then(__webpack_require__.t.bind(__webpack_require__, /*! @app/tle/TLE.json */ "./src/tle/TLE.json", 19)).then(function (resp) { return parseCatalog(resp, extraSats_1, asciiCatalog_1); })];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
...
var parseCatalog = function (resp, extraSats, asciiCatalog) {
    ...
    try {
        if (typeof satSet.getSat(satSet.getIdFromObjNum(44235)).vmag == 'undefined') {
            _app_js_satSet_satVmagManager_js__WEBPACK_IMPORTED_MODULE_1__.satVmagManager.init(satSet);
        }
    }
    catch (e) {
...
var filterTLEDatabase = function (resp, limitSatsArray, extraSats, asciiCatalog) {
    ...
    for (i = 0; i < resp.length; i++) {
        resp[i].SCC_NUM = _app_js_lib_helpers__WEBPACK_IMPORTED_MODULE_2__.stringPad.pad0(resp[i].TLE1.substr(2, 5).trim(), 5);
        if (limitSats === '') {
            // If there are no limits then just process like normal
...
//# sourceMappingURL=src_js_plugins_catalogLoader_catalogLoader_ts.5715d4e0f1056638ed11.js.map