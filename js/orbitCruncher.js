...
onmessage = function onmessage(m) {
  ...
  if (m.data.isInit) {
    ...
    if (satCache[satId].missile) {
      ...
      while (_i < len) {
        var t = now + _i * timeslice;
        var p = satellite_js__WEBPACK_IMPORTED_MODULE_0__.sgp4(satCache[satId], t).position;
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./src/js/webworker/orbitCruncher.js");
