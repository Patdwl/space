...
var startGremlins = function () {
    var bottomMenuGremlinClicker = gremlins_js__WEBPACK_IMPORTED_MODULE_0__.species.clicker({
        // Click only if parent is has class test-class
        canClick: canClick,
        defaultPositionSelector: defaultPositionSelector,
    });
    var bottomMenuGremlinScroller = gremlins_js__WEBPACK_IMPORTED_MODULE_0__.species.toucher({
        touchTypes: ['gesture'],
        defaultPositionSelector: defaultPositionSelector,
    });
    var distributionStrategy = gremlins_js__WEBPACK_IMPORTED_MODULE_0__.strategies.distribution({
    ...
    gremlins_js__WEBPACK_IMPORTED_MODULE_0__.createHorde({
        species: [bottomMenuGremlinClicker, bottomMenuGremlinScroller, gremlins_js__WEBPACK_IMPORTED_MODULE_0__.species.clicker(), gremlins_js__WEBPACK_IMPORTED_MODULE_0__.species.toucher(), gremlins_js__WEBPACK_IMPORTED_MODULE_0__.species.formFiller(), gremlins_js__WEBPACK_IMPORTED_MODULE_0__.species.typer()],
...
//# sourceMappingURL=src_js_plugins_debug_debug_ts.02220ba622e55d1a5039.js.map