...
var bottomMenuClick = function (iconName) {
    var _a = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs, drawManager = _a.drawManager, starManager = _a.starManager, objectManager = _a.objectManager, uiManager = _a.uiManager, orbitManager = _a.orbitManager, sensorManager = _a.sensorManager;
    if (iconName === 'menu-astronomy') {
        ...
        if (_app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.astronomy.isAstronomyView) {
            ...
            if (sensorManager.checkSensorSelected()) {
                ...
                if (typeof _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_1__.keepTrackApi.programs.planetarium !== 'undefined') {
...
//# sourceMappingURL=src_js_plugins_astronomy_astronomy_ts.9492a57da7f80851f0c3.js.map